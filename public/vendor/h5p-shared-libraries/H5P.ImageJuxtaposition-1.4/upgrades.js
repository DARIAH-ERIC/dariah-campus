			...
			4: function (parameters, finished, extras) {
				...
				if (parameters.imageBefore && parameters.imageBefore.imageBefore) {
					...
					parameters.imageBefore.imageBefore = {
						...
						params: {
							alt:
								parameters.imageBefore && parameters.imageBefore.labelBefore
									? parameters.imageBefore.labelBefore
									: undefined,
							contentName: "Image",
				...
				if (parameters.imageAfter && parameters.imageAfter.imageAfter) {
					...
					parameters.imageAfter.imageAfter = {
						...
						params: {
							alt:
								parameters.imageAfter && parameters.imageAfter.labelAfter
									? parameters.imageAfter.labelAfter
									: undefined,
							contentName: "Image",
