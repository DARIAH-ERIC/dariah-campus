					...
					o(e, null, [
						...
						},
						{
							...
							value: function (t, n, i) {
								...
								if ("background" === n)
									return (
										e.setOpacity(t, "backgroundColor", i),
										void e.setOpacity(t, "backgroundImage", i)
									);
								i = void 0 === i ? 1 : i / 100;
								var r = t.css(n),
									a = o(n, "");
								...
								var l = t.css(s);
								("" !== l && "none" !== l) || (l = r),
									(l = e.setAlphas(l, "rgba(", i)),
									(l = e.setAlphas(l, "rgb(", i)),
									t.css(o(n, l));
							},
						},
						{
								...
								if (e) {
									for (var i = e.indexOf(t); -1 !== i; ) {
										...
										(r[3] = void 0 !== r[3] ? parseFloat(r[3]) * n : n),
											(e = e.substring(0, i) + "rgba(" + r.join(",") + e.substring(o, e.length)),
											(i = e.indexOf(t, o));
									}
									return e;
								}
						...
						},
						{
							...
							value: function (e, t) {
								for (var n = 0; n < e.length; n++) if (e[n].$dropZone.is(t)) return e[n];
							},
						},
						{
								...
								t.hover(
									function () {
										t.addClass("h5p-draggable-hover"),
											t.parent().hasClass("h5p-dragging") || e.setElementOpacity(t, n);
									},
									function () {
	...
	function (e, t, n) {
		...
		function o(e, t, n) {
			...
			k++,
				...
				this.options.behaviour.singlePoint && (this.options.behaviour.enableScoreExplanation = !1),
				(this.draggables = []),
				(this.dropZones = []),
				(this.answered =
					n &&
			...
			var a = w(r.draggables, r.dropZones, r.$noDropZone[0]),
				s = function (e) {
					for (var t = 0; t < a.drop.elements.length; t++)
						a.drop.elements[t].setAttribute("aria-dropeffect", e);
				},
				l = [],
			...
			for (i = 0; i < u.elements.length; i++) {
				...
				if (void 0 !== p.dropZones && p.dropZones.length) {
					...
					n &&
						void 0 !== n.previousState &&
						void 0 !== n.previousState.answers &&
						void 0 !== n.previousState.answers[i] &&
						(g = n.previousState.answers[i]);
					...
					for (
						v.on("elementadd", function (e) {
							...
							v.on("elementremove", function (e) {
								a.drag.removeElement(e.data),
									"true" === e.data.getAttribute("aria-grabbed") &&
										(a.drag.firesEvent("select", e.data), e.data.removeAttribute("aria-grabbed"));
							}),
			...
			for (i = 0; i < u.dropZones.length; i++) {
				var A = u.dropZones[i];
				!0 === l[i] && (this.numDropZonesWithoutElements += 1),
					this.blankIsCorrect && A.correctElements.length && (this.blankIsCorrect = !1),
					(A.autoAlign = {
						enabled: A.autoAlign,
						spacing: r.options.behaviour.autoAlignSpacing,
						size: r.options.question.settings.size,
					}),
					(this.dropZones[i] = new b.default(A, i, E)),
					this.dropZones[i].on("elementaligned", function (e) {
						for (var t = e.data, n = 0; n < r.draggables.length; n++) {
							...
							if (i && i.elements && i.elements.length)
								for (var o = 0; o < i.elements.length; o++) {
									var a = i.elements[o];
									if (a && a.$[0] === t[0])
										return void (a.position = f.default.positionToPercentage(r.$container, a.$));
								}
						}
					});
			}
			this.on("resize", r.resize, r),
				...
				this.on("enterFullScreen", function () {
					r.$container &&
						(r.$container.parents(".h5p-content").css("height", "100%"), r.trigger("resize"));
				}),
				this.on("exitFullScreen", function () {
					r.$container &&
						(r.$container.parents(".h5p-content").css("height", "auto"), r.trigger("resize"));
				});
		}
		var r = n(4),
			a = i(r),
			...
			y = H5P.jQuery,
			k = 0;
		(o.prototype = Object.create(H5P.Question.prototype)),
			(o.prototype.constructor = o),
			(o.prototype.registerDomElements = function () {
				var e = this;
				...
				if (
					...
					this.on("enterFullScreen", function () {
						i.attr("class", "h5p-my-fullscreen-button-exit"),
							i.attr("title", this.options.localize.exitFullscreen);
					}),
						this.on("exitFullScreen", function () {
							i.attr("class", "h5p-my-fullscreen-button-enter"),
								i.attr("title", this.options.localize.fullscreen);
						});
				}
				e.registerButtons(),
					setTimeout(function () {
			...
			(o.prototype.getXAPIDefinition = function () {
				...
				for (var t = 0; t < this.options.question.task.elements.length; t++) {
					...
					if (n.dropZones && n.dropZones.length) {
						...
						e.source.push({
							id: "" + t,
							description: { "en-US": y("<div>" + i + "</div>").text() },
						});
					}
				}
				...
				for (t = 0; t < this.options.question.task.dropZones.length; t++)
					if (
						(e.target.push({
							...
							description: {
								"en-US": y(
									"<div>" + this.options.question.task.dropZones[t].label + "</div>",
								).text(),
							},
						}),
						...
						for (
							...
							var a = this.options.question.task,
								s = a.elements[a.dropZones[t].correctElements[r]];
							!s ||
								s.dropZones.indexOf(t.toString()) < 0 ||
								(o || (e.correctResponsesPattern[0] += "[,]"),
								(e.correctResponsesPattern[0] += t + "[.]" + a.dropZones[t].correctElements[r]),
								(o = !1));
						}
				return e;
			}),
			(o.prototype.addResponseToXAPI = function (e) {
				var t = this.getMaxScore(),
					n = this.getScore(),
					i = n == t;
				e.setScoredResult(n, t, this, !0, i),
			...
			(o.prototype.createQuestionContent = function () {
				var e;
				(this.$container = y(
					'<div class="h5p-inner" role="application" aria-labelledby="dq-intro-' + k + '"></div>',
				)),
					void 0 !== this.options.question.settings.background &&
						this.$container.css(
							"backgroundImage",
							'url("' + H5P.getPath(this.options.question.settings.background.path, this.id) + '")',
						);
				...
				for (this.$noDropZone.appendTo(this.$container), e = 0; e < this.dropZones.length; e++)
				...
				this.addButton(
					...
					function () {
						...
						e.addQuestionToXAPI(t),
							...
							e.trigger(t),
							(e.$introduction ? e.$introduction : e.$container.children().first()).focus();
					},
					!0,
					...
					if (void 0 !== o.correct || void 0 !== o.incorrect) {
						...
						e.draggables.forEach(function (e) {
							e.elements.forEach(function (t) {
								t.dropZone == i &&
									(a[e.id] = { instance: e, correct: -1 !== r.indexOf("" + e.id) });
							});
						}),
							Object.keys(a).forEach(function (e) {
								var r = a[e],
									s =
										f.default.strip(r.instance.type.params.alt || r.instance.type.params.text) ||
										"?",
									l = f.default.strip(t.label);
								r.correct && o.correct
									? (n.push({ correct: l + " + " + s, text: o.correct }),
										r.instance.setFeedback(o.correct, i))
									: !r.correct &&
										o.incorrect &&
										(n.push({ correct: l + " + ", wrong: s, text: o.incorrect }),
			...
			(o.prototype.resize = function (e) {
				...
				if (void 0 !== this.$container && this.$container.is(":visible")) {
					...
					n ||
						...
						t.$container.parents(".h5p-standalone.h5p-dragquestion").css("width", ""));
			...
			(o.prototype.showAllSolutions = function (e) {
				...
				for (var n = 0; n < this.draggables.length; n++) {
					...
					void 0 !== i &&
						(e || i.disable(),
						(this.points += i.results(e, this.correctDZs[n], t)),
						(this.rawPoints += i.rawPoints));
				}
				this.points < 0 && (this.points = 0),
					...
					this.options.behaviour.enableRetry && !e && this.showButton("try-again"),
					!this.hasButton("check-answer") ||
						(!1 !== this.options.behaviour.enableRetry && this.points !== this.getMaxScore()) ||
			...
			(o.prototype.getScore = function () {
				...
				var e =
					this.options.behaviour.applyPenalties || this.options.behaviour.singlePoint
						? this.points
						: this.rawPoints;
			...
			(o.prototype.getAnswerGiven = function () {
				return (
					!this.options.behaviour.showSolutionsRequiresInput || this.answered || this.blankIsCorrect
				);
			}),
			(o.prototype.showScore = function () {
				...
				var t =
						this.options.behaviour.applyPenalties || this.options.behaviour.singlePoint
							? this.points
							: this.rawPoints,
					n = H5P.Question.determineOverallFeedback(this.options.overallFeedback, t / e)
						.replace("@score", t)
						.replace("@total", e),
					i =
						!(
		...
		var w = function (e, t, n) {
			...
			var o,
				r = function () {
					o.draggable.trigger("dragend"),
						...
						f.default.setElementOpacity(o.element.$, o.draggable.backgroundOpacity),
			...
			return (
				i.drag.on("select", function (a) {
					var s = f.default.elementToDraggable(e, a.element);
					if (o) return void r();
					(o = s),
						o.element.$.addClass("h5p-draggable-hover"),
						f.default.setElementOpacity(o.element.$, o.draggable.backgroundOpacity),
						o.draggable.trigger(
							"dragstart",
					...
					for (var l, u = 0; u < t.length; u++) {
						var c = t[u];
						c.accepts(o.draggable, e) &&
							(c.highlight(),
							i.drop.addElement(c.$dropZone[0]),
							(l && o.element.dropZone !== c.id) || (l = c.$dropZone));
					}
								...
								switch (e.which) {
									...
									case 38:
										this.hasChromevoxModifiers(e) ||
											(this.previousElement(e.target), e.preventDefault());
										break;
									case 39:
									case 40:
										this.hasChromevoxModifiers(e) ||
											(this.nextElement(e.target), e.preventDefault());
								}
							},
						},
						{
			...
			l = (function () {
				function e(t, n, o) {
					...
					H5P.EventDispatcher.call(r),
						(r.id = n),
						(r.showLabel = t.showLabel),
						(r.label = t.label),
						(r.x = t.x),
						(r.y = t.y),
						(r.width = t.width),
						(r.height = t.height),
						(r.backgroundOpacity = t.backgroundOpacity),
						(r.tip = t.tipsAndFeedback.tip || ""),
						(r.single = t.single),
						(r.autoAlignable = t.autoAlign),
						(r.alignables = []),
						(r.l10n = o);
				}
				return (
					o(e, [
							...
							value: function (e, t) {
								...
								n.showLabel &&
									...
									(n.$dropZone = s("<div/>", {
										...
										tabindex: "-1",
										title: n.showLabel ? s("<div/>", { html: n.label }).text() : null,
										role: "button",
										"aria-disabled": !0,
										css: {
											left: n.x + "%",
										...
										.droppable({
											...
											drop: function (e, t) {
												var i = s(this);
												a.default.setOpacity(
													i.removeClass("h5p-over"),
													"background",
													n.backgroundOpacity,
												),
													t.draggable.data("addToZone", n.id),
													-1 === n.getIndexOf(t.draggable) && n.alignables.push(t.draggable),
													n.autoAlignable.enabled && n.autoAlign();
											},
											over: function () {
												a.default.setOpacity(
													s(this).addClass("h5p-over"),
													"background",
													n.backgroundOpacity,
												);
											},
						...
						},
						{
							...
							value: function (e, t) {
								...
								if (n.single)
									for (var i = 0; i < t.length; i++) if (t[i] && t[i].isInDropZone(n.id)) return !1;
								return !0;
							},
						},
						{
							...
							value: function () {
								for (
									var e,
										...
										d = 0;
									d < n.alignables.length;
									d++
								)
									if (((e = n.alignables[d]), (t = e[0].getBoundingClientRect()), l.x >= t.width))
										c();
									else {
										if (
											((l.x = s.x),
											(r.x = n.x + o.x),
											u && ((l.y -= u), (r.y += (u / i.height) * 100), (u = 0)),
											l.y <= 0)
										)
											return;
										c();
			...
			c = (function (e) {
				function t(e, n, r, a) {
					...
					if (
						...
						(l.width = e.width),
						(l.height = e.height),
						(l.backgroundOpacity = e.backgroundOpacity),
						(l.dropZones = e.dropZones),
						(l.type = e.type),
					...
					a(t, [
						...
						},
						{
							...
							value: function (e, t, n) {
								var i,
									o = this;
								null === e
									? ((i = {}), o.elements.push(i), (e = o.elements.length - 1))
									: (i = o.elements[e]),
									u.extend(i, {
										clone: function () {
										...
										reset: function () {
											void 0 !== i.dropZone && (o.trigger("leavingDropZone", i), delete i.dropZone),
												o.multiple &&
													(i.$.remove(), delete o.elements[e], o.trigger("elementremove", i.$[0])),
												delete i.position;
										},
									}),
									(i.$ = u("<div/>", {
										...
										.draggable({
											...
											start: function () {
												...
												n && i.clone(),
													...
													l.default.setElementOpacity(e, o.backgroundOpacity),
													this.setAttribute("aria-grabbed", "true"),
													o.trigger("focus", this),
													o.trigger("dragstart", { element: this, effect: n ? "copy" : "move" });
											},
											stop: function () {
												var n = u(this);
												...
												void 0 !== r
													? (n.removeData("addToZone"), o.addToDropZone(e, i, r))
													: i.reset();
											},
										})
										.css("position", "")),
									(o.element = i),
									i.position && (i.$.css(i.position), o.updatePlacement(i)),
									l.default.addHover(i.$, o.backgroundOpacity),
									H5P.newRunnable(o.type, n, i.$),
									u(
										'<span class="h5p-hidden-read">' +
											o.l10n.prefix.replace("{num}", o.id + 1) +
											"</span>",
									).prependTo(i.$),
									u('<span class="h5p-hidden-read"></span>').appendTo(i.$),
									setTimeout(function () {
										l.default.setElementOpacity(i.$, o.backgroundOpacity);
									}, 0),
									o.trigger("elementadd", i.$[0]);
							},
						},
						{
							key: "setFeedback",
							value: function (e, t) {
								this.elements.forEach(function (n) {
									n.dropZone === t &&
										(void 0 === n.$feedback &&
											(n.$feedback = u("<span>", { class: "h5p-hidden-read", appendTo: n.$ })),
										n.$feedback.html(e));
								});
							},
						},
						...
						},
						{
							...
							value: function (e, t, n) {
								...
								if (i.multiple)
									for (var o = 0; o < i.elements.length; o++)
										if (o !== e && void 0 !== i.elements[o] && i.elements[o].dropZone === n)
											return (
												void 0 !== i.elements[e].dropZone &&
													i.elements[e].dropZone !== n &&
													i.trigger("leavingDropZone", t),
												t.$.remove(),
												delete i.elements[e],
												void i.trigger("elementremove", this.element.$[0])
											);
								void 0 !== t.dropZone && t.dropZone !== n && i.trigger("leavingDropZone", t),
									(t.dropZone = n),
									i.updatePlacement(t),
									i.trigger("interacted");
							},
						},
						{
							key: "updatePlacement",
							value: function (e) {
								e.$suffix && e.$suffix.remove(),
									void 0 !== e.dropZone
										? (e.$.addClass("h5p-dropped"),
											l.default.setElementOpacity(e.$, self.backgroundOpacity),
											(e.$suffix = u(
												'<span class="h5p-hidden-read">' +
													this.l10n.suffix.replace("{num}", e.dropZone + 1) +
													". </span>",
											).appendTo(e.$)))
							...
							value: function () {
								...
								this.elements.forEach(function (t) {
									if (
										...
										n.animate({ left: e.x + "%", top: e.y + "%" }, function () {
											e.multiple &&
												...
												n.remove(),
												e.elements.indexOf(t) >= 0 && delete e.elements[e.elements.indexOf(t)],
									...
									void 0 !== e.element.dropZone &&
										(e.trigger("leavingDropZone", e.element), delete e.element.dropZone),
							...
							value: function (e, t, n) {
								...
								if (((s.rawPoints = 0), void 0 === t)) {
									for (i = 0; i < s.elements.length; i++)
										void 0 !== (r = s.elements[i]) &&
											void 0 !== r.dropZone &&
											(!0 !== e && s.markElement(r, "wrong", n), l--);
									return l;
								}
								for (i = 0; i < s.elements.length; i++)
						...
						},
						{
							...
							value: function (e, t, n) {
								...
								n && (i = i.add(n.getElement("correct" === t))),
									(e.$suffix = e.$suffix.add(i)),
									e.$.addClass("h5p-" + t).append(i),
									l.default.setElementOpacity(e.$, this.backgroundOpacity);
							},
						},
					]),
