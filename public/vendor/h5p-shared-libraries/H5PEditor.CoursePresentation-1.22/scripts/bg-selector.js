	...
	function BackgroundSelector($backgroundSlides, isSingleSlide) {
		...
		var paintElement = function () {
			...
			if (settings.type === "image") {
				...
				$targetSlides.addClass("has-background").css("background-color", settings.value);
			}
		};
		...
		self.addBgSelector = function (fields, params, $wrapper, options) {
			...
			$bgSelector.toggleClass("single", options.isSingle).toggleClass("show", options.isVisible);
