!(function (t) {
				...
				return (
					r(t, [
						...
						},
						{
							...
							value: function (t) {
								(this.elements = (0, a.without)([t], this.elements)),
									h(t) &&
										(this.setUntabbable(t), this.elements[0] && this.setTabbable(this.elements[0])),
						...
						},
						{
							key: "setUntabbable",
							value: function (t) {
								t !== document.activeElement && (this.negativeTabIndexAllowed ? d(t) : c(t));
							},
						},
						{
							key: "previousElement",
				...
				return (
					i(t, [
						...
						},
						{
							...
							value: function (t) {
								t.element.removeEventListener("keydown", this.boundHandleKeyDown);
							},
						},
						{
							key: "handleKeyDown",
								...
								switch (t.which) {
									...
									case 38:
										this.hasChromevoxModifiers(t) ||
											(this.previousElement(t.target), t.preventDefault(), t.stopPropagation());
										break;
									case 39:
									case 40:
										this.hasChromevoxModifiers(t) ||
											(this.nextElement(t.target), t.preventDefault(), t.stopPropagation());
								}
							},
						},
						{
	...
	function (t, e, n) {
		...
		var o = (e.Keys = {
			...
			i = (e.isKey = function (t, e) {
				var n =
					arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : { ctrl: !1, shift: !1 };
				return -1 !== e.indexOf(t.which) && !(n.ctrl && !t.ctrlKey) && !(n.shift && !t.shiftKey);
			});
	...
	function (t, e, n) {
		...
		(H5P = H5P || {}), (H5P.InteractiveVideo = i.default);
	},
	function (t, e) {},
	function (t, e) {},
	function (t, e) {},
	...
	function (t, e, n) {
		...
		function i(t, e, n) {
			...
			H5P.EventDispatcher.call(s),
				...
				(s.contentData = n),
				(s.instanceIndex = C()),
				(s.bookmarksMenuId = "interactive-video-" + this.contentId + "-bookmarks-chooser"),
				(s.endscreensMenuId = "interactive-video-" + this.contentId + "-endscreens-chooser"),
				(s.qualityMenuId = "interactive-video-" + this.contentId + "-quality-chooser"),
				(s.captionsMenuId = "interactive-video-" + this.contentId + "-captions-chooser"),
				(s.playbackRateMenuId = "interactive-video-" + this.contentId + "-playback-rate-chooser"),
				(s.popupMenuButtons = []),
				(s.popupMenuChoosers = []),
				...
				(s.options.video.startScreenOptions = s.options.video.startScreenOptions || {}),
				(s.qualities = void 0),
				...
				t.override &&
					...
					t.override.showSolutionButton &&
						(s.override.enableSolutionsButton = "on" === t.override.showSolutionButton),
					t.override.retryButton && (s.override.enableRetry = "on" === t.override.retryButton)),
				void 0 !== t.override &&
					((s.showRewind10 = void 0 !== t.override.showRewind10 && t.override.showRewind10),
					(s.showBookmarksmenuOnLoad =
						void 0 !== t.override.showBookmarksmenuOnLoad && t.override.showBookmarksmenuOnLoad),
			...
			null !== a && 3 === a.length && (s.justVideo = a[2] < 10),
				(o =
					s.previousState && s.previousState.progress ? Math.floor(s.previousState.progress) : 0),
				0 === o && t.override && t.override.startVideoAt && (o = t.override.startVideoAt),
				...
				(s.$controls = k("<div>", { role: "toolbar", class: "h5p-controls hidden" })),
				(s.$read = k("<div/>", { "aria-live": "polite", class: "hidden-but-read" })),
				(this.fontSize = 16),
				(this.width = 640);
			var l = !1,
				c = !0,
				u = !1;
			if (((s.isTask = !1), (s.interactions = []), s.options.assets.interactions))
				for (var d = 0; d < s.options.assets.interactions.length; d++) this.initInteraction(d);
			(s.initialize = function () {
				if (!u) {
					...
					var e = this.editor
						? []
						: s.options.video.textTracks && s.options.video.textTracks.videoTrack
					...
					s.video.on("containerLoaded", function () {
						s.trigger("resize");
					}),
								...
								switch (n) {
									case H5P.Video.ENDED:
										(s.currentState = H5P.Video.ENDED),
											s.controls.$play.addClass("h5p-pause").attr("aria-label", s.l10n.play),
										...
										if ((s.endscreensMap[s.getDuration()] && o > 0 && s.toggleEndscreen(!0), r)) {
											s.video.play();
											var a = t.override && t.override.startVideoAt ? t.override.startVideoAt : 0;
											s.seek(a);
										}
										break;
									case H5P.Video.PLAYING:
										if (c) {
											s.addQualityChooser(),
												...
												(c = !1);
											var u = s.options.video.startScreenOptions.poster;
											u &&
												void 0 !== u.path &&
												setTimeout(function () {
													s.trigger("resize");
										...
										(s.currentState = H5P.Video.PLAYING),
											s.controls.$play.removeClass("h5p-pause").attr("aria-label", s.l10n.pause),
						...
						s.video.on("captions", function (t) {
							s.controls || (s.addControls(), s.trigger("resize")), s.setCaptionTracks(t.data);
						}),
				...
				(s.toggleMute = function () {
					...
					s.deactivateSound ||
						(e.hasClass("h5p-muted")
							? (e.removeClass("h5p-muted").attr("aria-label", s.l10n.mute), s.video.unMute())
							: (e.addClass("h5p-muted").attr("aria-label", s.l10n.unmute), s.video.mute()),
						t && (e.blur(), e.focus()));
				});
		}
		Object.defineProperty(e, "__esModule", { value: !0 });
		...
		(i.prototype = Object.create(H5P.EventDispatcher.prototype)),
			...
			(i.prototype.setCaptionTracks = function (t) {
				var e = this;
				if ((t.unshift(new H5P.Video.LabelValue("Off", "off")), e.captionsTrackSelector))
					return void e.captionsTrackSelector.updateOptions(t);
				var n = this.editor ? void 0 : e.options.video.textTracks.defaultTrackLabel,
					o = t.reduce(
						function (t, e) {
				...
				i || (i = t[0]),
					...
					e.controls.$volume
						...
						: k(e.captionsTrackSelector.control).insertAfter(e.controls.$qualityButton),
					...
					k(e.captionsTrackSelector.overlayControl).insertAfter(e.controls.$qualityButtonMinimal),
					...
					e.captionsTrackSelector.on("close", function () {
						e.controls.$overlayButtons.removeClass("h5p-hide"),
							"true" === e.controls.$more.attr("aria-expanded") && e.controls.$more.click(),
							e.resumeVideo();
					}),
					...
					e.minimalMenuKeyboardControls.insertElementAt(e.captionsTrackSelector.overlayControl, 2);
			}),
			...
			(i.prototype.attach = function (t) {
				...
				this.$read.appendTo(t),
					(this.readText = null),
					void 0 === this.editor
						? ((this.dnb = new H5P.DragNBar([], this.$videoWrapper, this.$container, {
								disableEditor: !0,
							})),
					...
					this.video.pressToPlay ||
						(this.currentState === i.LOADED ? this.addControls() : this.addSplash()),
					t.attr("tabindex", "-1");
				var o = function (t, n) {
					var o = e.controls && e.controls[n] ? e.controls[n] : void 0;
					return !(void 0 !== o && "-1" !== o.attr("tabindex")) || "INPUT" === t.target.nodeName;
				};
				(0, d.onKey)(t, [{ key: d.Keys.M }], function (t) {
					...
					this.$container.append(k(this.accessibility.getInteractionAnnouncer())),
				...
				void 0 !== this.editor ||
					...
					k(".h5p-splash", this.$splash).keydown(function (e) {
						(0, d.isSpaceOrEnterKey)(e) &&
							(t.video.play(), e.preventDefault(), t.$controls.find(".h5p-play").focus());
					}),
					...
					this.startScreenOptions.hideStartTitle && this.$splash.addClass("no-title"));
			}),
			(i.prototype.getDuration = function () {
				return (
					void 0 === this.duration && (this.duration = this.video.getDuration()), this.duration
				);
			}),
			(i.prototype.addControls = function () {
				var t = this,
					e = this;
				this.addSplash(), this.attachControls(this.$controls.removeClass("hidden"));
				var n = this.getDuration(),
					o = i.humanizeTime(n),
					r = i.formatTimeForA11y(n, e.l10n);
				if (
					(this.controls.$totalTime.find(".human-time").html(o),
					this.controls.$totalTime.find(".hidden-but-read").html(e.l10n.totalTime + " " + r),
					this.controls.$slider.slider("option", "max", n),
					(this.bookmarkMenuKeyboardControls = new l.default([new u.default()])),
					this.bookmarkMenuKeyboardControls.on("close", function () {
						return t.toggleBookmarksChooser(!1);
					}),
					(this.endscreenMenuKeyboardControls = new l.default([new u.default()])),
					this.endscreenMenuKeyboardControls.on("close", function () {
						return t.toggleEndscreensChooser(!1);
					}),
					this.addSliderInteractions(),
					this.addBookmarks(),
					this.options.assets.endscreens && this.options.assets.endscreens.length > 0)
				)
					for (
						var s = !1, a = this.getDuration(), c = this.options.assets.endscreens.length - 1;
						c >= 0;
						c--
					) {
						var d = this.options.assets.endscreens[c];
						d.time > a &&
							(s
								? (this.options.assets.endscreens.splice(c, 1),
									this.trigger("endscreensChanged", { index: c, number: -1 }))
								: ((this.options.assets.endscreens[c].time = a),
									(this.options.assets.endscreens[c].label =
										i.humanizeTime(a) + " " + this.l10n.endscreen),
									this.trigger("endscreensChanged", { index: c, number: 1 }),
									(s = !0)));
					}
			...
			(i.prototype.loaded = function () {
				...
				if (((this.oneSecondInPercentage = 100 / t), (t = Math.floor(t)), void 0 !== this.editor)) {
					var e = $("interactions", this.editor.field.fields),
						n = $("duration", e.field.fields).fields;
					(n[0].max = n[1].max = t), (n[0].min = n[1].min = 0);
					for (var o = $("adaptivity", e.field.fields).fields, r = 0; r < o.length; r++)
						o[r].fields && ($("seekTo", o[r].fields).max = t);
				}
				if (this.options.assets.interactions && this.options.assets.interactions.length > 0)
					for (var r = this.options.assets.interactions.length - 1; r >= 0; r--)
						if (this.options.assets.interactions[r].duration.to > t) {
							var s =
									this.options.assets.interactions[r].duration.to -
									this.options.assets.interactions[r].duration.from,
								a = t - s <= 0 ? 0 : t - s;
							(this.options.assets.interactions[r].duration.from = a),
								(this.options.assets.interactions[r].duration.to = t);
						}
				if (this.hasMainSummary()) {
					var l = t - this.options.summary.displayAt;
					l < 0 && (l = 0),
						void 0 === this.options.assets.interactions && (this.options.assets.interactions = []),
						this.options.assets.interactions.push({
							action: this.options.summary.task,
							x: 80,
							y: 80,
							duration: { from: l, to: t },
							displayType: "button",
							bigDialog: !0,
			...
			(i.prototype.initInteraction = function (t) {
				...
				if (e.override) {
					var o = {};
					n.adaptivity && n.adaptivity.requireCompletion && (o.enableRetry = !0),
				...
				return (
					r.on("display", function (t) {
						...
						w(o ? 100 : null, function () {
							(e.currentState === H5P.Video.PLAYING || e.currentState === H5P.Video.BUFFERING) &&
								r.pause() &&
								(e.focusInteraction || (e.focusInteraction = r), e.video.pause());
						}),
					...
					r.on("xAPI", function (t) {
						var n = t.getVerb();
						"interacted" === n && this.setProgress(p.default.PROGRESS_INTERACTED),
							-1 !== k.inArray(n, ["completed", "answered"]) && t.setVerb("answered"),
					...
					H5P.jQuery
						...
						.forEach(function (n) {
							...
							e.menuitems.push(o),
								...
								e.interactionsProgress[e.menuitems.length - 1] === p.default.PROGRESS_ANSWERED &&
									(n.setProgress(e.interactionsProgress[e.menuitems.length - 1]),
									o.addClass("h5p-interaction-answered")),
								void 0 !== o &&
									(o.appendTo(t.controls.$interactionsContainer),
									t.preventSkipping || t.interactionKeyboardControls.addElement(o.get(0)));
						}),
			...
			(i.prototype.handleInteractionTabIndex = function (t) {
			...
			(i.prototype.addBookmarks = function () {
				if (
					...
					for (var t = 0; t < this.options.assets.bookmarks.length; t++) this.addBookmark(t);
			}),
			(i.prototype.addEndscreenMarkers = function () {
				if (((this.endscreensMap = {}), void 0 !== this.options.assets.endscreens))
					for (var t = 0; t < this.options.assets.endscreens.length; t++) this.addEndscreen(t);
				this.editor &&
			...
			(i.prototype.toggleBookmarksChooser = function (t) {
				...
				if (this.controls.$bookmarksButton) {
					t = void 0 === t ? !this.controls.$bookmarksChooser.hasClass("h5p-show") : t;
					var n = this.controls.$bookmarksChooser.hasClass("h5p-show");
					this.controls.$minimalOverlay.toggleClass("h5p-show", t),
						this.controls.$minimalOverlay.find(".h5p-minimal-button").toggleClass("h5p-hide", t),
				...
				t
					? (this.closePopupMenus(this.controls.$bookmarksButton),
						(this.showBookmarksmenuOnLoad && e.initialLoad) ||
			...
			(i.prototype.toggleEndscreensChooser = function (t) {
				...
				if (this.editor && this.controls.$endscreensButton) {
					t = void 0 === t ? !this.controls.$endscreensChooser.hasClass("h5p-show") : t;
			...
			(i.prototype.updateChooserTime = function (t, e) {
				var n = t.find(e);
				n.html(n.data("default").replace("@timecode", i.humanizeTime(this.video.getCurrentTime())));
			}),
			...
			(i.prototype.showPreventSkippingMessage = function (t) {
				...
				e.preventSkippingWarningTimeout ||
					...
					setTimeout(function () {
						e.$preventSkippingMessage.addClass("h5p-show").attr("aria-hidden", "false");
					}, 0),
					(e.preventSkippingWarningTimeout = setTimeout(function () {
						e.$preventSkippingMessage.removeClass("h5p-show").attr("aria-hidden", "true"),
							setTimeout(function () {
			...
			(i.prototype.onBookmarkSelect = function (t, e) {
				...
				n.currentState !== H5P.Video.PLAYING &&
					...
					"true" === n.controls.$more.attr("aria-expanded") && n.$container.hasClass("h5p-minimal")
			...
			(i.prototype.addBookmark = function (t, e) {
					...
					.hover(
						function () {
							void 0 !== n.bookmarkTimeout && clearTimeout(n.bookmarkTimeout),
								n.controls.$bookmarksContainer.children(".h5p-show").removeClass("h5p-show"),
								i.addClass("h5p-show");
						},
						function () {
				...
				i
					...
					.css("maxWidth", parseInt(n.controls.$slider.parent().css("marginRight")) - 35),
					void 0 === n.controls.$bookmarksList &&
						(n.controls.$bookmarksList = k('<ul role="menu"></ul>').insertAfter(
							n.controls.$bookmarksChooser.find("h3"),
						));
				var r = k(
					'<li role="menuitem" aria-describedby="' + n.bookmarksMenuId + '">' + o.label + "</li>",
				)
					.click(function () {
						return n.onBookmarkSelect(i, o);
					})
					.keydown(function (t) {
						(0, d.isSpaceOrEnterKey)(t) && n.onBookmarkSelect(i, o), t.stopPropagation();
					});
				n.bookmarkMenuKeyboardControls.addElement(r.get(0));
				var s = n.controls.$bookmarksList.children(":eq(" + t + ")");
				return (
					0 !== s.length ? r.insertBefore(s) : r.appendTo(n.controls.$bookmarksList),
			...
			(i.prototype.addEndscreen = function (t, e) {
				...
				if (!this.editor)
					return (
						n.getDuration() - e < 1 && (e = n.getDuration()), void (i = n.endscreensMap[e] = !0)
					);
				(i = n.endscreensMap[e] =
					k(
						...
						.hover(
							function () {
								void 0 !== n.endscreenTimeout && clearTimeout(n.endscreenTimeout),
									n.controls.$endscreensContainer.children(".h5p-show").removeClass("h5p-show"),
									i.addClass("h5p-show");
							},
							function () {
					...
					void 0 === n.controls.$endscreensList &&
						(n.controls.$endscreensList = k('<ul role="menu"></ul>').insertAfter(
							n.controls.$endscreensChooser.find("h3"),
						));
				var r = k(
					'<li role="menuitem" aria-describedby="' + n.endscreensMenuId + '">' + o.label + "</li>",
				)
					.click(function () {
						return n.onEndscreenSelect(i, o);
					})
					.keydown(function (t) {
						(0, d.isSpaceOrEnterKey)(t) && n.onEndscreenSelect(i, o), t.stopPropagation();
					});
				n.endscreenMenuKeyboardControls.addElement(r.get(0));
				var s = n.controls.$endscreensList.children(":eq(" + t + ")");
				return (
					0 !== s.length ? r.insertBefore(s) : r.appendTo(n.controls.$endscreensList),
			...
			(i.prototype.attachControls = function (t) {
				...
				e.hasStar &&
					((e.$star = k("<div/>", { class: "h5p-control h5p-star", appendTo: t })),
					(e.$starBar = k("<div/>", {
						class: "h5p-control h5p-star h5p-star-bar",
						appendTo: e.$star,
					})),
					k("<div/>", { class: "h5p-control h5p-star h5p-star-background", appendTo: e.$star }),
					(e.$starAnimation = k("<div/>", {
						class: "h5p-control h5p-star h5p-star-animation h5p-star-animation-inactive",
						appendTo: e.$star,
					})));
				...
				e.preventSkipping && e.setDisabled(o),
					...
					e.showRewind10 &&
						(e.controls.$rewind10 = e.createButton("rewind10", "h5p-control", n, function () {
				...
				if (
					(c &&
						((e.controls.$bookmarksChooser = H5P.jQuery("<div/>", {
							...
							role: "dialog",
							html: '<h3 id="' + e.bookmarksMenuId + '">' + e.l10n.bookmarks + "</h3>",
						})),
						...
						e.controls.$bookmarksChooser.append(
							k("<span>", {
								...
								keydown: function (t) {
									(0, d.isSpaceOrEnterKey)(t) && (e.toggleBookmarksChooser(), t.preventDefault());
								},
							}),
						),
						e.showRewind10 && e.controls.$bookmarksChooser.addClass("h5p-rewind-displacement"),
					...
					var h = e.editor ? "star h5p-star-foreground-editor" : "star h5p-star-foreground",
						p = e.editor
							? function () {
					...
					(e.controls.$endscreensButton = e.createButton(h, "h5p-control", e.$star, p)),
				...
				e.editor &&
					((e.controls.$endscreensChooser = H5P.jQuery("<div/>", {
						...
						role: "dialog",
						html: '<h3 id="' + e.endscreensMenuId + '">' + e.l10n.endscreens + "</h3>",
					})),
					...
					e.controls.$endscreensChooser.append(
						k("<span>", {
							...
							keydown: function (t) {
								(0, d.isSpaceOrEnterKey)(t) && (e.toggleEndscreensChooser(), t.preventDefault());
							},
						}),
					),
					e.hasStar &&
				...
				var f =
					...
					v = k('<div class="h5p-control h5p-simple-time">' + f + "</div>").appendTo(n);
				...
				(e.controls.$more = e.createButton("more", "h5p-control", r, function () {
					"true" === e.controls.$more.attr("aria-expanded")
						? y()
					...
					(e.controls.$playbackRateChooser = H5P.jQuery("<div/>", {
						...
						role: "dialog",
						html: '<h3 id="' + e.playbackRateMenuId + '">' + e.l10n.playbackRate + "</h3>",
					})),
					e.popupMenuChoosers.push(e.controls.$playbackRateChooser);
				var S = function () {
					e.isMinimal ? e.controls.$more.click() : e.controls.$playbackRateButton.click(),
						e.resumeVideo();
				};
				e.controls.$playbackRateChooser.append(
					...
					e.controls.$playbackRateChooser.insertAfter(e.controls.$playbackRateButton),
					(function () {
						...
						((e.controls.$volume = e.createButton("mute", "h5p-control", r, e.toggleMute)),
						e.deactivateSound &&
							(e.controls.$volume.addClass("h5p-muted").attr("aria-label", e.l10n.sndDisabled),
					...
					(e.controls.$qualityChooser = H5P.jQuery("<div/>", {
						...
						role: "dialog",
						html: '<h3 id="' + e.qualityMenuId + '">' + e.l10n.quality + "</h3>",
					})),
					e.popupMenuChoosers.push(e.controls.$qualityChooser);
				var $ = function () {
					e.isMinimal ? e.controls.$more.click() : e.controls.$qualityButton.click(),
						e.resumeVideo();
				};
				e.controls.$qualityChooser.append(
					...
					e.editor ||
						...
						(e.controls.$fullscreen = e.createButton("fullscreen", "h5p-control", r, function () {
							e.toggleFullScreen();
						})),
				...
				(e.minimalMenuKeyboardControls = new l.default([new u.default()])),
					...
					c &&
						((e.controls.$bookmarkButtonMinimal = e.createButton(
							...
							w,
							function () {
								e.controls.$overlayButtons.addClass("h5p-hide"), e.toggleBookmarksChooser(!0);
							},
							!0,
						)),
						...
						e.minimalMenuKeyboardControls.addElement(e.controls.$bookmarkButtonMinimal.get(0))),
					...
					e.minimalMenuKeyboardControls.addElement(e.controls.$qualityButtonMinimal.get(0)),
					...
					e.minimalMenuKeyboardControls.addElement(e.controls.$playbackRateButtonMinimal.get(0)),
					e.addQualityChooser(),
					...
					(e.controls.$slider = k("<div/>", { appendTo: o }).slider({
						...
						create: function (t) {
							...
							n
								...
								e.preventSkipping && e.setDisabled(n).attr("aria-hidden", "true");
						},
						start: function () {
						...
						slide: function (t, n) {
							...
							if (o) {
								var r = (0, d.isKey)(t, [d.Keys.ARROW_RIGHT]),
									s = e.getDuration();
								(i = r ? Math.min(i + 5, s) : Math.max(i - 5, 0)), e.timeUpdate(i, !0);
							}
							return e.seek(i), e.updateInteractions(i), e.updateCurrentTime(i), !o;
						},
						stop: function (t, n) {
							(e.currentState = e.lastState), e.seek(n.value), e.recreateCurrentInteractions();
							var o =
								e.lastState === H5P.Video.PLAYING ||
								...
								(e.hasQueuedPause = !1),
									i && i.then
										? ((e.hasPlayPromise = !0),
											i.then(function () {
												setTimeout(function () {
													(e.hasQueuedPause || e.hasActivePauseInteraction()) && e.video.pause(),
														(e.hasPlayPromise = !1);
												}, 0);
											}))
							...
							e.$overlay.removeClass("h5p-visible"),
								e.editor &&
									(e.updateChooserTime(e.controls.$bookmarksChooser, ".h5p-add-bookmark"),
									e.updateChooserTime(e.controls.$endscreensChooser, ".h5p-add-endscreen"));
						},
					})),
			...
			(i.prototype.createButton = function (t, e, n, o, i) {
				...
				return (s[i ? "text" : "aria-label"] = r.l10n[t]), H5P.jQuery("<div/>", s);
			}),
			(i.prototype.addQualityChooser = function () {
				...
				if (
					...
					var a = k('<ul role="menu">' + o + "</ul>").appendTo(this.controls.$qualityChooser);
					a.children()
						.click(function () {
					...
					a
						...
						t.removeDisabled(this.controls.$qualityButton.add(this.controls.$qualityButtonMinimal));
				}
			}),
			(i.prototype.updateQuality = function (t) {
				...
				e.video.setQuality(t),
					"true" === e.controls.$more.attr("aria-expanded")
						...
						: (e.controls.$qualityButton.click(), e.controls.$qualityButton.focus());
			}),
			(i.prototype.addPlaybackRateChooser = function () {
				var t = this,
					e = this;
				if (
					((this.playbackRateMenuKeyboardControls = new l.default([new u.default()])),
					...
					if (
						...
						for (var o = this.video.getPlaybackRate(), i = "", r = 0; r < n.length; r++) {
							var s = n[r];
							i +=
						...
						a
							...
							e.removeDisabled(
								this.controls.$playbackRateButton.add(this.controls.$playbackRateButtonMinimal),
							);
					}
				}
			}),
			...
			(i.prototype.resize = function () {
				if (this.$container) {
					...
					this.$videoWrapper.css({ marginTop: "", marginLeft: "", width: "", height: "" }),
					...
					if (t) {
						if ((n = this.$videoWrapper.height()) + o <= i)
							this.$videoWrapper.css("marginTop", (i - o - n) / 2),
								...
								void 0 !== this.bubbleEndscreen && this.bubbleEndscreen.fullscreen(!0, i, n);
						else {
							...
							(e = s * r),
								...
								void 0 !== this.bubbleEndscreen && this.bubbleEndscreen.fullscreen(!0);
						}
						this.video.trigger("resize");
					} else
						(e = this.$container.width()),
							void 0 !== this.bubbleEndscreen && this.bubbleEndscreen.fullscreen();
					(this.scaledFontSize = e > this.width ? this.fontSize * (e / this.width) : this.fontSize),
						this.$container.css("fontSize", this.scaledFontSize + "px"),
						this.editor ||
							(e < this.width
								? this.$container.hasClass("h5p-minimal") || this.$container.addClass("h5p-minimal")
					...
					if (((this.controlsCss = { bottom: "", maxHeight: a + "px" }), t)) {
						var l = o;
						n + o <= i && (l = o + (i - o - n) / 2), (this.controlsCss.bottom = l + "px");
					}
					this.controls &&
						...
						this.editor
							? this.editor.dnb && this.editor.dnb.dnr.setContainerEm(this.scaledFontSize)
							: (this.resizeMobileView(), void 0 !== this.$splash && this.resizeStartScreen()),
						this.bubbleScore && (this.bubbleScore.update(), this.bubbleEndscreen.update()),
						this.resizeInteractions();
				}
			}),
			(i.prototype.resizeMobileView = function () {
				if (!isNaN(this.currentState)) {
					if (this.$container.width() / parseInt(this.$container.css("font-size"), 10) < 30) {
			...
			(i.prototype.resizeStartScreen = function () {
				...
				(void 0 !== this.startScreenOptions.shortStartDescription &&
					this.startScreenOptions.shortStartDescription.length) ||
					((e = !1), this.startScreenOptions.hideStartTitle && ((n = !1), (t = 45)));
				...
				e || (n && u < a ? (u = a) : u < 10 && (u = 10)),
					c < 510 ? this.$splash.addClass("mobile") : this.$splash.removeClass("mobile"),
					0.8 * u < a ? o.addClass("minimum-font-size") : o.removeClass("minimum-font-size"),
					1.5 * u < l ? i.addClass("minimum-font-size") : i.removeClass("minimum-font-size"),
			...
			(i.prototype.timeUpdate = function (t, e) {
				...
				n.updateInteractions(t),
					e ||
						setTimeout(function () {
							(n.currentState === H5P.Video.PLAYING ||
								(n.currentState === H5P.Video.BUFFERING && n.lastState === H5P.Video.PLAYING)) &&
								n.timeUpdate(n.video.getCurrentTime());
						}, 40);
			}),
			(i.prototype.updateInteractions = function (t) {
				...
				var o = Math.floor(t);
				o !== e.lastSecond &&
					((e.currentState !== H5P.Video.PLAYING && e.currentState !== H5P.Video.PAUSED) ||
			...
			(i.prototype.disableTabIndexes = function () {
				var t =
						arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ".h5p-dialog-wrapper",
					e = this,
			...
			(i.prototype.showWarningMask = function () {
				var t = this,
					e =
						"interactive-video-" + t.contentId + "-" + t.instanceIndex + "-completion-warning-text";
				return (
					t.$mask ||
						(t.$mask = k(
			...
			(i.prototype.hasUncompletedRequiredInteractions = function (t) {
				var e = this;
				return (void 0 !== t ? e.getVisibleInteractionsAt(t) : e.getVisibleInteractions()).some(
					function (t) {
						return t.getRequiresCompletion() && !t.hasFullScore();
					},
				);
			...
			(i.prototype.getTitle = function () {
				return H5P.createTitle(
					this.contentData && this.contentData.metadata && this.contentData.metadata.title
			...
			(i.prototype.findNextInteractionToShow = function (t, e) {
				for (var n = void 0, o = 0; o < this.interactions.length; o++) {
					...
					if (this.interactions[o].visibleAt(t) && !this.interactions[o].isVisible()) {
						n = o;
						break;
					}
					(i.from > t || (i.from == t && (void 0 === e || o > e))) &&
						(void 0 === n || i.from < this.interactions[n].getDuration().from) &&
						(n = o);
				}
				return n;
			}),
			(i.prototype.findNextInteractionToHide = function (t) {
				for (var e = void 0, n = 0; n < this.visibleInteractions.length; n++) {
					...
					(void 0 === e ||
						o.to < this.interactions[this.visibleInteractions[e]].getDuration().to) &&
						(e = n);
				}
				return e;
			}),
			(i.prototype.hideInteractions = function (t) {
				...
				for (
					var e =
						void 0 !== this.nextInteractionToHide
							? this.interactions[this.visibleInteractions[this.nextInteractionToHide]]
							: null;
					e && !e.visibleAt(t);
			...
			(i.prototype.seek = function (t) {
				(this.nextInteractionToShow = this.nextInteractionToHide = void 0), this.video.seek(t);
			}),
			...
			(i.prototype.resetTask = function () {
				if (void 0 !== this.controls) {
					this.seek(0), this.timeUpdate(-1), this.controls.$slider.slider("option", "value", 0);
					for (var t = 0; t < this.interactions.length; t++) this.interactions[t].resetTask();
				}
			}),
			...
			(i.prototype.getCopyrights = function () {
				...
				void 0 !== t.options.video.files &&
					...
					e.addMedia(new H5P.MediaCopyright(t.options.video.files[0].copyright, t.l10n)),
				...
				if (n && void 0 !== n.copyright) {
					...
					o.setThumbnail(new H5P.Thumbnail(i, n.width, n.height)), e.addMedia(o);
				}
				...
				if (t.hasMainSummary()) {
					...
					if (void 0 !== a) {
						...
						l.addContent(H5P.getCopyrights(a, { action: t.options.summary.task }, t.contentId)),
			...
			(i.secondsToMinutesAndHours = function (t) {
				...
				return { seconds: Math.floor(t % 60), minutes: e % 60, hours: Math.floor(e / 60) };
			});
		var S = function (t, e) {
			...
			C = function () {
				return (
					void 0 === window.interactiveVideoCounter && (window.interactiveVideoCounter = 0),
		...
		(i.prototype.getXAPIData = function () {
			...
			T(e),
				e.setScoredResult(t.getScore(), t.getMaxScore(), t, !0, t.getScore() === t.getMaxScore());
			var n = E(t.interactions);
			return { statement: e.data.statement, children: n };
		}),
			(i.prototype.getContext = function () {
				var t = this,
					e = t.video.getCurrentTime();
				return void 0 === e ? {} : { type: "time", value: e };
			});
		var T = function (t) {
			...
			P = function (t, e) {
				return void 0 !== t && void 0 !== e && (t.is(e) || k.contains(t.get(0), e.get(0)));
			},
			E = function (t) {
				return t
					.map(function (t) {
		...
		var i = n(0),
			...
			c = function (t, e, n, o, i, s) {
				...
				(c.updateOptions = function (t) {
					...
					(c.popup = u("h5p-chooser h5p-" + t, '<h3 id="' + h + '">' + i[t] + "</h3>")),
					c.popup.setAttribute("role", "dialog");
				var $ = d("h5p-chooser-close-button", l.ICON, i.close, g, "div", "button");
				c.popup.appendChild($),
					(c.control = d("h5p-control h5p-" + t, l.ICON, i[t], g, "div", "button")),
					c.control.setAttribute("aria-haspopup", "true"),
					(c.overlayControl = d("h5p-minimal-button h5p-" + t, l.TEXT, i[t], g, "div", "menuitem")),
					(c.overlayControl.tabIndex = "-1"),
					c.updateOptions(e);
			};
		(c.prototype = Object.create(H5P.EventDispatcher.prototype)), (c.prototype.constructor = c);
			...
			d = function (t, e, n, o, i, r) {
				...
				return (
					...
					s.addEventListener(
						"keydown",
						function (t) {
							(32 !== t.which && 13 !== t.which) || (t.preventDefault(), o.call(s, t));
						},
						!1,
					),
					s
		...
		e.Eventful = function () {
			return {
				...
				on: function (t, e, n) {
					...
					return (this.listeners[t] = this.listeners[t] || []), this.listeners[t].push(o), this;
				},
				fire: function (t, e) {
	...
	function (t, e, n) {
		...
		function o(t, e, n) {
			...
			var g,
				...
				T = [
					b.params.contentName,
					C ? a(t.label) : "",
					"H5P.Link" === $ && void 0 !== b.params.title ? b.params.title : t.libraryTitle,
				].filter(s)[0],
				x = !1,
				P = !1,
				E = !1,
			...
			var A = function () {
					return r.extend({}, { backgroundColor: "rgb(255,255,255)", boxShadow: !0 }, t.visuals);
				},
				B = function (n) {
					(h = r("<div/>", {
						tabindex: 0,
						...
						e.editor &&
							h
								.hover(
									function () {
										h.is(".focused") || h.is(":focus") || (e.dnb && (!e.dnb || e.dnb.newElement))
				...
				H = function () {
					return (
						(h = M(t.label, "h5p-interaction h5p-interaction-label-standalone")),
						h.css({ left: t.x + "%", top: t.y + "%", width: "", height: "initial" }),
						o.trigger("display", h),
						setTimeout(function () {
							h && h.removeClass("h5p-hidden");
						}, 0),
				...
				D = function (e) {
					if ("timecode" === t.goto.type)
						...
						}).attr({ href: ("other" !== n.protocol ? n.protocol : "") + n.url, target: "_blank" });
					}
				...
				L = function (n) {
					...
					var a = o.isGotoClickable(),
						u = i.find("[tabindex]"),
						d = r(a ? "<a>" : "<div>", { class: "h5p-dialog-interaction h5p-frame" });
					!a && p($) && d.attr("tabindex", "0"),
						void 0 !== e.editor ? d.attr("tabindex", -1) : 0 === u.length && d.attr("tabindex", 0),
						o.getRequiresCompletion() &&
							i.keydown(function (t) {
								var e = i.find('[tabindex="0"], button, input').filter(":visible");
								q(e, t);
							});
					var f = a ? D(d) : d;
					if (
							...
							i.click(function () {
								if (!o.hasFullScore()) {
									e.showWarningMask()
										...
										.click(function () {
											return d.find("button").last().focus();
										});
								}
							}));
					e.dnb.dialog.open(d),
						...
						e.dnb.dialog.toggleClass("goto-clickable-visualize", !(!a || !t.goto.visualize)),
					...
					var v = function () {
						...
						h && (h.focus(), h.attr("aria-expanded", "false")), y && y.trigger("hide");
						var t = i.find(".h5p-dialog-titlebar"),
							n = t.find(".h5p-sc-sound-control");
						if (n.length) {
							i.find(".h5p-sc-set-wrapper").append(n);
						}
					};
					e.dnb.dialog.once("close", v);
					var m = function t() {
						(o.dialogWidth = e.dnb.dialog.getDialogWidth()), e.dnb.dialog.off("close", t);
					};
					if ((e.dnb.dialog.on("close", m), "H5P.Image" === $)) {
						var g = e.dnb.dialog.getMaxSize(h),
							k = d.find("img");
						b.params.file.width && b.params.file.height
							...
							: (k.on("load", function () {
									k.is(":visible") &&
										N(k, g, { width: this.width, height: this.height }, !e.isMobileView);
								}),
						...
						e.isMobileView ||
							("H5P.FreeTextQuestion" === $
								...
								: "H5P.Text" !== $ && "H5P.Table" !== $
									? e.dnb.dialog.position(h, { width: o.dialogWidth / 16 }, "medium")
									: e.dnb.dialog.position(h, { width: o.dialogWidth / 16 }, null));
					if ("H5P.Summary" === $) {
						var S = 0;
					...
					if ((s.find(".h5p-sc-sound-control").remove(), i.find(".h5p-sc-sound-control").length)) {
						var w = i.find(".h5p-sc-sound-control"),
							C = i.find(".h5p-dialog-close");
						if (C.length && "none" !== C.css("display")) {
							var T = 2 * parseFloat(C.css("right")) + 2 * parseFloat(C.css("padding-right"));
							w.css({ right: T + "px" });
						}
						s.append(w);
					}
				...
				N = function (t, n, o, i) {
					(o.width /= 16),
						(o.height /= 16),
						o.height > n.height &&
							((o.width = (o.width * n.height) / o.height), (o.height = n.height)),
						o.width > n.width && ((o.height = (o.height * n.width) / o.width), (o.width = n.width));
				...
				W = function (n) {
					o.isButton() && e.dnb.dialog.close(),
						(e.currentState !== H5P.Video.PAUSED && e.currentState !== H5P.Video.ENDED) || e.play();
					var i = n.data;
				...
				z = function () {
					...
					return {
						height: (n / (i / (e.$videoWrapper.width() / e.$videoWrapper.height()))) * 100 + "%",
						width: (o / i) * 100 + "%",
					};
				},
				F = function (t) {
				...
				_ = function () {
					...
					if (
						((h = r("<div/>", {
							...
							css: { left: t.x + "%", top: t.y + "%", width: i.width, height: i.height },
						})),
						"H5P.IVHotspot" !== $)
					) {
						...
						if (a[3]) {
							0 === parseFloat(a[3].replace(")", "")) && h.addClass("h5p-transparent-interaction");
						}
					}
					!1 === s.boxShadow && h.addClass("h5p-box-shadow-disabled"),
						...
						(v = r(n ? "<a>" : "<div>", { class: "h5p-interaction-inner h5p-frame" }).appendTo(m)),
				...
				j = function () {
					...
					if (
						...
						return void (
							...
							(y.hasButton("iv-continue") ||
								y.addButton("iv-continue", e.l10n.defaultAdaptivitySeekLabel, function () {
									R(), U();
								}),
					...
					e.pause(),
						!n.allowOptOut &&
							h &&
							(o.isButton()
								? ((e.dnb.dialog.disableOverlay = !0), e.dnb.dialog.hideCloseButton())
								: F(h));
					...
					y
						...
						.addButton("iv-adaptivity-" + s, a, function () {
							R(n.seekTo),
								!i && y.resetTask && (y.resetTask(), y.hideButton("iv-adaptivity-" + s)),
								o.remove(),
								U(n.seekTo);
						})
						...
						void 0 !== y.disableInput &&
							(y.disableInput instanceof Function || "function" == typeof y.disableInput) &&
							y.disableInput(),
						setTimeout(function () {
				...
				U = function (t) {
					...
					if (
						(o.length
							? (n = o)
							: n.length && e.$container.find(".h5p-dialog-wrapper .h5p-dialog").show(),
						n.length)
					) {
						var i = n[0];
						return i.isButton() ? i.trigger("open-dialog") : i.trigger("show-mask"), void e.pause();
					}
					e.currentState !== H5P.Video.ENDED &&
						(void 0 !== t && (e.pause(), e.seek(t)), e.play(), e.controls.$play.focus());
				},
				G = function () {
					return e
				...
				Q = function () {
					...
					return t.goto && "timecode" === t.goto.type && (e += " h5p-goto-timecode"), e;
				};
			(o.isGotoClickable = function () {
				...
				(o.getCurrentState = function () {
					if (
						y &&
						(y.getCurrentState instanceof Function || "function" == typeof y.getCurrentState)
					)
				...
				(o.selectDot = function () {
					e.preventSkipping ||
						((e.seekingTo = !0),
						Math.floor(10 * e.video.getCurrentTime()) !== Math.floor(10 * t.duration.from) &&
					...
					var n = "h5p-seekbar-interaction " + g,
						i = r("<div/>", {
							...
							on: {
								click: o.selectDot,
								keydown: function (t) {
									if (13 === t.which || 32 === t.which) return o.selectDot(), !1;
								},
							},
						});
					return (
						e.preventSkipping && i.attr("aria-disabled", "true").attr("tabindex", "-1"),
						(o.$menuitem = i),
						i
					);
				}),
				...
				(o.toggle = function (n, i) {
					if (!o.visibleAt(n))
						return (
							...
							void (
								...
								(S &&
									(S.hideContextMenu(),
									S === e.dnb.focusedElement && (S.blur(), delete e.dnb.focusedElement)),
					...
					if (!h)
						return (
							...
							void 0 === e.editor
								? (S = e.dnb.add(h, void 0, { dnbElement: S, disableContextMenu: !0 }))
				...
				(o.reCreate = function () {
					(g = Q()),
						o.isStandaloneLabel() ||
							...
							void 0 === o.maxScore && y.getMaxScore && (o.maxScore = y.getMaxScore()),
							b.userDatas && X(y) && (o.score = y.getScore()),
							e.isTask ||
								void 0 === e.options.assets.endscreens ||
								((y.isTask || (void 0 === y.isTask && void 0 !== y.showSolutions)) &&
									(e.isTask = !0)),
							y.on &&
								(y.on("xAPI", function (t) {
									var n =
										...
										r = "completed" === t.getVerb() || "answered" === t.getVerb(),
										s = n.some(function (t) {
											return t.id === i;
										});
								...
								y.on("resize", function () {
									delete o.dialogWidth, e && e.dnb && e.dnb.dialog.removeStaticWidth();
								}),
			...
			(o.setDnbElement = function (t) {
				...
				(o.getXAPIData = function () {
					if (y && (y.getXAPIData instanceof Function || "function" == typeof y.getXAPIData))
				...
				(o.getClipboardData = function () {
					return H5P.DragNBar.clipboardify(H5PEditor.InteractiveVideo.clipboardKey, t, "action");
				}),
				...
				(o.resetTask = function () {
					void 0 !== b.userDatas && void 0 !== b.userDatas.state && delete b.userDatas.state,
						delete o.score,
						delete o.maxScore,
						o.reCreate();
				}),
			...
			a = (function () {
				function t(e) {
					...
					o(this, t),
						...
						(this.$innerTail = r("<div/>", { class: this.style + "-inner-tail" })),
								...
								var t = this,
									...
									n =
										"full" === this.mode
											...
											: Math.min(
													0.9 * e.outerWidth,
													"auto" === this.maxWidth ? this.$bubble.outerWidth() : this.maxWidth,
												),
								...
								"centered" === this.mode &&
									...
									setTimeout(function () {
										var e = t.getTailPosition(t.$reference),
											n = {
												bottom: e.bottom + "px",
												left: "string" == typeof e.left ? e.left : e.left + "px",
											};
						...
						},
						{
							...
							value: function () {
								...
								this.$bubble.hasClass(this.style + "-inactive") &&
									...
									setTimeout(function () {
										t.$bubble.removeClass(t.style + "-active").addClass(t.style + "-inactive");
									}, 2e3));
							},
						},
						{
						...
						},
						{
							...
							value: function (t) {
								...
								(t = void 0 === t ? !this.isActive() : t),
									t && n
										? (setTimeout(function () {
												e.$bubble.removeClass(e.style + "-preparing").addClass(e.style + "-active"),
													setTimeout(function () {
														return e.focus();
													}, 400);
											}, 100),
	...
	function (t, e, n) {
		...
		var s = (function () {
			...
			a = n(17),
			l = H5P.jQuery,
			c = "h5p-interactive-video-endscreen",
			u = "h5p-interactive-video-endscreen-submit-button-hidden",
			d = function (t) {
					...
					s(e, [
						{
							...
							value: function () {
								var t = this;
								(this.$endscreenIntroductionTitleText = l("<div/>", {
									class: c + "-introduction-title-text",
									id: c + "-introduction-title-text",
								})),
									(this.$closeButton = l("<div>", {
										role: "button",
										class: c + "-close-button",
										tabindex: "0",
										"aria-label": this.parent.l10n.close,
									})),
									(0, a.onClick)(this.$closeButton, function () {
										return t.parent.toggleEndscreen(!1);
									});
								var e = l("<div/>", { class: c + "-introduction-title" }).append([
									this.$endscreenIntroductionTitleText,
									this.$closeButton,
								]);
								(this.$endscreenIntroductionText = l("<div/>", {
									class: c + "-introduction-text",
									id: c + "-introduction-text",
								})),
									(this.$submitButtonContainer = l("<div/>", {
										class: c + "-submit-button-container " + u,
									})),
									(this.$submitButton = H5P.JoubelUI.createButton({
										class: c + "-submit-button",
									...
									(this.$endscreenOverviewTitle = l("<div/>", { class: c + "-overview-title" })
										.append(
											l("<div/>", {
												class: c + "-overview-title-answered-questions",
												html: this.l10n.tableRowAnswered,
											}),
										)
										.append(
											l("<div/>", {
												class: c + "-overview-title-score",
												html: this.l10n.tableRowScore,
											}),
										)),
									(this.$endscreenBottomTable = l("<div/>", { class: c + "-overview-table" })),
									(this.$endscreen = l("<div/>", {
										class: c,
										role: "dialog",
										"aria-labelledby": c + "-introduction-title-text",
										"aria-describedby": c + "-introduction-text",
									})
										.append(
											l("<div/>", { class: c + "-introduction" })
												.append(l("<div/>", { class: c + "-star-symbol" }))
												.append(
													l("<div/>", { class: c + "-introduction-container" }).append([
														e,
						...
						},
						{
							...
							value: function () {
								var t = this;
								this.$submitButtonContainer.hasClass(u) ||
									(this.$submitButtonContainer.addClass(u),
									...
									this.answered.forEach(function (e) {
										if ("completed" !== e.getLastXAPIVerb() && "answered" !== e.getLastXAPIVerb()) {
						...
						},
						{
							...
							value: function (t, e, n, o) {
								var i = this,
									...
									u = this.parent.skippingPrevented() ? " " + c + "-no-link" : "",
									h = l("<div/>", {
										class: c + "-overview-table-row" + u,
										role: "row",
										tabIndex: 0,
										"aria-label": s
											.replace("@score", n)
								...
								return (
									(0, a.onClick)(h, function () {
										return i.jump(t);
									}),
									l("<div/>", {
										class: c + "-overview-table-row-time",
										html: H5P.InteractiveVideo.humanizeTime(t),
										appendTo: h,
										"aria-hidden": !0,
									}),
									l("<div/>", {
										class: c + "-overview-table-row-title",
										html: e,
										appendTo: h,
										"aria-hidden": !0,
									}),
									l("<div/>", {
										class: c + "-overview-table-row-score",
						...
						},
						{
							...
							value: function () {
								...
								this.$endscreenIntroductionTitleText.html(this.l10n.title.replace("@answered", n)),
									0 === n
										? this.$endscreenIntroductionText.html(
												'<div class="' +
													c +
									...
									n > 0 && this.$submitButtonContainer.removeClass(u);
							},
						},
						{
							key: "getDescription",
	...
	function (t, e, n) {
		...
		e.onClick = function (t, e) {
			...
			t.click(l), !0 !== r && (0, o.onKey)(t, [{ key: o.Keys.SPACE }, { key: o.Keys.ENTER }], l);
		};
	},
]);
