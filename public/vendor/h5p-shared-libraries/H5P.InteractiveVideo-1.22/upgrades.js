				...
				if (
					...
					for (var i = 0; i < interactions.length; i++) {
						if (interactions[i].action && interactions[i].action.subContentId === undefined) {
							...
							// future
							interactions[i].action.subContentId = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(
								/[xy]/g,
								function (char) {
				...
				if (
					...
					for (i = 0; i < interactions.length; i++) {
						...
						interaction.displayType =
							interaction.displayAsButton === undefined || interaction.displayAsButton
								? "button"
								: "poster";
			...
			10: function (parameters, finished) {
				if (parameters.override) {
					if (parameters.override.overrideButtons) {
						// Set new variables
						parameters.override.showSolutionButton = parameters.override.overrideShowSolutionButton
							? "on"
							: "off";
