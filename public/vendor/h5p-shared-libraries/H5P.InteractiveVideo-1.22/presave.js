...
H5PPresave["H5P.InteractiveVideo"] = function (content, finished) {
	...
	function isContentInvalid() {
		return (
			!presave.checkNestedRequirements(content, "content.interactiveVideo.assets.interactions") ||
	...
	function hasSummary() {
		return (
			presave.checkNestedRequirements(content, "content.interactiveVideo.summary.task.library") &&
			presave.checkNestedRequirements(content, "content.interactiveVideo.summary.task.params")
		);
	}
};
