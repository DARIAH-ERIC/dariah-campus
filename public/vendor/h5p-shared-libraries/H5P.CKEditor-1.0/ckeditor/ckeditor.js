...
(function () {
					...
					on: function (b, c, l, h, k) {
						...
						if (0 > y.getListenerIndex(c)) {
							...
							for (var z = y.length - 1; 0 <= z; z--)
								if (y[z].priority <= k) return y.splice(z + 1, 0, p), { removeListener: f };
							y.unshift(p);
						}
					...
					fire: (function () {
						...
						return function (k, p, f) {
							...
							if (x) {
								var z = x.listeners;
								if (z.length)
									for (var z = z.slice(0), C, w = 0; w < z.length; w++) {
										if (x.errorProof)
											try {
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			getDocumentPosition: function (a) {
				...
				if (
					...
					for (w = this, n = null; w && "body" != w.getName() && "html" != w.getName(); ) {
			...
			scrollIntoParent: function (a, b, c) {
				...
				function w(a, b) {
					...
					f = a.getWindow();
					f.equals(b) ||
						((f = w(CKEDITOR.dom.element.get(f.$.frameElement), b)), (c.x += f.x), (c.y += f.y));
					return c;
				}
				function n(a, b) {
						...
						? f.type == CKEDITOR.NODE_ELEMENT &&
							(f =
								0 < g
									...
									: !1 === x(f, !0)
										? null
										: f.getPreviousSourceNode(!0, m, x))
						: ((f = d),
							f.type == CKEDITOR.NODE_ELEMENT &&
								((f = f.getChild(e)) ||
									(f = !1 === x(d, !0) ? null : d.getNextSourceNode(!0, m, x)))),
					f && !1 === x(f) && (f = null));
			for (; f && !this._.end; ) {
				this.current = f;
		...
		function d(a, b, c, d, e) {
			...
			if (
				...
				for (
					...
					aa = da.getNext();
					for (
						U != J || (da.equals(t[U]) && J < v)
							? b && (D = B.append(da.clone(0, e)))
							: M
								? g(da, B, !1, F)
								: u && B.append(a.document.createText(da.substring(L)));
						aa;
			...
			enlarge: function (a, b) {
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						this.setStartAt(
							u,
							!u.is("br") && ((!k && this.checkStartOfBlock()) || (k && u.contains(k)))
						...
						this.setEndAt(
							u,
							(!k && this.checkEndOfBlock()) || (k && u.contains(k))
		...
		a.prototype = {
			getNextParagraph: function (a) {
				...
				if (!this._.started) {
					...
					l = w.startPath();
					var n = w.endPath(),
						H = !w.collapsed && c(w, l.block),
						q = !w.collapsed && c(w, n.block, 1);
					...
					w.collapsed ||
						((l = new CKEDITOR.dom.walker(w.clone())),
						...
						(l.evaluator = n),
						(l = l.previous()),
						(this._.lastNode = l.getNextSourceNode(!0, null, w.root)),
						this._.lastNode &&
						...
						(this._.lastNode && w.root.contains(this._.lastNode)) ||
							((this._.lastNode = this._.docEndMarker = w.document.createText("")),
						...
						: !d || (this.enforceRealBlocks && d.is(k))
							...
							: "li" != d.getName()
								? (l.checkStartOfBlock() && l.checkEndOfBlock()) ||
									...
									l.insertNode(d))
								: y ||
									(this._.nextNode = d.equals(w)
										? null
										: this._getNextSourceNode(l.getBoundaryNodes().endNode, 1, w));
				}
				z &&
					(z = d.getPrevious()) &&
					...
					("br" == z.getName()
						? z.remove()
						: z.getLast() && "br" == z.getLast().$.nodeName.toLowerCase() && z.getLast().remove());
				C &&
					(z = d.getLast()) &&
					z.type == CKEDITOR.NODE_ELEMENT &&
					"br" == z.getName() &&
					...
					z.remove();
				this._.nextNode ||
					(this._.nextNode = y || d.equals(w) || !w ? null : this._getNextSourceNode(d, 1, w));
				return d;
			},
	...
	(function () {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				...
				for (r in Q) {
					...
					for (; (O = u.pop()); ) (h[O] = h["!" + O]), delete h["!" + O];
					E[t] = (B ? !1 : n) || null;
				}
			...
			if (f.doFilter) {
				...
				if (!a.allAttributes)
					for (k in t)
						F[k] ||
							(Q.test(k)
								? k == (A = k.replace(/^data-cke-saved-/, "")) || F[A] || (delete t[k], (u = !0))
								: (delete t[k], (u = !0)));
		...
		function G(a, b) {
			...
			for (f in d)
				if ("class" == f)
					for (c = d[f].split(/\s+/), g = a.classes.join("|"); (v = c.pop()); ) {
			...
			if (c && !b) {
				...
				!0 === d
					...
					: (d || (this.customConfig = !1),
						...
						this.allow(u[c.enterMode] + " " + u[c.shiftEnterMode], "default", 1),
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						...
						for (m = 0; m < b.length; ++m)
							(g = b[m]),
								"string" == typeof g
									? ((g = g.split(/\s*:\s*/)), (v = g[0]), (t = null), (r = g[1]))
									: ((v = g.check), (t = g.left), (r = g.right)),
								f ||
									((f = g),
									(f = f.element
										? f.element
			...
			check: function (a, b, c) {
				...
				if ("string" == typeof a) {
					...
					(e = a.getDefinition()),
						(v = e.styles),
						(d = e.attributes || {}),
						v && !CKEDITOR.tools.isEmpty(v)
							? ((v = F(v)), (d.style = CKEDITOR.tools.writeCssText(v, !0)))
							: (v = {}),
						(e = {
							name: e.element,
							attributes: d,
				...
				0 < t.length
					...
					: ((b = e.attributes["class"]) &&
						...
						(c = CKEDITOR.tools.objectCompare(e.attributes, v.attributes, !0)),
		...
		B = CKEDITOR.filter.transformationsTools = {
			...
			transform: function (a, b) {
				if ("string" == typeof b) a.name = b;
					...
					for (f in e)
						if ("class" == f)
							for (c = a.classes.join("|"), g = e[f].split(/\s+/); (v = g.pop()); )
					...
					a.call(
						...
						function (a) {
							...
							for (f in a) {
								...
								if (!d[f]) {
									if (h.icons)
										for (var z = h.icons.split(","), C = z.length; C--; )
								...
								if (y)
									for (y.split && (y = y.split(",")), h = 0; h < y.length; h++)
										e[y[h]] || b.push(y[h]);
							}
	...
	(function () {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function (e, l, h) {
			...
			function x(b, c, d) {
				...
				var e = q;
				void 0 === b.previous &&
					(y(c, b) && ((q = c), C.onTagOpen(h, {}), (b.returnPoint = c = q)),
					f(b),
							...
							if (q.isOptionalClose) C.onTagClose(g);
								...
								(g = q.children),
									((g = g[g.length - 1]) && "li" == g.name) ||
										x((g = new CKEDITOR.htmlParser.element("li")), q),
									!f.returnPoint && (f.returnPoint = q),
									(q = g);
							else if (e in CKEDITOR.dtd.$listItem && !z(e, g))
								C.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
							else if (g in d && !z(e, g)) !f.returnPoint && (f.returnPoint = q), (q = q.parent);
							else if ((g in CKEDITOR.dtd.$inline && n.unshift(q), q.parent)) x(q, q.parent, 1);
							else {
								f.isOrphan = 1;
								break;
							}
				...
				return function (g) {
					if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var v = [],
							...
							E;
						if (m)
							for (r(m, 1) && v.push(m); m; )
								e(m) &&
									(t = c(m)) &&
									r(t) &&
									((E = c(t)) && !e(E) ? v.push(t) : (f(h).insertAfter(t), t.remove())),
									(m = m.previous);
						for (m = 0; m < v.length; m++) v[m].remove();
						if ((v = !a || !1 !== ("function" == typeof d ? d(g) : d)))
							h || CKEDITOR.env.needsBrFiller || g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
								? h ||
									CKEDITOR.env.needsBrFiller ||
									!(
									...
									? ((v = b(g)), (v = !v || ("form" == g.name && "input" == v.name)))
									: (v = !1)
								: (v = !1);
						v && g.add(f(a));
					}
			...
			function r(a, b) {
				...
				return a.type == CKEDITOR.NODE_TEXT &&
					...
					(c.index &&
						...
						(a.value = c[0])),
					(!CKEDITOR.env.needsBrFiller && h && (!b || a.parent.name in u)) ||
						(!h && (((c = a.previous) && "br" == c.name) || !c || e(c))))
					? !0
					: !1;
			}
			var E = { elements: {} },
		...
		function f(a, b) {
			return a.replace(b, function (a, b, c) {
				0 === a.indexOf("\x3ctextarea") &&
					(a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e");
			...
			proto: {
				...
				extractHtmlFromRange: function (a, b) {
					...
					if (b) {
						...
						c.autoParagraph(this.editor, a), z(a.startContainer) && a.startContainer.appendBogus();
						...
						CKEDITOR.env.gecko &&
							this.attachListener(this, "mouseup", function (b) {
								if (
									2 == b.data.$.button &&
									((b = b.data.getTarget()),
									!b.getAscendant("table") && !b.getOuterHtml().replace(w, ""))
								) {
									var c = a.createRange();
			...
			return function (t, u, J, v) {
				...
				if (!v.checkReadOnly()) {
					...
					if ((q = C.contains(f, !1, 1)))
						(x = D.splitElement(q)), (u.inlineStylesRoot = q), (u.inlineStylesPeak = C.lastElement);
					C = D.createBookmark();
					y && (k(q), k(x));
					...
					B.enterMode === CKEDITOR.ENTER_DIV &&
						...
						v.setStartAt(t, CKEDITOR.POSITION_AFTER_START),
						v.collapse(!0));
					if ((t = J)) {
						t = u.range;
						if ("text" == u.type && u.inlineStylesRoot) {
							...
							for (x = u.inlineStylesRoot.getParent(); !v.equals(x); )
								(B = B.appendTo(v.clone())), (v = v.getParent());
					...
					if (t) {
						...
						for (F(B, P); x < B.length; x++) {
							...
							if ((y = D.isLineBreak))
								(y = P),
									...
									D.hasBlockSibling
										? (y = 1)
										: (T = y.startContainer.getAscendant(E.$block, 1)) && T.is({ div: 1, p: 1 })
											? ((H = T.getPosition(q)),
												H == CKEDITOR.POSITION_IDENTICAL || H == CKEDITOR.POSITION_CONTAINS
													? (y = 0)
													: ((q = y.splitElement(T)),
														y.moveToPosition(q, CKEDITOR.POSITION_AFTER_START),
														(y = 1)))
											: (y = 0);
							if (y) J = 0 < x;
							else {
								y = P.startPath();
								!D.isBlock &&
									l(u.editor, y.block, y.blockLimit) &&
									(N = h(u.editor)) &&
									((N = t.createElement(N)),
									N.appendBogus(),
									P.insertNode(N),
								...
								if (C && D.isElement) {
									...
									if (y) q && ((K = P.splitElement(q)), u.zombies.push(K), u.zombies.push(q));
									else {
										q = v.getName();
										ba = !x;
										y = x == B.length - 1;
						...
						R &&
							((J = !0),
							(y = B[0].node),
							P.setStartAt(y, CKEDITOR.POSITION_BEFORE_START),
							P.setEndAt(y, CKEDITOR.POSITION_AFTER_END));
						u.dontMoveCaret = J;
					...
					for (I = R.createBookmark(); (N = u.zombies.pop()); )
						N.getParent() &&
					...
					return {
						...
						deleteRanges: function (a) {
							for (var b; (b = a.tableContentsRanges.pop()); )
								b.extractContents(), z(b.startContainer) && b.startContainer.appendBogus();
							...
							m.on("mousedown", function (a) {
								function b(a) {
									...
									if (w) {
										...
										w.setEndPoint(
											0 > z.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart",
											c,
										);
										w.select();
									}
							...
							if (n) {
								...
								for (D = 0; D < a.length; D++) {
									if (
										...
										(B = a[D + 1]),
										(k = v.clone()),
										k.setStart(v.endContainer, v.endOffset),
									...
									b.collapsed &&
										...
										"br" == v.getName()
											? (x(this.root), b.moveToPosition(v, CKEDITOR.POSITION_BEFORE_START))
				...
				for (q.getPosition(y) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q; ) {
					...
					if (q.equals(y)) (q = null), (k = !0);
						...
						var u = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
							w = u && "false" == q.getAttribute("contentEditable"),
							z = u && -1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, u),
							z = u && (q.getAttribute("data-nostyle") || z);
						if ((u && q.data("cke-bookmark")) || q.type === CKEDITOR.NODE_COMMENT) {
							q = q.getNextSourceNode(!0);
							continue;
						}
						if (w && m && CKEDITOR.dtd.$block[u])
							for (
								var A = q,
									F = g(A),
									G = void 0,
						...
						if (F)
							if (
								...
								if (
									(r ||
										(u && CKEDITOR.dtd.$removeEmpty[u] && (q.getPosition(y) | Q) != Q) ||
										((r = c.clone()), r.setStartBefore(q)),
									(u = q.type),
									u == CKEDITOR.NODE_TEXT ||
										w ||
										(u == CKEDITOR.NODE_ELEMENT && !q.getChildCount()))
								) {
									for (
										var u = q, M;
										(k = !u.getNext(E)) && ((M = u.getParent()), p[M.getName()]) && d(M, x, h, S);
					...
					if (k && r && !r.collapsed) {
						for (
							...
							if (z.getName() == f) {
								...
								for (W in h.styles)
									!G[W] && (Y = z.getStyle(W)) && (k.getStyle(W) == Y ? (u[W] = 1) : (G[W] = 1));
							}
							z = z.getParent();
						}
				...
				for (
					...
					if (this.checkElementRemovable(k)) {
						...
						(a.checkBoundaryOfElement(k, CKEDITOR.END) ||
							...
							: (k.mergeSiblings(),
								k.is(this.element) ? z.call(this, k) : w(k, K(this)[k.getName()]));
					}
				if (g) {
					e = d;
					for (h = 0; ; h++) {
				...
				for (f = d; !f.equals(m); )
					(g = f.getNextSourceNode()),
						f.type == CKEDITOR.NODE_ELEMENT &&
							...
							(f.getName() == this.element ? z.call(this, f) : w(f, K(this)[f.getName()]),
...
*/
		...
		function x(a) {
						...
						function c(b, g) {
							...
							b
								...
								: e &&
									...
									a.showNotification(f, "info", a.config.clipboard_notificationDuration);
							...
							f =
								"string" === typeof e
									...
									: a.lang.clipboard.pasteNotification.replace(
											/%1/,
											'\x3ckbd aria-label\x3d"' + m.aria + '"\x3e' + m.display + "\x3c/kbd\x3e",
										),
			...
			(function () {
				function b(c, e, d, g, m) {
					...
					a.addMenuItems &&
						a.addMenuItem(e, { label: k, command: e, group: "clipboard", order: m });
				}
		...
		CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
			...
			setData: function (a, b) {
				...
				if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == a || "Text" == a)
					if (
						("Text" == n && "Text" == a && (this.id = b), this._.fallbackDataTransfer.isRequired())
					)
			...
			_: {
				...
				alignRows: function () {
					for (
						...
						!(this.rows[a].boxes.length <= this.editor.config.colorButton_colorsPerRow);
						a++
					)
						this.rows[a + 1]
			...
			a.addCommand(b.commandName, {
				exec: function (a, b) {
					var c = b.newStyle,
						...
						f = void 0 === c;
					if (d || c)
						if ((d && e.collapsed && m({ editor: a, range: e, style: d }), f)) a.removeStyle(d);
						else {
							if ((e = d))
								(e =
	...
	CKEDITOR.config.plugins =
		"dialogui,dialog,about,basicstyles,notification,button,toolbar,clipboard,panelbutton,panel,floatpanel,colorbutton,enterkey,entities,floatingspace,listblock,richcombo,font,format,indent,indentlist,fakeobjects,link,list,table,undo,wysiwygarea";
	...
	(function () {
		...
		if (CKEDITOR.env.hidpi)
			setIcons(
				"about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,bgcolor,312,,textcolor,336,,indent-rtl,360,,indent,384,,outdent-rtl,408,,outdent,432,,anchor-rtl,456,,anchor,480,,link,504,,unlink,528,,bulletedlist-rtl,552,,bulletedlist,576,,numberedlist-rtl,600,,numberedlist,624,,table,648,,redo-rtl,672,,redo,696,,undo-rtl,720,,undo,744,",
				"icons_hidpi.png",
			);
		else
			setIcons(
				"about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,bgcolor,312,auto,textcolor,336,auto,indent-rtl,360,auto,indent,384,auto,outdent-rtl,408,auto,outdent,432,auto,anchor-rtl,456,auto,anchor,480,auto,link,504,auto,unlink,528,auto,bulletedlist-rtl,552,auto,bulletedlist,576,auto,numberedlist-rtl,600,auto,numberedlist,624,auto,table,648,auto,redo-rtl,672,auto,redo,696,auto,undo-rtl,720,auto,undo,744,auto",
				"icons.png",
			);
	})();
