...
!(function (t, e) {
	...
	function s() {
		...
		p(u, { createContext: s, drops: [], defaults: {} });
		var g = {
			classPrefix: "drop",
			defaults: {
		...
		p(u, g, a),
			p(u.defaults, g.defaults, a.defaults),
			"undefined" == typeof x[u.classPrefix] && (x[u.classPrefix] = []),
			(u.updateBodyClasses = function () {
		...
		var b = (function (s) {
			function r(t) {
				if (
					(e(this, r),
					l(Object.getPrototypeOf(r.prototype), "constructor", this).call(this),
					(this.options = p({}, u.defaults, t)),
				...
				this.options.classes &&
					...
					d(this.target, this.options.classes),
					u.drops.push(this),
					x[u.classPrefix].push(this),
					(this._boundEvents = []),
					this.bindMethods(),
					this.setupElements(),
					this.setupEvents(),
				...
				h(r, [
					{
						...
						value: function (t, e, n) {
							this._boundEvents.push({ element: t, event: e, handler: n }),
					...
					},
					{
						...
						value: function () {
							...
							if (
								...
								d(this.drop, u.classPrefix),
								this.options.classes && d(this.drop, this.options.classes),
								(this.content = document.createElement("div")),
								d(this.content, u.classPrefix + "-content"),
					...
					},
					{
						...
						value: function () {
							...
							this.options.constrainToScrollParent
								? n.push({ to: "scrollParent", pin: "top, bottom", attachment: "together none" })
								: n.push({ to: "scrollParent" }),
								this.options.constrainToWindow !== !1
							...
							this.options.tetherOptions !== !1 &&
								(this.tether = new t(p({}, i, this.options.tetherOptions)));
						},
					},
					{
						key: "setupEvents",
						value: function () {
							...
							if (this.options.openOn) {
								...
								var r = !1,
									...
									l = function (e) {
										(r = !1),
											"undefined" != typeof a && clearTimeout(a),
											(a = setTimeout(function () {
												r || t.close(e), (a = null);
											}, 50));
									};
								e.indexOf("hover") >= 0 &&
									(this._on(this.target, "mouseover", h),
									this._on(this.drop, "mouseover", h),
									this._on(this.target, "mouseout", l),
									this._on(this.drop, "mouseout", l)),
									e.indexOf("focus") >= 0 &&
										(this._on(this.target, "focus", h),
										this._on(this.drop, "focus", h),
					...
					},
					{
						...
						value: function (t) {
							var e = this;
							this.isOpened() ||
								(this.drop.parentNode || document.body.appendChild(this.drop),
								"undefined" != typeof this.tether && this.tether.enable(),
								d(this.drop, u.classPrefix + "-open"),
								d(this.drop, u.classPrefix + "-open-transitionend"),
								setTimeout(function () {
									e.drop && d(e.drop, u.classPrefix + "-after-open");
								}),
								"undefined" != typeof this.tether && this.tether.position(),
								this.trigger("open"),
								u.updateBodyClasses());
						},
					},
					{
						...
						value: function (t) {
							t.target === t.currentTarget &&
								(f(this.drop, u.classPrefix + "-open") ||
									c(this.drop, u.classPrefix + "-open-transitionend"),
								this.drop.removeEventListener(m, this.transitionEndHandler));
						},
					},
					{
						...
						value: function (t) {
							...
							return (
								this.isClosing ||
									...
									((this.isClosing = !0), (e = this.options.beforeClose(t, this) !== !1)),
								(this.isClosing = !1),
								e
							);
						},
					},
					{
						...
						value: function (t) {
							this.isOpened() &&
								this.beforeCloseHandler(t) &&
								(c(this.drop, u.classPrefix + "-open"),
								c(this.drop, u.classPrefix + "-after-open"),
								this.drop.addEventListener(m, this.transitionEndHandler),
								this.trigger("close"),
			...
			function t(t, e) {
				...
				try {
					for (
						...
						!(o = (r = a.next()).done) && (n.push(r.value), !e || n.length !== e);
						o = !0
					);
				} catch (h) {
					(i = !0), (s = h);
