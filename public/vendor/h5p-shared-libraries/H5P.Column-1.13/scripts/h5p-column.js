H5P.Column = (function (EventDispatcher) {
	...
	function Column(params, id, data) {
		...
		var grabContentData = function (index) {
			...
			if (
				data.previousState &&
				data.previousState.instances &&
				data.previousState.instances[index]
			) {
		...
		self.attach = function ($container) {
			...
			instanceContainers
				...
				.forEach(function (container) {
					instances[container.instanceIndex].attach(H5P.jQuery(container.container));
		...
		self.getTitle = function () {
			return H5P.createTitle(
				self.contentData && self.contentData.metadata && self.contentData.metadata.title
	 ...
	 */
	var hasTopMargins = ["H5P.SingleChoiceSet"];
