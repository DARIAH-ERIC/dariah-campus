...
(this.createjs = this.createjs || {}),
	...
	(function () {
		...
		(BrowserDetect.isWindowPhone = a.indexOf("IEMobile") > -1 || a.indexOf("Windows Phone") > -1),
			...
			(BrowserDetect.isIOS =
				(a.indexOf("iPod") > -1 || a.indexOf("iPhone") > -1 || a.indexOf("iPad") > -1) &&
		...
		(b.INTERRUPT_ANY = "any"),
			...
			(b._registerSound = function (c) {
				...
				if (
					...
					for (var g, h = e.audioSprite.length; h--; )
						(g = e.audioSprite[h]),
							...
							g.defaultPlayProps &&
								(b._defaultPlayPropsHash[g.id] = createjs.PlayPropsConfig.create(
									g.defaultPlayProps,
								));
				...
				return (
					...
					c.defaultPlayProps &&
						(b._defaultPlayPropsHash[c.src] = createjs.PlayPropsConfig.create(c.defaultPlayProps)),
					i
				);
			}),
			...
			(b.play = function (a, c, d, e, f, g, h, i, j) {
				var k;
				k = createjs.PlayPropsConfig.create(
					c instanceof Object || c instanceof createjs.PlayPropsConfig
						? c
						: {
								interrupt: c,
								delay: d,
			...
			(b._playInstance = function (a, c) {
				...
				if (
					(null == c.interrupt && (c.interrupt = d.interrupt || b.defaultInterruptBehavior),
			...
			(c._getSlot = function (a) {
				...
				for (var d = 0, e = this.max; e > d; d++) {
					...
					a != Sound.INTERRUPT_NONE &&
						((a == Sound.INTERRUPT_EARLY && b.getPosition() < c.getPosition()) ||
							(a == Sound.INTERRUPT_LATE && b.getPosition() > c.getPosition())) &&
						(c = b);
				}
	...
	(function () {
		...
		(a.play = function (a, b, c, d, e, f) {
			var g;
			return (
				(g = createjs.PlayPropsConfig.create(
					a instanceof Object || a instanceof createjs.PlayPropsConfig
						? a
						: { interrupt: a, delay: b, offset: c, loop: d, volume: e, pan: f },
				)),
			...
			(a.setPlaybackResource = function (a) {
				return (
					(this._playbackResource = a), 0 == this._duration && this._setDurationFromSource(), this
				);
			}),
		...
		(b._capabilities = null),
			...
			(b._generateCapabilities = function () {
				if (null == b._capabilities) {
					...
					null == b._scratchBuffer && (b._scratchBuffer = b.context.createBuffer(1, 1, 22050)),
