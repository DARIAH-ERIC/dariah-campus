!(function (e) {
	...
	function (e, t, n) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.stripHTML =
				t.addClickAndKeyboardListeners =
				t.keyCode =
				t.defaultValue =
				t.contains =
				t.isIOS =
		...
		function i(e, t) {
			...
			if (
				((n.addChild = function (t, s) {
					...
					var o = new r(s, n);
					return (
						s === n.children.length ? n.children.push(o) : (n.children.splice(s, 0, o), i(s)),
						e.call(o, t),
						o
					);
				}),
				...
				return (
					s(e, [
						...
						},
						{
							key: "removeElement",
							value: function (e) {
								(this.elements = (0, a.without)([e], this.elements)),
									p(e) &&
				...
				function e(e, t) {
					...
					try {
						for (
							...
							!(i = (o = a.next()).done) && (n.push(o.value), !t || n.length !== t);
							i = !0
						);
					} catch (e) {
						(r = !0), (s = e);
			...
			S = function (e, t, n) {
				...
				(this.presentation = e.presentation),
					...
					(this.currentSlideIndex =
						this.previousState && this.previousState.progress ? this.previousState.progress : 0),
					(this.presentation.keywordListEnabled =
						void 0 === e.presentation.keywordListEnabled || e.presentation.keywordListEnabled),
					...
					e.override &&
						...
						(this.showSummarySlideRetryButton =
							void 0 === e.override.summarySlideRetryButton || e.override.summarySlideRetryButton),
						e.override.social &&
					...
					(this.keywordMenu = new v.default({
						l10n: this.l10n,
						currentIndex: void 0 !== this.previousState ? this.previousState.progress : 0,
					})),
					this.setElementsOverride(e.override),
					a.default.call(this, g.default, e.presentation.slides),
					this.on("resize", this.resize, this),
					this.on("printing", function (e) {
						(i.ignoreResize = !e.data.finished),
							e.data.finished ? i.resize() : e.data.allSlides && i.attachAllElements();
					});
			};
		(S.prototype = Object.create(a.default.prototype)),
				...
				for (var n = 0; n < this.elementInstances.length; n++)
					if (this.elementInstances[n])
						for (var i = 0; i < this.elementInstances[n].length; i++) {
							...
							(r.getCurrentState instanceof Function || "function" == typeof r.getCurrentState) &&
								(t.answers[n] || (t.answers[n] = []), (t.answers[n][i] = r.getCurrentState()));
						}
				return t;
			}),
			...
			(S.prototype.attach = function (e) {
				...
				e.attr("role", "application").addClass("h5p-course-presentation").html(i),
					...
					(this.$wrapper = e
						...
						.blur(function () {
							void 0 !== n.keydown &&
								(H5P.jQuery("body").unbind("keydown", n.keydown), delete n.keydown);
						})
						.click(function (e) {
							var t = H5P.jQuery(e.target),
								i = n.belongsToTagName(
									e.target,
							...
							n.presentation.keywordListEnabled &&
								...
								n.presentation.keywordListAutoHide &&
								!t.is("textarea, .h5p-icon-pencil, span") &&
								n.hideKeywords();
						})),
					this.on("exitFullScreen", function () {
						t.$footer.removeClass("footer-full-screen"),
							t.$fullScreenButton.attr("title", t.l10n.fullscreen),
							t.$fullscreenAnnouncer.html(t.l10n.accessibilityExitedFullscreen);
					}),
				...
				(this.$slidesWrapper = o.children(".h5p-slides-wrapper")),
					...
					this.activeSurface &&
						void 0 === this.editor &&
						((this.initKeywords = !1), this.$boxWrapper.css("height", "100%")),
				...
				if (
					...
					this.slides.push(l),
						(a = H5P.jQuery(g.default.createHTML(l)).appendTo(this.$slidesWrapper)),
						a.addClass("h5p-summary-slide"),
						this.isCurrentSlide(this.slides.length - 1) && (this.$current = a);
				}
				...
				c.length > 0 || this.isEditor()
					? (this.keywordMenu.init(c),
						...
						(this.$keywords = (0, m.jQuery)(this.keywordMenu.getElement()).appendTo(
					...
					void 0 === this.editor && this.activeSurface
						...
						: (this.initTouchEvents(),
							(this.navigationLine = new u.default(this)),
							(this.previousState && this.previousState.progress) ||
								this.setSlideNumberAnnouncer(0, !1),
							(this.summarySlideObject = new d.default(this, a))),
					new h.default(this),
					this.previousState &&
			...
			(S.prototype.createSlides = function () {
				for (var e = this, t = 0; t < e.children.length; t++) {
					...
					e.children[t].getElement().appendTo(e.$slidesWrapper),
						n && e.children[t].setCurrent(),
						(e.isEditor() || 0 === t || 1 === t || n) && e.children[t].appendElements();
				}
			}),
			(S.prototype.hasScoreData = function (e) {
				return (
					"undefined" !== (void 0 === e ? "undefined" : s(e)) &&
				...
				void 0 !== e && e
					? e.forEach(function (e) {
							...
							if (n.hasClass("h5p-answered")) {
								...
								n.addClass(i ? "h5p-is-correct" : "h5p-is-wrong"),
			...
			(S.prototype.fitCT = function () {
				void 0 === this.editor &&
					this.$current.find(".h5p-ct").each(function () {
						for (
							var e = 100, t = H5P.jQuery(this), n = t.parent().height();
							t.outerHeight() > n &&
							(e--, t.css({ fontSize: e + "%", lineHeight: e + 65 + "%" }), !(e < 0));
			...
			(S.prototype.resize = function () {
				...
				if (!this.ignoreResize) {
					...
					var r = t / this.width;
					(n.height = t / this.ratio + "px"),
						(n.fontSize = this.fontSize * r + "px"),
						void 0 !== this.editor && this.editor.setContainerEm(this.fontSize * r * 0.75),
						this.$wrapper.css(n),
			...
			(S.prototype.setElementsOverride = function (e) {
				(this.elementsOverride = { params: {} }),
					e &&
						...
						e.retryButton &&
							(this.elementsOverride.params.behaviour.enableRetry = "on" === e.retryButton));
			}),
				...
				if (void 0 === this.elementsAttached[t]) {
					...
					if (void 0 !== n.elements)
						for (var r = 0; r < n.elements.length; r++)
							this.attachElement(n.elements[r], i[r], e, t);
					this.trigger(
						"domChanged",
			...
			(S.prototype.attachElement = function (e, t, n, i) {
				...
				if ((a.toggleClass("h5p-transparent", l), r)) {
					...
					var d = e.action && e.action.library,
						...
						u = H5P.jQuery("<div>", { class: "h5p-element-outer " + c + "-outer-element" })
							.css({
								background:
									"rgba(255,255,255," +
									(void 0 === e.backgroundOpacity ? 0 : e.backgroundOpacity / 100) +
									")",
							})
							.appendTo(a),
					...
					0 == i && this.slidesWithSolutions.indexOf(i) < 0 && p.attr("tabindex", "0"),
						this.setOverflowTabIndex();
				}
				return (
					void 0 !== this.editor
						? this.editor.processElement(e, a, i, t)
						: (e.solution && this.addElementSolutionButton(e, t, a),
							(this.hasAnswerElements = this.hasAnswerElements || void 0 !== t.exportAnswers)),
					a
				);
			}),
			...
			(S.prototype.createInteractionButton = function (e, t) {
				...
				"" === r &&
					(r =
						(e.action.params && e.action.params.contentName) ||
				...
				var s = this.getLibraryTypePmz(e.action.library),
					...
					a = (0, m.jQuery)("<div>", {
						...
						"aria-popup": !0,
						"aria-expanded": !1,
						class: "h5p-element-button h5p-element-button-" + e.buttonSize + " " + s + "-button",
					}),
				...
				return (
					(0, y.addClickAndKeyboardListeners)(a, function () {
						a.attr("aria-expanded", "true"),
							n.showInteractionPopup(t, a, l, s, i, o(a), d),
							n.disableTabIndexes();
					}),
					void 0 !== e.action &&
			...
			(S.prototype.showInteractionPopup = function (e, t, n, i, r, s) {
				...
				if (!this.isEditor()) {
					...
					setTimeout(function () {
						...
						(0, y.isFunction)(e.setActivityStarted) &&
							(0, y.isFunction)(e.getScore) &&
							e.setActivityStarted(),
			...
			(S.prototype.addElementSolutionButton = function (e, t, n) {
				...
				(t.showCPComments = function () {
					if (
						0 === n.children(".h5p-element-solution").length &&
						(0, y.stripHTML)(e.solution).length > 0
					) {
						var t = (0, m.jQuery)("<div/>", {
								role: "button",
								tabindex: 0,
								title: i.l10n.solutionsButtonTitle,
								"aria-popup": !0,
								"aria-expanded": !1,
			...
			(S.prototype.initKeyEvents = function () {
				if (void 0 === this.keydown && !this.activeSurface) {
					...
					(this.keydown = function (n) {
						t ||
							((37 !== n.keyCode && 33 !== n.keyCode) || !e.previousSlide()
								? (39 !== n.keyCode && 34 !== n.keyCode) ||
									!e.nextSlide() ||
			...
			(S.prototype.initTouchEvents = function () {
				...
				this.$slidesWrapper
					.bind("touchstart", function (d) {
						(l = !1),
							(n = e = d.originalEvent.touches[0].pageX),
							(t = d.originalEvent.touches[0].pageY);
						var c = o.$slidesWrapper.width();
						(i = 0 === o.currentSlideIndex ? 0 : -c),
							(r = o.currentSlideIndex + 1 >= o.slides.length ? 0 : c),
							(s = null),
							(a = !0);
					})
					.bind("touchmove", function (c) {
						...
						null === s && (s = Math.abs(t - c.originalEvent.touches[0].pageY) > Math.abs(p)),
							1 !== u.length ||
								...
								l ||
									(p < 0
										? o.$current.prev().css(d("translateX(" + (i - p) + "px"))
										: o.$current.next().css(d("translateX(" + (r - p) + "px)")),
									o.$current.css(d("translateX(" + -p + "px)"))));
					})
					.bind("touchend", function () {
						if (!s) {
							var t = e - n;
							if (
								(t > o.swipeThreshold && o.nextSlide()) ||
								(t < -o.swipeThreshold && o.previousSlide())
							)
								return;
						}
			...
			(S.prototype.updateTouchPopup = function (e, t, n, i) {
				if (arguments.length <= 0)
					return void (void 0 !== this.touchPopup && this.touchPopup.remove());
				var r = "";
				if (
				...
				void 0 === this.editor && t >= this.slides.length - 1 && (r = this.l10n.showSolutions),
					void 0 === this.touchPopup
						? (this.touchPopup = H5P.jQuery("<div/>", { class: "h5p-touch-popup" }).insertAfter(e))
			...
			(S.prototype.attachAllElements = function () {
				for (var e = this.$slidesWrapper.children(), t = 0; t < this.slides.length; t++)
					this.attachElements(e.eq(t), t);
				void 0 !== this.summarySlideObject &&
					this.summarySlideObject.updateSummarySlide(this.slides.length - 1, !0);
			}),
				...
				if (!this.$current.hasClass("h5p-animate")) {
					...
					if (void 0 !== c)
						for (var u = 0; u < c.length; u++)
							this.slides[l].elements[u].displayAsButton || i.pauseMedia(c[u]);
					return (
						setTimeout(function () {
							s.removeClass("h5p-current"),
								s.find(".h5p-element-inner").attr("tabindex", "-1"),
								o
									.css({
										"-webkit-transform": "",
										"-moz-transform": "",
								...
								void 0 === i.slidesWithSolutions[i.getCurrentSlideIndex()] &&
									i.$current.find(".h5p-element-inner").attr("tabindex", "0"),
								...
								if (void 0 !== e)
									for (var n = 0; n < e.length; n++)
										t[n] &&
											t[n].action &&
											t[n].action.params &&
											t[n].action.params.cpAutoplay &&
											!t[n].displayAsButton &&
											"function" == typeof e[n].play &&
											e[n].play(),
											t[n].displayAsButton ||
												"function" != typeof e[n].setActivityStarted ||
												"function" != typeof e[n].getScore ||
												e[n].setActivityStarted();
							}
						}, 250),
						void 0 !== this.$keywords &&
						...
						i.presentation.keywordListEnabled &&
							...
							i.showKeywords(),
						i.navigationLine &&
							(i.navigationLine.updateProgressBar(e, l, this.isSolutionMode),
							i.navigationLine.updateFooter(e),
							this.setSlideNumberAnnouncer(e, n)),
						i.summarySlideObject && i.summarySlideObject.updateSummarySlide(e, !0),
						void 0 !== this.editor &&
							void 0 !== this.editor.dnb &&
							(this.editor.dnb.setContainer(this.$current), this.editor.dnb.blurAll()),
						this.trigger("resize"),
						this.fitCT(),
						!0
					);
			...
			(S.prototype.getCopyrights = function () {
				...
				if (
					...
					i.setThumbnail(new H5P.Thumbnail(H5P.getPath(n.path, this.contentId), n.width, n.height)),
						t.addMedia(i);
				}
				for (var r = 0; r < this.slides.length; r++) {
					...
					if (
						...
						a.setThumbnail(
							new H5P.Thumbnail(H5P.getPath(o.path, this.contentId), o.width, o.height),
						),
							s.addMedia(a);
					}
							...
							if (this.slides[r].elements[l].action) {
								...
								(e = void 0),
									...
									void 0 === e &&
										...
										H5P.findCopyrights(e, c, this.contentId, {
											metadata: u,
											machineName: d.libraryInfo.machineName,
										}));
								var p = l + 1;
								void 0 !== c.contentName
									? (p += ": " + c.contentName)
									: void 0 !== d.getTitle
										? (p += ": " + d.getTitle())
										: c.l10n && c.l10n.name && (p += ": " + c.l10n.name),
									e.setLabel(p),
									s.addContent(e);
							}
						}
			...
			(S.prototype.pauseMedia = function (e) {
				try {
					void 0 !== e.pause && (e.pause instanceof Function || "function" == typeof e.pause)
						? e.pause()
						: void 0 !== e.video &&
							  void 0 !== e.video.pause &&
							  (e.video.pause instanceof Function || "function" == typeof e.video.pause)
							? e.video.pause()
							: void 0 !== e.stop &&
								(e.stop instanceof Function || "function" == typeof e.stop) &&
								e.stop();
				} catch (e) {
					H5P.error(e);
				}
			...
			s = (function () {
				...
				return (
					(e.prototype.updateSummarySlide = function (e, t) {
						...
						if (r) {
							n.cp.presentation.keywordListEnabled &&
								n.cp.presentation.keywordListAlwaysShow &&
								n.cp.hideKeywords(),
											...
											c.append(
												(0, i.jQuery)("<div/>", {
													...
													html:
														n.cp.l10n.summary +
														". " +
														n.cp.l10n.accessibilityTotalScore
															.replace("@score", l.totalScore)
															.replace("@maxScore", l.totalMaxScore),
												}),
											);
										}, 100);
								}
					...
					(e.prototype.outputScoreStats = function (e) {
						...
						var d =
								i.cp.enableTwitterShare || i.cp.enableFacebookShare || i.cp.enableGoogleShare
									? '<span class="h5p-show-results-text">' + i.cp.l10n.shareResult + "</span>"
									: "",
							c =
					...
					(e.prototype.getSlideDescription = function (e) {
						...
						if (e.indexes.length > 1) t = i.cp.l10n.summaryMultipleTaskText;
							...
							if (
								((n = r[e.indexes[0]].action),
								"function" == typeof i.cp.elementInstances[e.slide - 1][e.indexes[0]].getTitle)
							)
								t = i.cp.elementInstances[e.slide - 1][e.indexes[0]].getTitle();
						...
						e.attr("tabindex", "0").attr("role", "button"),
							(0, r.addClickAndKeyboardListeners)(e, function () {
								return (
									window.open(
										a,
										n.cp.l10n.shareTwitter,
										"width=800,height=300,left=" + l + ",top=" + d,
									),
									!1
								);
							});
							...
							(0, r.addClickAndKeyboardListeners)(e, function () {
								return (
									window.open(
										...
										"width=401,height=437,left=" + s + ",top=" + o,
									),
									!1
								);
							});
					...
					(e.prototype.toggleSolutionMode = function (e) {
						...
						if (((this.cp.isSolutionMode = e), e)) {
							...
							this.cp.setProgressBarFeedback(n),
					...
					(e.prototype.setFooterSolutionModeText = function (e) {
						void 0 !== e && e
							...
							: this.cp.$exitSolutionModeText && this.cp.$exitSolutionModeText.html("");
					}),
					e
				);
			})();
				...
				return (
					...
					(t.prototype.initProgressbar = function (t) {
						...
						for (
							...
							var a = this.cp.slides[o],
								...
								h = e("<a>", {
									href: "#",
									html: '<span class="h5p-progressbar-part-title hidden-but-read">' + d + "</span>",
									tabindex: "-1",
								})
									.data("slideNumber", o)
									.click(s)
							...
							if (
								...
								var f = t[o] && t[o].length > 0,
									v = !!(
										...
										i.cp.previousState.answered[o]
									);
								f &&
									(e("<div>", { class: "h5p-progressbar-part-has-task" }).appendTo(h),
									this.setTaskAnswered(o, v));
							}
						}
					}),
					(t.prototype.ensurePopupVisible = function (e) {
						var t = this.cp.$container.width(),
							...
							i = e.offset().left;
						i < 0
							? (e.css("left", 0), e.css("transform", "translateX(0)"))
							: i + n > t &&
								(e.css("left", "auto"), e.css("right", 0), e.css("transform", "translateX(0)"));
					}),
					(t.prototype.displaySlide = function (e) {
						var t = this.cp.getCurrentSlideIndex();
						this.updateSlideTitle(e, { isCurrent: !0 }),
							this.updateSlideTitle(t, { isCurrent: !1 }),
							this.cp.jumpToSlide(e),
					...
					(t.prototype.initFooter = function () {
						...
						(this.cp.$keywordsButton = e("<div/>", {
							...
							(0, u.addClickAndKeyboardListeners)(this.cp.$keywordsButton, function (e) {
								n.cp.presentation.keywordListAlwaysShow ||
									(n.cp.toggleKeywords(), e.stopPropagation());
							}),
							(!this.cp.presentation.keywordListAlwaysShow && this.cp.initKeywords) ||
					...
					(t.prototype.updateProgressBar = function (e, t, n) {
						var i,
							r = this;
						for (i = 0; i < r.cp.progressbarParts.length; i += 1)
							e + 1 > i
								? r.cp.progressbarParts[i].addClass("h5p-progressbar-part-show")
								: r.cp.progressbarParts[i].removeClass("h5p-progressbar-part-show");
						if (
					...
					(t.prototype.setTaskAnswered = function (e, t) {
						this.cp.progressbarParts[e]
							...
							this.updateSlideTitle(e, { state: t ? p.ANSWERED : p.NOT_ANSWERED });
					}),
					(t.prototype.updateSlideTitle = function (e) {
						var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							n = t.state,
							i = t.isCurrent;
						this.setSlideTitle(e, {
							state: (0, u.defaultValue)(n, this.getAnsweredState(e)),
							isCurrent: (0, u.defaultValue)(i, this.cp.isCurrentSlide(e)),
						});
					}),
		...
		var r = n(0),
			s = function e(t) {
				...
				n = r.jQuery.extend(
					!0,
					{
						globalBackgroundSelector: { fillGlobalBackground: "", imageGlobalBackground: {} },
						slides: [
							{ slideBackgroundSelector: { fillSlideBackground: "", imageSlideBackground: {} } },
						],
					},
					n,
				);
				...
				return (
					s(e, [
						...
						},
						{
							...
							value: function (e, t) {
								(e.innerHTML =
									'<div class="h5p-keyword-subtitle">' +
									t.subtitle +
									'</div><span class="h5p-keyword-title">' +
									t.title +
									"</span>"),
						...
						},
						{
							...
							value: function (e, t) {
								...
								e.forEach(function (e) {
									...
									e.classList.toggle("h5p-current", i),
										i && e.appendChild(n.currentSlideMarkerElement);
								});
							},
						},
						{
						...
						},
						{
							...
							value: function () {
								...
								return (
									e.classList.add("hidden-but-read"), (e.innerHTML = this.l10n.currentSlide), e
								);
							},
						},
					]),
	...
	function (e, t, n) {
			...
			(t.getElement = function () {
				...
				(t.appendElements = function () {
					for (var i = 0; i < t.children.length; i++)
						t.parent.attachElement(e.elements[i], t.children[i].instance, n, t.index);
					(t.parent.elementsAttached[t.index] = !0),
						t.parent.trigger(
							"domChanged",
							{ $target: n, library: "CoursePresentation", key: "newSlide" },
							{ bubbles: !0, external: !0 },
						);
				});
		}
		...
		(r.createHTML = function (e) {
			return (
				'<div role="document" class="h5p-slide"' +
				(void 0 !== e.background ? ' style="background:' + e.background + '"' : "") +
				"></div>"
			);
		}),
			(t.default = r);
		...
		function i(e) {
			...
			if (void 0 === e.action)
				...
				(n = t.parent.parent.isEditor()
					...
					n.params.autoplay
						...
						: n.params.playback && n.params.playback.autoplay
							...
							: n.params.media &&
								  n.params.media.params &&
								  n.params.media.params.playback &&
								  n.params.media.params.playback.autoplay
								...
								: n.params.media && n.params.media.params && n.params.media.params.autoplay
									...
									: n.params.override &&
										n.params.override.autoplay &&
										((n.params.override.autoplay = !1), (n.params.cpAutoplay = !0));
				var i = t.parent.parent.elementInstances[t.parent.index]
				...
				t.parent.parent.previousState &&
					...
					(n.params = n.params || {}),
					(t.instance = H5P.newRunnable(n, t.parent.parent.contentId, void 0, !0, {
