						...
						(i = function (e, t) {
							...
							(C.fn = C.prototype =
								...
								C.extend({
									...
									makeArray: function (e, t) {
										...
										return (
											null != e &&
												(T(Object(e)) ? C.merge(n, "string" == typeof e ? [e] : e) : s.call(n, e)),
											n
										);
									},
							...
							var P = (function (e) {
								...
								function se(e, t, r, i) {
									var o,
										...
										w = t ? t.nodeType : 9;
									if (
										((r = r || []), "string" != typeof e || !e || (1 !== w && 9 !== w && 11 !== w))
									)
										return r;
									if (!i && (f(t), (t = t || p), g)) {
										if (11 !== w && (d = Z.exec(e)))
								...
								(se.uniqueSort = function (e) {
									var t,
										...
										o = 0;
									if (
										((d = !n.detectDuplicates), (u = !n.sortStable && e.slice(0)), e.sort(I), d)
									) {
																	...
																	for (
																		b =
																			(p =
																				(l =
																					(u =
																						(d = (f = v)[x] || (f[x] = {}))[f.uniqueID] ||
																						(d[f.uniqueID] = {}))[e] || [])[0] === C && l[1]) &&
																			l[2],
																			f = p && v.childNodes[p];
												...
												if (c) {
													...
													for (; (t = t[r]); )
														if (1 === t.nodeType || a)
															if (
																((u =
																	(d = t[x] || (t[x] = {}))[t.uniqueID] || (d[t.uniqueID] = {})),
										...
										le(function (o, a, s, c) {
											...
											if (o) {
												if (i || e) {
													...
													for (u = m.length; u--; )
														(d = m[u]) && -1 < (l = i ? q(o, d) : f[u]) && (o[l] = !(a[l] = d));
												}
											} else
												(m = Ce(m === a ? m.splice(h, m.length) : m)),
													i ? i(null, a, m, c) : L.apply(a, m);
										})
									);
								}
								function Pe(e) {
									for (
										var t,
											...
											f = [
												function (e, n, r) {
													var i =
														(!a && (r || n !== l)) || ((t = n).nodeType ? u(e, n, r) : d(e, n, r));
													return (t = null), i;
												},
											];
										c < o;
								...
								return (
												...
												(v = S(
													...
													(u = function (e, t, n, a, u) {
														...
														for (u && (l = t == p || t || u); y !== E && null != (d = T[y]); y++) {
															if (c && d) {
																for (
																	h = 0, t || d.ownerDocument == p || (f(d), (n = !g));
																	(v = i[h++]);
														...
														if (((m += y), s && y !== m)) {
															...
															if (e) {
																if (0 < m) for (; y--; ) b[y] || x[y] || (x[y] = A.call(a));
																x = Ce(x);
															}
															L.apply(a, x),
																u && !e && 0 < x.length && 1 < m + o.length && se.uniqueSort(a);
														}
														return u && ((C = P), (l = w)), b;
													}),
													s ? le(u) : u),
									...
									(c = se.select =
										function (e, t, n, i) {
											...
											return (
												(f || s(e, p))(i, t, !g, n, !t || (ee.test(e) && me(t.parentNode)) || t), n
											);
										}),
							...
							(C.filter = function (e, t, n) {
								...
								C.fn.extend({
									...
									is: function (e) {
										return !!k(this, "string" == typeof e && H.test(e) ? C(e) : e || [], !1).length;
									},
								});
							var A,
								j = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
								...
								if (((n = n || A), "string" == typeof e)) {
									...
									if (r[1]) {
										if (
											...
											C.merge(
												this,
												C.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : m, !0),
											),
								...
								C.each(
									{
										...
										contents: function (e) {
											return null != e.contentDocument && i(e.contentDocument)
												? e.contentDocument
												: (I(e, "template") && (e = e.content || e), C.merge([], e.childNodes));
										},
									},
									function (e, t) {
										C.fn[e] = function (n, r) {
											...
											return (
												...
												1 < this.length && (N[e] || C.uniqueSort(i), L.test(e) && i.reverse()),
												this.pushStack(i)
											);
										};
									},
								...
								var r,
									...
									d = {
										...
										fireWith: function (e, t) {
											return (
												a || ((t = [e, (t = t || []).slice ? t.slice() : t]), c.push(t), r || u()),
												this
											);
										},
										fire: function () {
							...
							var U = function (e, t, n, r, i, o, a) {
									var s = 0,
										c = e.length,
										l = null == n;
									if ("object" === x(n)) for (s in ((i = !0), n)) U(e, t, s, n[s], !0, o, a);
									else if (
										void 0 !== r &&
										((i = !0),
										g(r) || (a = !0),
								...
								C.fn.extend({
									data: function (e, t) {
										...
										if (void 0 === e) {
											if (
												this.length &&
												((i = G.get(o)), 1 === o.nodeType && !J.get(o, "hasDataAttrs"))
											) {
												for (n = a.length; n--; )
													a[n] &&
										...
										return "object" == typeof e
											...
											: U(
													...
													function (t) {
														var n;
														if (o && void 0 === t)
															return void 0 !== (n = G.get(o, e)) || void 0 !== (n = ee(o, e))
																? n
																: void 0;
														this.each(function () {
															G.set(this, e, t);
							...
							function ue(e, t) {
								for (var n, r, i, o, a, s, c, l = [], u = 0, d = e.length; u < d; u++)
									(r = e[u]).style &&
										...
										t
											? ("none" === n &&
													((l[u] = J.get(r, "display") || null), l[u] || (r.style.display = "")),
												"" === r.style.display &&
													se(r) &&
													(l[u] =
														((c = a = o = void 0),
														...
														(c = le[s]) ||
															...
															"none" === c && (c = "block"),
															(le[s] = c)))))
											: "none" !== n && ((l[u] = "none"), J.set(r, "display", n)));
							...
							(ve.tbody = ve.tfoot = ve.colgroup = ve.caption = ve.thead),
								(ve.th = ve.td),
								h.option ||
									(ve.optgroup = ve.option = [1, "<select multiple='multiple'>", "</select>"]);
							var be = /<|&#?\w+;/;
							function xe(e, t, n, r, i) {
								for (
									var o, a, s, c, l, u, d = t.createDocumentFragment(), f = [], p = 0, h = e.length;
									p < h;
									p++
								)
									if ((o = e[p]) || 0 === o)
								...
								special: {
									...
									click: {
										...
										_default: function (e) {
											var t = e.target;
											return (
												(pe.test(t.type) && t.click && I(t, "input") && J.get(t, "click")) ||
												I(t, "a")
											);
										},
									},
							...
							function Oe(e, t, n, r) {
								...
								var i,
									...
									v = t[0],
									m = g(v);
								if (m || (1 < f && "string" == typeof v && !h.checkClone && ke.test(v)))
								...
								if (
									...
									for (c = (s = C.map(me(i, "script"), Le)).length; d < f; d++)
										(l = i),
											d !== p && ((l = C.clone(l, !0, !0)), c && C.merge(s, me(l, "script"))),
											n.call(e[d], l, d);
									if (c)
										for (u = s[s.length - 1].ownerDocument, C.map(s, Ne), d = 0; d < c; d++)
											(l = s[d]),
												ge.test(l.type || "") &&
													...
													(l.src && "module" !== (l.type || "").toLowerCase()
														? C._evalUrl &&
															!l.noModule &&
															C._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, u)
							...
							function Fe(e, t, n) {
								for (var r, i = t ? C.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
									n || 1 !== r.nodeType || C.cleanData(me(r)),
										r.parentNode &&
											(n && oe(r) && ye(me(r, "script")), r.parentNode.removeChild(r));
								return e;
							}
							C.extend({
								...
								clone: function (e, t, n) {
									var r,
										...
										d = oe(e);
									if (
										!(h.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || C.isXMLDoc(e))
									)
										for (a = me(u), r = 0, i = (o = me(e)).length; r < i; r++)
											(s = o[r]),
												"input" === (l = (c = a[r]).nodeName.toLowerCase()) && pe.test(s.type)
													? (c.checked = s.checked)
													: ("input" !== l && "textarea" !== l) ||
														(c.defaultValue = s.defaultValue);
									if (t)
										if (n)
											for (o = o || me(e), a = a || me(u), r = 0, i = o.length; r < i; r++)
												qe(o[r], a[r]);
										else qe(e, u);
									...
									function (e, t) {
										C.fn[e] = function (e) {
											for (var n, r = [], i = C(e), o = i.length - 1, a = 0; a <= o; a++)
												(n = a === o ? this : this.clone(!0)), C(i[a])[t](n), s.apply(r, n.get());
							...
							function ze(e, t, n) {
								...
								return (
									(n = n || Re(e)) &&
										("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = C.style(e, t)),
										!h.pixelBoxStyles() &&
											Me.test(a) &&
											Qe.test(t) &&
											((r = s.width),
							...
							function Ze(e, t, n, r, i, o) {
								...
								for (; a < 4; a += 2)
									"margin" === n && (c += C.css(e, n + re[a], !0, i)),
										r
											? ("content" === n && (c -= C.css(e, "padding" + re[a], !0, i)),
												"margin" !== n && (c -= C.css(e, "border" + re[a] + "Width", !0, i)))
							...
							function et(e, t, n) {
								var r = Re(e),
									i =
										(!h.boxSizingReliable() || n) && "border-box" === C.css(e, "boxSizing", !1, r),
									o = i,
									a = ze(e, t, r),
								...
								style: function (e, t, n, r) {
									if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
										var i,
											...
											c = Ye.test(t),
											l = e.style;
										if ((c || (t = We(s)), (a = C.cssHooks[t] || C.cssHooks[s]), void 0 === n))
									...
									_default: {
										...
										set: function (e) {
											C.fx.step[e.prop]
												? C.fx.step[e.prop](e)
												: 1 !== e.elem.nodeType ||
													  (!C.cssHooks[e.prop] && null == e.elem.style[We(e.prop)])
													? (e.elem[e.prop] = e.now)
							...
							function ft(e, t, n) {
								...
								for (
									...
									if ((r = ft.prefilters[o].call(l, e, u, l.opts)))
										return (
											g(r.stop) && (C._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r
										);
								return (
									C.map(u, dt, l),
									...
									C.fx.timer(C.extend(c, { elem: e, anim: l, queue: l.opts.queue })),
									l
								);
							}
										...
										select: {
											...
											set: function (e, t) {
												for (var n, r, i = e.options, o = C.makeArray(t), a = i.length; a--; )
													((r = i[a]).selected = -1 < C.inArray(C.valHooks.option.get(r), o)) &&
														(n = !0);
								...
								trigger: function (t, n, r, i) {
									...
									if (
										...
										3 !== r.nodeType &&
											...
											((t = t[C.expando]
												? t
												: new C.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3),
											(t.namespace = b.join(".")),
							...
							(Bt.href = Tt.href),
								C.extend({
									...
									ajax: function (t, n) {
										...
										if (
											(v.promise(P),
											(p.url = ((t || p.url || Tt.href) + "").replace(Ot, Tt.protocol + "//")),
										...
										p.hasContent
											...
											: ((f = p.url.slice(i.length)),
												...
												!1 === p.cache &&
													((i = i.replace(Lt, "$1")),
													(f = (Et.test(i) ? "&" : "?") + "_=" + Pt.guid++ + f)),
												(p.url = i + f)),
										p.ifModified &&
											(C.lastModified[i] &&
												P.setRequestHeader("If-Modified-Since", C.lastModified[i]),
											C.etag[i] && P.setRequestHeader("If-None-Match", C.etag[i])),
												...
												d
													? (p.ifModified &&
															((w = P.getResponseHeader("Last-Modified")) &&
																(C.lastModified[i] = w),
															(w = P.getResponseHeader("etag")) && (C.etag[i] = w)),
														204 === t || "HEAD" === p.type
															? (T = "nocontent")
															: 304 === t
																? (T = "notmodified")
																: ((T = x.state), (f = x.data), (d = !(m = x.error))))
													: ((m = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
												(P.status = t),
												(P.statusText = (n || T) + ""),
												d ? v.resolveWith(h, [f, T, P]) : v.rejectWith(h, [P, T, m]),
												P.statusCode(b),
												(b = void 0),
												u && g.trigger(d ? "ajaxSuccess" : "ajaxError", [P, p, d ? f : m]),
												y.fireWith(h, [P, T]),
												u &&
				...
				644: () => {
					(H5P.ConfirmationDialog = (function (e) {
						...
						function t(t) {
							...
							((t = t || {}).headerText = t.headerText || H5P.t("confirmDialogHeader")),
							...
							c.classList.add("h5p-confirmation-dialog-background", "hidden", "hiding");
							...
							l.classList.add("h5p-confirmation-dialog-popup", "hidden"),
								...
								l.setAttribute("aria-labelledby", "h5p-confirmation-dialog-dialog-text-" + r),
								c.appendChild(l),
								l.addEventListener("keydown", function (e) {
									27 === e.which && o(e);
								});
							var u = document.createElement("div");
							u.classList.add("h5p-confirmation-dialog-header"), l.appendChild(u);
							...
							h.classList.add("h5p-confirmation-dialog-buttons"), f.appendChild(h);
							var g = document.createElement("button");
							g.classList.add("h5p-core-cancel-button"), (g.textContent = t.cancelText);
							...
							b.classList.add("h5p-confirmation-dialog-exit"),
								...
								g.addEventListener("keydown", function (e) {
									32 === e.which ? o(e) : 9 === e.which && e.shiftKey && a(v, e);
								}),
								t.hideCancel ? h.classList.add("center") : h.appendChild(g),
								v.addEventListener("click", i),
								v.addEventListener("keydown", function (e) {
									32 === e.which ? i(e) : 9 !== e.which || e.shiftKey || a(t.hideCancel ? v : g, e);
								}),
								h.appendChild(v),
							...
							(this.show = function (e) {
										...
										l.classList.remove("hidden"),
											...
											setTimeout(function () {
												if ((v.focus(), s && t.instance)) {
													...
													n.setViewPortMinimumHeight(e), t.instance.trigger("resize"), (s = !1);
												}
											}, 100);
									}, 0),
									this
								...
								(this.hide = function () {
									return (
										...
										E(c, C),
										setTimeout(function () {
											c.classList.add("hidden"), m.removeChild(c), n.setViewPortMinimumHeight(null);
										}, 100),
										this
									);
								}),
								...
								(this.setViewPortMinimumHeight = function (e) {
									(document.querySelector(".h5p-container") || document.body).style.minHeight =
							...
							if (t.contentId)
								if (
									((this.data.statement.object = {
										...
										objectType: "Activity",
										definition: {
											extensions: { "http://h5p.org/x-api/h5p-local-content-id": t.contentId },
										},
									}),
									t.subContentId)
								)
									(this.data.statement.object.definition.extensions[
										...
										"function" == typeof t.getTitle &&
											(this.data.statement.object.definition.name = { "en-US": t.getTitle() });
								else {
						...
						(e.XAPIEvent.prototype.setContext = function (e) {
							e.parent &&
								...
								(this.data.statement.context = {
									contextActivities: {
										parent: [{ id: this.getContentXAPIId(e.parent), objectType: "Activity" }],
									},
								}),
								e.libraryInfo &&
					...
					(e.isFramed = window.self !== window.parent),
						...
						document.documentElement.requestFullscreen
							...
							: document.documentElement.webkitRequestFullScreen
								? ((e.safariBrowser = navigator.userAgent.match(/version\/([.\d]+)/i)),
									(e.safariBrowser = null === e.safariBrowser ? 0 : parseInt(e.safariBrowser[1])),
						...
						(e.init = function (t) {
							void 0 === e.$body && (e.$body = e.jQuery(document.body)),
								...
								e.jQuery(".h5p-content:not(.h5p-initialized)", t).each(function () {
									...
									if (void 0 === i)
										return e.error(
											"No data for content id " + r + ". Perhaps the library is gone?",
										);
									var o = {
										library: i.library,
										...
										if (s) o.userDatas = { state: s };
											...
											e
												...
												.on("dialog-opened", function (t, n) {
													...
													n.find(".h5p-dialog-ok-button").click(i).keypress(i),
														e.trigger(a, "resize");
												})
									...
									(e.offlineRequestQueue = new e.OfflineRequestQueue({ instance: a })),
										1 == i.fullScreen &&
											e.fullscreenSupported &&
											e
												.jQuery(
									...
									if (c.frame) {
										...
										d.on("reuse", function () {
											...
											d.on("copyrights", function () {
												new e.Dialog("copyrights", e.t("copyrightInformation"), u, n).open(!0),
									...
									if (
										...
										e.on(a, "finish", function (t) {
											void 0 !== t.data &&
												e.setFinished(r, t.data.score, t.data.maxScore, t.data.time);
										}),
										...
										var p,
											h = function () {
												...
												void 0 !== t && e.setUserData(r, "state", t, { deleteOnChange: !0 }),
														...
														!(function () {
															if (!window.parent.H5P.isFullscreen) {
																...
																(g.parentElement.style.height =
																	...
																	(g.style.height = "1px"),
																	(g.style.height = g.contentDocument.body.scrollHeight + "px"),
						...
						(e.fullScreen = function (t, n, r, i, o) {
							if (void 0 === e.exitFullScreen) {
								...
								if (((e.isFullscreen = !0), void 0 === e.fullScreenBrowserPrefix || !0 === o)) {
									...
									if (
										(g || ((v = document.createElement("meta")).name = "viewport"),
										(v.content =
									...
									if (
										(document.addEventListener(T, function () {
											...
											p("h5p-fullscreen"), document.removeEventListener(T, arguments.callee, !1);
										}),
										"" === e.fullScreenBrowserPrefix)
									)
										...
										var P =
											...
											E =
												"webkit" === e.fullScreenBrowserPrefix && 0 === e.safariBrowser
									...
									e.exitFullScreen = function () {
										"" === e.fullScreenBrowserPrefix
											...
											: "moz" === e.fullScreenBrowserPrefix
												...
												: document[e.fullScreenBrowserPrefix + "ExitFullscreen"]();
									};
								}
							}
						}),
						(function () {
									...
									o
										? ((t.crossOrigin = o),
											H5PIntegration.crossoriginCacheBuster &&
												(i = e.addQueryParameter(i, H5PIntegration.crossoriginCacheBuster)))
							...
							(e.getCrossOrigin = function (e) {
								...
								(e.getPath = function (e, n) {
									...
									return (
										t(r) || (r = window.location.protocol + "//" + window.location.host + r),
										r + "/" + e
									);
								});
						})(),
						...
						(e.newRunnable = function (t, n, r, i, o) {
							...
							if (t.params instanceof Object != 1 || t.params instanceof Array == 1)
								return e.error("Invalid library params for: " + t.library), e.error(t.params);
							try {
							...
							var d,
								f = o.standalone || !1;
							return (
								(l.prototype = e.jQuery.extend({}, e.ContentType(f).prototype, l.prototype)),
								void 0 ===
									(d =
								...
								void 0 === d.subContentId && t.subContentId && (d.subContentId = t.subContentId),
						...
						(e.t = function (e, t, n) {
							if ((void 0 === n && (n = "H5P"), void 0 === H5PIntegration.l10n[n]))
						...
						(e.Dialog = function (t, n, r, i) {
							var o = this,
								a = e
									...
									.insertAfter(i)
									.click(function (e) {
										(e && e.originalEvent && e.originalEvent.preventClosing) || o.close();
									})
									.children(".h5p-inner")
									.click(function (e) {
							...
							(o.open = function (t) {
								t && a.css("height", "100%"),
									setTimeout(function () {
										a.addClass("h5p-open"), e.jQuery(o).trigger("dialog-opened", [a]), a.focus();
									}, 1);
							}),
								(o.close = function () {
										...
										if (
											(s && s.library && "string" == typeof s.library
												...
												: s &&
													...
													(o =
														s.library.library && "string" == typeof s.library.library
											...
											if (
												...
												void 0 !== s.width &&
													void 0 !== s.height &&
													c.setThumbnail(new e.Thumbnail(e.getPath(s.path, r), s.width, s.height)),
													t.addMedia(c);
											}
									} else
										console.warn(
						...
						(e.openReuseDialog = function (t, n, r, i, o) {
							...
							n.displayOptions.export &&
								...
								n.displayOptions.export &&
									...
									(a += '<div class="h5p-horizontal-line-text"><span>or</span></div>'),
								n.displayOptions.copy &&
									(a +=
									...
									e
										...
										a.find(".h5p-copy-button").click(function () {
											...
											(t.contentId = o),
												...
												s.close(),
												e.attachToastTo(e.jQuery(".h5p-content:first")[0], e.t("contentCopied"), {
													position: {
														horizontal: "centered",
														vertical: "centered",
														noOverflowX: !0,
									...
									var r = n.find(".h5p-inner").find(".h5p-scroll-content"),
										...
										d = function () {
											n.find(".h5p-embed-code-container:first").val(
												a.replace(":w", u(c, i.width)).replace(":h", u(l, i.height)),
											);
										};
									c.change(d),
										l.change(d),
							...
							var o,
								...
								c = function (t, n) {
									var r,
										...
										a = "";
									("PD" === t && n) || (a += o.hasOwnProperty("label") ? o.label : o),
										o.versions &&
											(!o.versions.default || (n && o.versions[n]) || (n = o.versions.default),
											n && o.versions[n] && (r = o.versions[n])),
										r && (a && (a += " "), (a += r.hasOwnProperty("label") ? r.label : r)),
										o.hasOwnProperty("link")
											? (i = o.link.replace(":version", o.linkVersions ? o.linkVersions[n] : n))
											: r && o.hasOwnProperty("link") && (i = r.link),
										i && (a = '<a href="' + i + '" target="_blank">' + a + "</a>");
									var s = "";
									return (
										"PD" !== t && "C" !== t && (s += t),
										n && "CC0 1.0" !== n && (s && "GNU GPL" !== t && (s += " "), (s += n)),
										s && (a += " (" + s + ")"),
										"C" === t && (a += " &copy;"),
										a
									);
								...
								for (var u = 0; u < r.length; u++) {
									...
									if (void 0 !== t[d] && "" !== t[d]) {
										...
										"license" === d && (f = c(t.license, t.version)),
											"source" === d &&
												(f = f ? '<a href="' + f + '" target="_blank">' + f + "</a>" : void 0),
							...
							(this.setThumbnail = function (e) {
								...
								(this.toString = function () {
									...
									return (
										this.undisclosed() ||
											(void 0 !== o && (e += o),
											"" !== (e += a) && (e = '<div class="h5p-media-copyright">' + e + "</div>")),
										e
									);
								});
						}),
						...
						(function (t) {
							...
							(e.getUserData = function (e, t, r, i) {
								...
								if (a && a[i] && void 0 !== a[i][t]) {
									...
									n(e, t, i, function (e, n) {
										if (e || void 0 === n) r(e, n);
											...
											void 0 === o.contentUserData && (o.contentUserData = a = {}),
												void 0 === a[i] && (a[i] = {}),
												(a[i][t] = n);
											try {
								...
								(e.setUserData = function (t, r, i, o) {
									var a = e.jQuery.extend(
										!0,
										{},
										{ subContentId: 0, preloaded: !0, deleteOnChange: !1, async: !0 },
										o,
									);
									try {
										i = JSON.stringify(i);
									...
									void 0 === s && (s = H5PIntegration.contents["cid-" + t] = {}),
								...
								(e.getContentForInstance = function (e) {
									var t = "cid-" + e;
									return H5PIntegration && H5PIntegration.contents && H5PIntegration.contents[t]
											...
											(function () {
												if (r.generic) {
													...
													e.params.file &&
														...
														((r.width = 20),
														(r.height = (e.params.file.height / e.params.file.width) * r.width));
												}
											})();
								}),
								...
								(e.setClipboard = function (t) {
									localStorage.setItem("h5pClipboard", JSON.stringify(t)),
										e.externalDispatcher.trigger("datainclipboard", { reset: !1 });
								}),
								(e.getLibraryConfig = function (e) {
									return H5PIntegration.libraryConfig && H5PIntegration.libraryConfig[e]
							...
							t(document).ready(function () {
								window.addEventListener("storage", function (t) {
									"h5pClipboard" === t.key &&
										e.externalDispatcher.trigger("datainclipboard", { reset: null === t.newValue });
								});
								var t = {
									default: "4.0",
									"4.0": e.t("licenseCC40"),
						...
						return (
							...
							(n.prototype.displayToastMessage = function (e, t, n) {
								...
								const r = H5P.jQuery.extend(
									!0,
									{},
									{ position: { horizontal: "centered", vertical: "centered", noOverflowX: !0 } },
									n,
								);
						...
						(H5P.OfflineRequestQueue =
							...
							function (n) {
								...
								h.classList.add("count-down"),
									...
									p.querySelector(".h5p-confirmation-dialog-text").appendChild(h);
										...
										function (e) {
											e.data && e.data.length
												...
												: (clearInterval(s),
													...
													(a = -1),
													l && (f.hide(), (l = !1)),
													r.displayToastMessage(H5P.t("offlineSuccessfulSubmit"), !0, {
														position: { vertical: "top", offsetVertical: "100" },
													}));
										}.bind(this),
									),
									f.on(
