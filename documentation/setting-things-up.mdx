...
- Type "`npm install`" into Terminal (remember to hit ‘enter’). Installation may
  take a while if you haven’t installed this before. There is a progress bar on
  the bottom of Terminal that shows you how far along you are.
