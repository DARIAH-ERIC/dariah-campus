...
Now that you have yarn installed on your system, you will be able to use it to
install all the packages you need to run DARIAH-Campus locally on your computer.
To do this:

1. In Finder, go to the folder in which you cloned your DARIAH-Campus fork.
2. In Terminal, type "`cd`" to change directory (also note, be sure to add a
   space after ‘cd’), then
3. Drag and drop the folder from Finder into Terminal _on the same line as “cd
   “_. This will automatically write the full path (‘breadcrumb’) to the
   DARIAH-Campus folder in Terminal.
...
Now that you have all the packages you need to preview DARIAH-Campus, you can
start the server and build the site like this:

1. In Terminal, go to your local DARIAH-Campus folder (see previous steps 1, and
   3 in the previous section for how to do this)
2. Type "`yarn develop`" (+ enter). This build the whole site locally and start
   a server to run it in. This may also take a little while.
3. Once the build process is complete, you will be able to view DARIAH-Campus in
   the browser using the link given to you in the terminal, which will look like
   this: ⠀ `http://localhost:8000/`
4. Copy the url given in Terminal into your browser, which will give you the
   DARIAH-Campus home page. _Any saved edits you make to the DARIAH-Campus .mdx
   files in your editor will automatically be shown in your browser._
...
8. In GitHub desktop, make sure that you have the most up-to-date version of
   DARIAH-Campus. To do this, follow the instructions above to 'Fetch Origin'
   and 'Merge' it to your local branch
9. Once any changes from the DARIAH-Campus 'master' on GitHub has been merged to
...
10. Run: `yarn develop`. This will build the entire website and launch a server
    to run it in on your computer. Once the build process is complete, you can:
11. Navigate to `localhost:8000` in your browser to preview DARIAH-Campus. _Any
    saved edits you make to the DARIAH-Campus .mdx files in your editor will
    automatically be shown in your browser._
