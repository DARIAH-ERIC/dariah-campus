...
computer, in the locally clown fork of DARIAH-CAMPUS.
...
1. **Fetch origin**. Before you start a working session on your computer, make
   ...
   will update your local fork with possible changes you've made to your remote
   fork (if you're, for instance, working on more than one computer).
2. **Merge from upstream**. Also, before you start your working session, you
   should merge from upstream: ![](images/github_merge_from_upstream.png) This
   will update your local fork with the changes that may have been submitted to
   the "upstream" DARIAH-CAMPUS, i.e. the original repository owned by DARIAH.
3. Do your work
...
- A new window will open in your Browser. Click on the green button "Create pull
  request" ![](images/github_in_browser_create_pull_request.png)
