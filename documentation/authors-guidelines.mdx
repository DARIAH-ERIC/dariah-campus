...
Any recommendations and/or questions about the flexibility of these guidelines—or general enquiries about the process of creating a learning module—are welcome, and can be sent via the [DARIAH Helpdesk](https://www.dariah.eu/helpdesk/), Subject: 'Education and training'.
...
To propose a new hosted course, module, or tutorial for D-C, contact us via the [DARIAH Helpdesk](https://www.dariah.eu/helpdesk/), providing a structured abstract with the following information:
...
There are other options for inserting videos; guidance for these can be found in the [Sample-resource template](link)
