...
Authors can provide both endnotes and a bibliography, which should be formatted using the Chicago Manual of Style. Bibliographical items will be presented as links to the DARIAH-Campus Zotero bibliography.
