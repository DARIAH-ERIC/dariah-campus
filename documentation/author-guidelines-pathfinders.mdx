...
Recommendations and/or questions about the flexibility of these guidelines—or general enquiries about the process of creating a Pathfinder—are welcome, and can be directed to [DARIAH’s Training and Education Officer](info@dariah.eu).

</Panel>

## 1. Proposing a new Pathfinder

If you would like to contribute a Pathfinder, please [contact us](info@dariah.eu) with a structured abstract, including the following information:
