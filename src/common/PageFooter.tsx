...
import ByLogo from "~/public/assets/images/by.svg?symbol";
import CcLogo from "~/public/assets/images/cc.svg?symbol";
import EuLogo from "~/public/assets/images/eu-flag.svg?symbol";
		...
		<footer className="flex flex-col px-4 xs:px-8 py-16 space-y-6 text-sm font-medium bg-secondary-800 text-neutral-400">
			...
			<div className="flex flex-col items-center justify-between max-w-screen-lg mx-auto space-y-8 text-xs font-normal xs:space-x-8 xs:space-y-0 xs:flex-row">
				<div className="flex items-center space-x-4">
					<EuLogo className="flex-shrink-0 h-6 w-9" />
					<span>
						Co-funded by the Horizon 2020 innovation and research programme of the European Union
						under grants no. 731081 and 823782.
					</span>
				</div>
