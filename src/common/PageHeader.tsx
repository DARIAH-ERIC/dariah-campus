...
export function PageHeader(): JSX.Element {
	...
	return (
		...
		>
			...
			>
				<Image src={Logo} alt="" height="40" width="195" priority />
			</Link>
			<PageNavigation />
								...
								.map(([route, { href }]) => {
									return (
										<li key={route} className="flex px-2 py-2">
											<NavLink
												href={href}
												className="flex items-center justify-center flex-1 py-2 transition rounded hover:text-primary-600 focus:outline-none focus-visible:ring focus-visible:ring-primary-600"
											>
												{t(`common.page.${route}`)}
											</NavLink>
										</li>
