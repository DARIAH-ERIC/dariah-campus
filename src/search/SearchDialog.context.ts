 ...
 */
export const SearchDialogContext = createContext<OverlayTriggerState | null>(null);
...
export function useSearchDialog(): OverlayTriggerState {
	...
	if (dialogState === null) {
		throw new MissingContextProviderError("useSearchDialog", "SearchDialogProvider");
	}
