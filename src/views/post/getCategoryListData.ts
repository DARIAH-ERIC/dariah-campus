...
export type CategoryListItem = Pick<Category, "description" | "id" | "image" | "name">;

/**
 * Provides minimal data necessary for category list view.
 */
export function getCategoryListData(categories: Array<Category>): Array<CategoryListItem> {
