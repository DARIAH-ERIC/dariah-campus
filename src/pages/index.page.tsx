  ...
  return (
    <div className="flex justify-center" role="search">
      <button
        {...openButtonProps}
        ref={openButtonRef}
        className="flex items-center flex-1 max-w-xl px-4 py-3 text-lg transition border rounded-full shadow-xl border-neutral-150 text-neutral-500 hover:text-primary-600 hover:border-primary-600 focus:outline-none focus-visible:ring focus-visible:ring-primary-600 focus-visible:border-primary-600"
      >
