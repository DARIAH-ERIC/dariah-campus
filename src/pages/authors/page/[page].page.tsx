...
export async function getStaticProps(
	...
	const authors = paginate(getAuthorListData(await getPersons(locale)), pageSize)[page - 1]!;
	...
	return (
		<ul className="flex flex-col space-y-4">
			{authors.map((author) => {
				return (
					<li key={author.id}>
						<Link href={routes.author({ id: author.id })} className="flex items-center space-x-1.5">
