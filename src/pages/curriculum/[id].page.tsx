...
export async function getStaticProps(
	...
	const related = getCourseListData(pickRandom(coursesWithSharedTags, RELATED_COURSES_COUNT));
	...
	return (
		<Fragment>
			...
			<PageContent className="grid w-full max-w-screen-lg px-4 py-8 mx-auto space-y-10 xs:py-16 xs:px-8 2xl:space-y-0 2xl:grid-cols-content-layout 2xl:gap-x-10 2xl:max-w-none">
				...
				>
					{metadata.editors != null ? <AuthorsAside authors={metadata.editors} /> : null}
...
function LessonsList(props: LessonsListProps) {
	...
	return (
		<nav aria-label={t("common.curriculumOverview")} className="w-full space-y-2">
