...
const Cms = dynamic(
	async () => {
		...
		const { collection: events } = await import("@/cms/collections/events.collection");
		const { collection: docs } = await import("@/cms/collections/docs.collection");
		...
		const { externalResourceEditorWidget } = await import("@/cms/widgets/ExternalResource");
		const { eventSessionSpeakersEditorWidget } = await import("@/cms/widgets/EventSessionSpeakers");
		const { eventSessionDownloadEditorWidget } = await import("@/cms/widgets/EventSessionDownload");
		const { eventSessionLinkEditorWidget } = await import("@/cms/widgets/EventSessionLink");
