...
import { client, createResourceMetadata } from "@/lib/content";
...
export function generateStaticParams(): Array<
	Pick<Awaited<ExternalResourcePageProps["params"]>, "id">
> {
	const ids = client.collections.resourcesExternal.ids();
...
export async function generateMetadata(
	...
	const resource = client.collections.resourcesExternal.get(id);
