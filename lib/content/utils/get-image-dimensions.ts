...
/**
 * Be aware that vercel's output file tracing will include the whole public folder when this function is called in a
 * server component. Consider excluding public assets via `outputFileTracingExcludes` and adding `force-static` route
 * configs.
 *
