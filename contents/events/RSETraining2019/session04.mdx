...
while planning any DH project were named and discussed, to illustrate basic
concepts around a Core idea, which typically evolve into more refined Research
questions, Methods to address them, Management, Budget to support the project
and Sustainability issues at stake.
...
to prioritise requirements, KDL uses the prioritisation technique known as the
...
requirements are considered low priority. In the iterative process of project
development, this prioritisation technique is used throughout the project at
review meetings.

Given this training workshop was part of the specific project MaDiH (مديح)
Mapping Digital Cultural Heritage in Jordan with defined core idea and high
