...
abstract:
  ...
  in 1946 were eventually turned into digital data accessible on the web today.
  Consisting of a clip, a quiz, an interactive digital documentary, and a series
  of assignments, it examines the transformation of information from one medium
  (and technology) to another, a critical part of understanding digital history.'
