...
tags:
  ...
  - open-access
abstract:
In this lecture from the Austrian Centre for Digital Humanities and Cultural Heritage (ADCH-CH) entitled Crowdsourcing Methods to Increase Public Access and Engagement with Cultural Heritage and Academic Datasets, Victoria Van Hyning explores the possibilities of crowdsourcing as "cultural heritage co-creation" or "commons-based per production", as applied on the Zooniverse.org and Library of Congress projects. Van Hyning expands on the need for further comparative analysis of these well as other crowdsourcing projects’ design and engagement strategies, and their resulting data. Van Hyning discusses briefly possible applications for these data in Machine Learning training sets.
