...
abstract:
  As part of DARIAH's Friday Frontiers in-house webinar series, Iason Jongepier
  (University of Antwerp) and Melvin Wevers (University of Amsterdam) give a
  demonstration of the Time Machine Project.
type: training module
remoteUrl: https://www.youtube.com/watch?v=pM33gxkUYyA
# remoteUrl is obligatory for remotely hosted resources.
remotePublicationDate: 2020-11-19
...
In this video, viewers will learn about the Time Machine Project structure, and
how visualisations of cultural heritage such as these can deepen an
