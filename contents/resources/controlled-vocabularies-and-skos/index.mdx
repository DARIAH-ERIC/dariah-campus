...
![Diagram 1](images/cv_and_skos_diagram_1.jpg)
...
Picture 1. Visualization of IAD Thesaurus [^10]

![Picture 1](images/iad_visualization.JPG)
...
![Picture 2](images/cv_in_curation_interface.PNG)
...
![Picture 3](images/cv_popup_in_userinterface.png)
...
![Picture 4](images/cv_in_search_interface_01.png)


Picture 5. CV in faceted search interface


![Picture 5](images/cv_in_search_interface_02.PNG)
...
![Picture 6](images/vocabs_iad.JPG)
...
1. [Vocabs repository](https://vocabs.acdh.oeaw.ac.at/en/) is a services based on open source tool SKOSMOS [^11] to allow publication, reuse and retrieval of controlled vocabularies. It provides an API endpoint in order to integrate vocabulary terms in a web applications.
...
3. [Vocabs SPARQL](https://vocabs-sparql.acdh.oeaw.ac.at/) is an interface for querying vocabularies triple store with SPARQL queries. It is developed on top of Jena Fuseki [^12] triple store and uses YASGUI [^13] interface to access the endpoint.
...
[^10] IAD Thesaurus https://vocabs.acdh.oeaw.ac.at/iad_thesaurus/en/

[^11] http://skosmos.org/

[^12] https://jena.apache.org/documentation/fuseki2/

[^13] https://triply.cc/docs/yasgui