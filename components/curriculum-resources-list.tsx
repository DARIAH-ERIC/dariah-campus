				...
				{resources.map((resource, index) => {
					...
					return (
						<li key={id}>
							<Link
								className={cn(
									"relative flex items-center space-x-1.5 rounded text-sm transition hover:text-brand-700 focus:outline-none focus-visible:ring focus-visible:ring-brand-700",
									isCurrent && "font-bold",
								)}
