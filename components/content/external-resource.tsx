...
export function ExternalResource(props: ExternalResourceProps): ReactNode {
	...
	return (
		<aside className="not-prose my-12 flex flex-col items-center space-y-4 text-center text-neutral-800">
			...
			<a
				className="select-none rounded-full bg-primary-600 px-4 py-2 font-medium text-white no-underline transition hover:bg-primary-700 focus:outline-none focus-visible:ring focus-visible:ring-primary-600"
				href={url}
				target="_blank"
			>
				{t("go-to-resource")}
