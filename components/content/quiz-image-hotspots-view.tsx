...
export type HotspotPresentation = "inline" | "popover" | "sidepanel";
...
interface QuizImageHotspotsViewProps {
	alt?: string;
	children: ReactNode;
	height?: number;
	presentation?: HotspotPresentation;
	/** What the exercise asks for, picked out of the children by the server component above. */
	question?: ReactNode;
	src: string;
	width?: number;
}

/** The interactive half of `QuizImageHotspots`. */
export function QuizImageHotspotsView(props: Readonly<QuizImageHotspotsViewProps>): ReactNode {
	const { alt = "", children, height, presentation = "inline", question, src, width } = props;
