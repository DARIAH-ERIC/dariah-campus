...
The core vocabulary will be presented following a logical approach. In this context, we do not follow an alphabetical order, but we start with generic concepts moving towards the more specific ones.
...
<mark>Figure 1: Model of a Dictionary Structure (Salgado, 2021)</mark>
...
<mark>Figure 1: Minimal microstructure of a lexicographic article</mark>
...
`<lexicographic_article>
	<lexicographic_component>
		<headword>fly</headword>
	<part_of-speech>noun</part_of_speech>
	<sense>
		<sense_component>
<lexicographic_definition> Any winged insect; as the bee, gnat, locus, moth, etc.</lexicographic_definition>
<label>figurative </label>
	</sense_component>
	</sense>
	<sense>
		<sense_component>
<lexicographic_definition> A dipterous or two-winged insect, esp. of the family Muscidae</lexicographic_definition>
<label>figurative </label>
	</sense_component>
	</sense>
	</lexicographic_component>
...
Retrieved from: Oxford English Dictionary, https://www.oed.com (07/01/2022)

#### 2.2 French lexicographic article: mouche

Retrieved from: Le Robert, https://dictionnaire.lerobert.com/definition/mouche (07/01/2022)

#### 2.3 Portuguese lexicographic article: mosca

Retrieved from: Dicionário da Língua Portuguesa Contemporânea, Academia das Ciências de Lisboa, 2001
