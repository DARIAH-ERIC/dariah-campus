...
\    head\_verb = token.head.pos\_ == 'VERB'

\    person = token.ent\_type\_ == 'PERSON'
...
\_\_the token after Mahraja in title case\_\_
...
\_\_the token after Mahraja in title case followed by 'king' and two tokens\_\_
...
There is also a library in the "spaCy Universe" that makes it easier to classify texts using few-shot learning. With \[Classy Classification](https://spacy.io/universe/project/classyclassification

), you provide examples of the classes that you would like to identify.
...
\    print(ent.text, ent.kb\_id\_, ent._.dbpedia_raw_result\['@similarityScore'])
