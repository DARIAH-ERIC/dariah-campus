...
categories:
  - ehri
abstract: The way in which archival materials collected by the Jewish Museum of
  Deportation and Resistance (JMDR) were catalogued and made available to the
  public changed dramatically over the past few years as Kazerne Dossin –
  Memorial, Museum and Documentation Centre on Holocaust and Human Rights - and
  EHRI became partners in sharing (meta)data with a broader audience. Using the
  example of the Lewkowicz family collection, this article focuses on the
  evolution Kazerne Dossin went through while standardizing descriptions, and on
  the tools EHRI provided to optimize the workflow for collection holding
  institutes, a process from which Kazerne Dossin benefited as a test case.
