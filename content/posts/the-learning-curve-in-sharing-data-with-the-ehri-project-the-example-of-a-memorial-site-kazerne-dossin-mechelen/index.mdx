...
categories:
  - ehri
abstract: A partnership between Kazerne Dossin - Memorial, Museum and
  Documentation Centre on Holocaust and Human Rights - and EHRI was established
  to enable sharing of metadata with a broader audience.  As a result, the
  practices of cataloguing archival materials from specific collections changed
  dramatically over the past few years.  Using the example of the Lewkowicz
  family collection, this article focuses on the evolution Kazerne Dossin went
  through while standardizing descriptions, and on the tools EHRI provided to
  optimize the workflow for collection holding institutes, a process from which
  Kazerne Dossin benefited as a test case.
