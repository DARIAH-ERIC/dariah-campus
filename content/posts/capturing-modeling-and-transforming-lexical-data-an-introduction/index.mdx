...
<figure style={{'padding-top':'1em', 'padding-bottom':'1em', 'padding-left':'1em', 'float':'right'}}>
...
Keep in mind, there is a lot more to learn about oXygen. If you're interested, make sure to check out the ELEXIS course [Mastering oXygen XML Editor for Dictionary Nerds](https://campus.dariah.eu/id/CPYfBfo_5Rz1d8tow9Gfu) here on DARIAH-Campus.
