...
![](http://i.imgur.com/NNw9TI3l.jpg) CC-BY-SA-3.0 E.Herzel [https://commons.wikimedia.org/wiki/File%3ABrand_Anna_Amalia\_22.30Uhr.JPG](https://commons.wikimedia.org/wiki/File%3ABrand_Anna_Amalia\_22.30Uhr.JPG)
...
<figure style={{'marginTop':'0em', 'marginBottom':'0em', 'marginLeft':'1em', 'float':'right'}}>
  <img src="http://i.imgur.com/BgYAA8o.jpg"/>

  <figcaption style={{'color':'gray','fontSize':'80%','textAlign':'right'}}>
    Some caption
  </figcaption>
</figure>
...
Once you've learned the basics of working with XML, you can explore XPath, a standard query language for selecting nodes from XML documents. [Extracting Lexical Data: XPath for Dictionary Nerds](https://campus.dariah.eu/id/XUDsnt3PCB0WTEr-6EM7w) may be a good place to start.
...
As part of the ELEXIS Curriculum on DARIAH-Campus, we offer an introductory course on [Transforming Lexical Data: XSLT for Dictionary Nerds](https://campus.dariah.eu/id/DPF60ESE5Bf1jmjtPXzWI).
...
Keep in mind, there is a lot more to learn about oXygen. If you're interested, make sure to check out the ELEXIS course [Mastering oXygen XML Editor for Dictionary Nerds](https://campus.dariah.eu/id/CPYfBfo\_5Rz1d8tow9Gfu) here on DARIAH-Campus.
...
The creation of user interfaces and storage of digitized lexical datasets in databases is beyond the scope of this course. But, if you are interested, you could check out the ELEXIS course [How to Publish Your Dictionary Data with Publex](/id/IbZ4arshkA06y5Uem0UsT) here on DARIAH-Campus.
