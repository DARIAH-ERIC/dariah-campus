...
tags:
  - e-heritage
abstract: >-
  This is a set of workflows and processes on the use of museum metadata for
  research and education for both undergraduate students and postgraduate
  students in Greece, Europe and worldwide. It is included in a curriculum in a
  course offered to last year students and postgraduates as well to first year
  doctoral students at the Athens University of Economics and Business. The
  students come predominantly from the field of Digital Humanities. 

  They come from the areas of Social Sciences and Humanities, and are largely interested in Museum Studies, especially pertaining to the digital domain and the use of digital and immersive methods in museums and heritage sites. This workflow ensures that the course is applicable/reus in other departments and subject areas, so that accessibility is guaranteed. 

  As for research, this set of workflows supports and encourages curation and other similar activities 
