...
abstract: >
  ...
  significance of Cultural Heritage data, and their various types and formats.
  They are introduced to the identification of types of sources for Cultural
  Heritage data acquisition and to application methods and techniques that
  increase the quality of acquired data. Additionally, the course covers the
  basic methods to organise Cultural Heritage data and presents the main
  representatives of Cultural Heritage metadata standards. Finally, throughout
  the course the current trends and technologies prevailing in the domain
  Cultural Heritage Data are presented.
