...
Now, we can explore how to set up the dictionary for publishing. Click _Formatting_ in _Configure._ This is where you can fine-tune how you would like your entries to appear to the public when you publish your dictionary. You can change the colours, the fonts, and so on. If you are familiar with CSS (Cascading Stylesheets) or XSL (Extensible Stylesheet Language), this will be especially easy for you, but if not, don't worry either: you can work with a template, or try and explore the appearance features yourself.

To publish your dictionary, go into the _Configure_ menu, click _Publishing_, and select "Public". From the moment you click _Save_, your dictionary will be publicly viewable to anyone who knows its URL. If you decided to change your mind, you can turn it into private again whenever you want.
