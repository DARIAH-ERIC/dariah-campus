...
abstract: "Geographical Text Analysis (GTA) is a relatively recent development
  ...
  sources that offers a new method for combining techniques from Natural Language Processing (NLP), Corpus
  Linguistics, and Geographic Information Systems (GIS) in Humanities research.
  This module offers a step-by-step guide with real data, with a focused interest in querying the
  geographic nature of textual sources, and analysis of spatial information on a large scale. "
...
- **D﻿ARIAH-GTA.zip file** - available in Recogito
</SideNote>
