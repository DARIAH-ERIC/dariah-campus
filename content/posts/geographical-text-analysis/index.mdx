...
- Each row refers to a field of information (see above). For example, ‘geonameid’ is the heading for the first field.
  ...
  o	Three fields that contain place names (‘name’ is the basic one ‘ascii name’ and ‘alternatenames’ given varients on this)
  o	Coordinate information (‘latitude’ and ‘longitude’)
