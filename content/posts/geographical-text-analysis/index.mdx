...
- Click *Add* within the Data Source Manager. QGIS will then ask you which Layers you would like to add. **Select all** those that appear within the ‘QGIS-Shapefiles’ folder, as follows: (**Coast.shp**; **Lake_Cnty.shp**; **Lakes.shp**; **Lakes_towns.shp**; **Main_Roads.shp**) 