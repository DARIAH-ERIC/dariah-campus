...
- Find the Vertex Tool, located in the editing toolbar towards the top of the screen. Left-click to select Vertex Tool (Current Layer). This will allow us to edit the vertices of our layer – in this case, our points.