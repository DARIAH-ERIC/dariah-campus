...
abstract: Natural language processing is one of the most powerful concepts in
  ...
  perform complex linguistic tasks on their own. It is one of the core concepts
  in machine learning and provides us with several new opportunities on how to
  research language and the scale at which it can be done. Before that’s done,
  however, one has to convert information into a format that’s understandable to
  machines.
...
- Learn what word embeddings are and how they are created
