...
- understand the prototype tool for OCRing, and query digitised historical documents, "quod", which can be used for organising large collections of such documents

<ExternalResource title="Interested in learning more?" subtitle="Check out: quod: A Tool for Querying and Organising Digitised Historical Documents. N.B. This training resource is located in the GitHub environment, so please go straight to the text in the 'readme' file." url="https://blog.ehri-project.eu/2018/03/29/quod/" />