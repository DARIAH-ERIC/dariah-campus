...
abstract: >
  ...
  Heritage (ADCH-CH), Björn Ommer discusses Visual Analytics's concern of how to
  teach machines to enable visuals to speak for themselves. Pointing out the
  current inadequacy of research tools in the humanities, Ommer discusses
  questions such as "How would research in the humanities benefit if computers
