...
categories:
  - dariah
abstract: In this lecture, Victoria Van Hyning explores the possibilities of crowdsourcing as "cultural heritage co-creation" or "commons-based peer production", expanding on the need for further comparative analysis of design and engagement strategies for crowdsourcing projects, their resulting data and possible applications for these data in Machine Learning training sets.
