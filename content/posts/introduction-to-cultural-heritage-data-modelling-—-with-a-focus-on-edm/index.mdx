...
abstract: >
  ...
  utilising metadata standards commonly used in the domain. The course
  ...
  the use cases introduced in “Introduction to Cultural Heritage Data” course.
  Finally, it highlights the significance of understanding the structure of the
  data model not only for reusing data, but especially for exploring and reusing
  metadata.
