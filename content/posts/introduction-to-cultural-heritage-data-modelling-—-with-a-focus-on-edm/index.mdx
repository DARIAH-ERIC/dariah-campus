...
Below, we describe a subset of the main classes, which serve for the documentation of the most information regarding Cultural Heritage objects. The complete documentation about EDM can be found [here](https://pro.europeana.eu/page/edm-documentation), while the EDM mapping guidelines are available [here](https://europeana.atlassian.net/wiki/spaces/EF/pages/987758622/EDM+Core+classes).
