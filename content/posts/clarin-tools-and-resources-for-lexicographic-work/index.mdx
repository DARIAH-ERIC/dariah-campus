...
In addition to this, we recommend doing the course **Modeling Dictionaries in OntoLex-Lemon** before starting Part 2 of this course.
Finally, if you are interested in learning more about the topics of Part 1 of this course, we suggest continuing with **Lexicography in the Age of Open Data**, and **Standards for Representing Lexical Data: An Overview**.
