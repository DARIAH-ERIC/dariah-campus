...
<figure style={{ width: "50%", float: "right", "margin-left": "1em", "margin-bottom": "0", "margin-top": "0.5em", "margin-bottom": "0"  }}>
...
To begin with, let's create a new XSLT stylesheet.
...
5. Click on the blue "Create" button.
    ...
    This will create a new stylesheet file with the following content:
    ...
    We'll explain a little later what these lines of code mean. But let's first finish setting up oXygen in such a way that we can view both our bad TEI _and_ the XSLT stylesheet. To do that:

6. Select Window > Open perspective > XSLT Debugger from the main menu, or click on the XSLT icon in the upper right conrer of the main window. 
