...
categories:
  - dariah
abstract: "The course builds upon Extracting Lexical Data: XPath for Dictionary Nerds and introduces the basics of XSL Transformations (XSLT), a standard language for transforming XML documents."
...
_When should you \_not_ use the shallow copy instruction?_ For instance, if you are writing an XSLT to \_extract_ rather than _transform_ your lexical data, copying everything by default will make no sense. Later in this course, we'll show you, for instance, how to create a lemma list out of your dictionary and what `<xsl:mode>` to use in those cases.
