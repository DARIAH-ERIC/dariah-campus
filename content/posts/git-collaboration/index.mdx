...
This short course will help you understand how to work with Git in an open and collaborative setting; including the use of platforms like GitHub or GitLab. Using Git for version control to work on the same project in small teams is a good way to share and co-edit content and to keep track of all the changes.  Note: This resource was originally published to the ACDH-CH 'HowTo' internal training platform on 5th May 2023.  The publication date of this present resource reflects the date it was migrated to DARIAH-Campus.
