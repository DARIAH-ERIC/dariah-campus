...
\[INSERT TABLE: entry; headword; sense; definition; translation (headword translation, example translation); example; part of speech; secondary headword; variant headword; inflected form; label; sense indicator; note; cross-reference]
...
\[Exercise will be added shortly]
