...
remote:
  ...
  url: https://youtu.be/i3_IcKY9MNY
  publisher: Austrian Centre for Digital Humanities and Cultural Heritage (ACDH-CH)
licence: ccby-4.0
toc: false
uuid: 3YdH1Xhjf4i033vG1GMG_
shortTitle: How is the Use of Virtual Reality Technology Challenging the Museum-Library Sector?
categories:
  - dariah
---
...
<VideoCard
  provider="youtube"
  id="i3_IcKY9MNY"
  title="ACDH-CH Lecture 2.3 – Alexandra Angeletaki – How is the Use of Virtual Reality Technology Challenging the Museum-Library Sector? The Case of the University Museum and Library of Trondheim, Norway"
