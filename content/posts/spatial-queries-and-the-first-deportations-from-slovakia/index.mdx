...
To answer these questions, Michal digitised lists kept in the [Slovak National Archives](https://portal.ehri-project.eu/institutions/sk-003250) and compiled a database of the deportees containing information about their birth places, domicile and/or citizenship and place from which they were deported.  This blogpost on the EHRI website outlines the steps Michal took, and demonstrates how geospatial data such as this can be used to create visualisations that can reveal patterns and connections.
