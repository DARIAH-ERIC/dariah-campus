...
title: "Gold, Green, Diamond: What you should know about Open Access publishing
  models"
lang: en
date: 2025-01-17T09:21:41.115Z
version: 1.0.0
authors:
  - gouzi-françoise
tags:
  - open-science
abstract: "This resource aims to show an historical approach of the Open Access
  routes, and focuses both on the milestones of Open Access and on the pioneers
  (researchers actively involved) to be able to understand the evolution of the
  movement. This content also investigates terminology, concepts, research
  funding organisation and research performing organisation policies and Open
  Access strategy in the European framework. "
