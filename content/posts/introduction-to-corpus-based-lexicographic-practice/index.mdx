...
There are several aspects that should be considered. Example sentences should be:

- easy to understand
- illustrative of the use of the headword
- acceptable for the target user of the dictionary especially in terms of topics appearing in the sentence
...
- do not contain frequent references pointing outside the sentence, for example a large number of pronouns 
...
![](https://lh3.googleusercontent.com/rJ1rFQV9guLxdP0QQV9orXMhyB3Ocw8lyfR-RrcQOgtHRziYhXNuAtA8sB2m_5duArn2imyXr53hrne1gM0zePZBFtNLtRh0NXZU_YWbJoJXYjeTvZ5FsQAaUPX29Eed8HRuf7_AF5u2Ca0q8A)
