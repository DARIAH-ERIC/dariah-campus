...
Most corpora that you will use, will contain various levels of linguistic annotation.  Although automatic processing and annotation tools provide excellent results, they are not flawless and each step can introduce errors into the data.
