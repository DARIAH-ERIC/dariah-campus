...
Most corpora that you will use, will contain various levels of linguistic annotation (e.g. tokenisation, lemmatisation, part-of-speech tagging).  Although automatic processing and annotation tools provide excellent results, they are not flawless and each level of annotation may introduce new errors.

Here, we just give a few examples of some known issues.
