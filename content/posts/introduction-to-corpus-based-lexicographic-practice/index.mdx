...
Most corpora that you will use, will contain various levels of linguistic annotation.  Although automatic processing and annotation tools provide excellent results, they are not flawless and each step has its own particular challenges.

Here, we just give a few examples of some known issues in automatic processing and annotating of corpora. 
