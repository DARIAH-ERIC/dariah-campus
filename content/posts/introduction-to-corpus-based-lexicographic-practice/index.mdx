...
Semantically annotated corpora are used in NLP for Word Sense Diambiguation (WSD). +… Within ELEXIS a parallel semantically annotated dataset in 10 languages has been created (see ref) and deliverable 4.XX \[LINK]
