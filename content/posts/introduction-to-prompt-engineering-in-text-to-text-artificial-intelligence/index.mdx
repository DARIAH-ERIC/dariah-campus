...
shortTitle: "Prompt Engineering: Text to Text Artificial Intelligence"
lang: en
date: 2024-06-10T10:22:35.485Z
version: 1.0.0
authors:
  - genatowski-emily
tags:
...
abstract: The goal of this tutorial is to introduce learners to prompt
  ...
  interfacing with text to text artificial intelligence (AI).  It does so
  through the exploration of 24 different prompting techniques.  For each
