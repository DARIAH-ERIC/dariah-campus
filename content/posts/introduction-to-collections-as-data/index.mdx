...
Many questions appear when an institution is willing to adopt Collections as data such as what licence to use or how to provide documentation about the dataset. There is useful documentation available such as the [50 Things](https://collectionsasdata.github.io/fiftythings/) report that gives an overview of how to start publishing digital collections suitable for computational use. However, the process can be cumbersome for small and medium-sized institutions since they may lack the knowledge and technical skills. 

In this sense, workflows can be useful to split the task in a set of individual steps, enabling adopters to identify and focus on one or more of them. A [workflow](https://marketplace.sshopencloud.eu/workflow/I3JvP6) has been developed in the context of the [common European data space for cultural heritage](https://pro.europeana.eu/page/common-european-data-space-for-cultural-heritage), that builds on the International GLAM Labs’ [Checklist to Publish Collections as Data in GLAM Institutions](https://marketplace.sshopencloud.eu/publication/uviY8r). The workflow provides a set of ten steps focused on the publication of Collections as data in GLAM institutions. Each step is described in terms of how it can be applied and why it is relevant, including a selection of relevant examples. This intends to provide best practices and guidelines that can be useful for institutions giving their first steps.
...
If you are interested in learning more about the reuse of digital collections in innovative ways, check out the [workflow to publish Collections as data in the Social and Humanities Sciences Open Marketplace](https://marketplace.sshopencloud.eu/workflow/I3JvP6). You can also check the [Datasheets for Digital Cultural Heritage Datasets](https://doi.org/10.5334/johd.124) to provide proper documentation for datasets. In addition, you can join existing initiatives such as the [Collections as data interest group at the Research Data Alliance](https://www.rd-alliance.org/groups/collections-as-data-ig/). 
...
Otherwise, check out what else may strike your fancy on [DARIAH-Campus](https://campus.dariah.eu/). Have fun exploring!
