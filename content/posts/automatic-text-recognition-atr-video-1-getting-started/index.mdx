...
To know more about “Text recognition and model training” check out the dedicated training module.
...
You can now proceed with the [ATR roadmap workflow on the SSH-Open Marketplace](https://marketplace.sshopencloud.eu/workflow/o8ilLU)
