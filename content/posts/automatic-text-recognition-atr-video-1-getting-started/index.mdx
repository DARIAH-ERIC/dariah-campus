---
title: "Automatic Text Recognition (ATR) - Part 1: Getting Started"
lang: en
...
You can watch our video (with subtitles in English, French, and German) or read the blogpost accompanying the video (also available in all three languages): [https://harmoniseatr.hypotheses.org/274](https://harmoniseatr.hypotheses.org/274).
...
- Prepare to integrate ATR technology into your research activities effectively.
  ...
  <VideoCard provider="youtube" id="https://youtu.be/Arxi4iHFQlM?si=2xJuOVEbxDQpqpmw" title="Automatic Text Recognition - Video 1: Getting Started" subtitle="Click here to view" image="images/folie1.png" />
