...
![](images/resources_atr.png "Some platforms for ground truth and models: HTR-United, GitHub and Zenodo")
...
![Schema of a model training](images/training.png "Schema of a model training")
...
![Example of a post-ATR correction.](images/post-atr_correction.png "Example of a post-ATR correction.")
...
- Script: [https://github.com/DiScholEd/pipeline-digital-scholarly-editions/tree/master/post_ocr_correction/scripts](https://github.com/DiScholEd/pipeline-digital-scholarly-editions/tree/master/post_ocr_correction/scripts)
- Documentation: h[ttps://github.com/DiScholEd/pipeline-digital-scholarly-editions/blob/master/post_ocr_correction/post-ocr_correction_for_text_files.md](ttps://github.com/DiScholEd/pipeline-digital-scholarly-editions/blob/master/post_ocr_correction/post-ocr_correction_for_text_files.md) 

##### Python scripts, regex, and context

- Scripts: [https://github.com/sbiay/CdS-edition/blob/main/htr/py/spellcheckTexts.py and https://github.com/sbiay/CdS-edition/blob/main/htr/py/textCorrection.py](<https://github.com/sbiay/CdS-edition/blob/main/htr/py/spellcheckTexts.py and https://github.com/sbiay/CdS-edition/blob/main/htr/py/textCorrection.py>)
- Documentation: [https://github.com/sbiay/CdS-edition/blob/main/htr/Corriger_une_prediction.ipynb](https://github.com/sbiay/CdS-edition/blob/main/htr/Corriger_une_prediction.ipynb)  

##### Neural approach to correction

- Project: [https://github.com/GarfieldLyu/OCR_POST_DE](https://github.com/GarfieldLyu/OCR_POST_DE) 
...
Post-ATR correction is a key element of the Automatic Text Recognition pipeline. Decisions on whether to automatise it or part of it are integral to the exploration and research process. With this resource, you can balance pros and cons and find the tool suited to your approach.
