...
<ExternalResource title="Interested in learning more?" subtitle="Check out Using OpenCV for Face Detection. N.B. This training resource is located in the GitHub environment, so please go straight to the text in the 'readme' file." url="https://github.com/EHRI/ehri-data-analysis-tools/tree/master/face_detection_with_opencv" />