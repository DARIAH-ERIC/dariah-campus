...
For a deeper understanding of the corpus analysis tools and dictionary editing tools (Lexonomy) mentioned in this chapter, the student is expected to refer to the LEX2: Mastering ELEXIS Corpus Tools for Lexicographic Purposes and Lexonomy: Mastering the ELEXIS Dictionary Writing System courses. 
...
The following screenshot shows the settings of the ONceClick Dictionary interface used in the Push mode to generate 10 dictionary entries from a corpus about digital photography.
