---
title: Introduction to metadata and documentation / Einführung in Metadaten und Dokumentation
lang: de
date: 2022-07-08
version: 1.0.0
authors:
...
categories:
  - acdh-ch
abstract: >-
	Following on from the "Fundamentals of data management", this chapter provides an introduction to the topic of metadata. What is metadata? What components does it consist of? And what types of metadata can we distinguish?

	Anschließend an die "Grundlagen des Datenmanagements" bietet dieses
