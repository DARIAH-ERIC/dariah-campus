...
Entires in the lexicography module can also capture the structure of an entry including subsenses. For example, a dictionary entry containing structure such as the entry below for **fish** may be captured using `LexicographicComponent`s.
...
1. An invertebrate marine animal with gills
   ...
   2. Any inverterbrate animal living in water
2. A fishing trip
...
- https://www.w3.org/2019/09/lexicog/ (Lexicography module)
