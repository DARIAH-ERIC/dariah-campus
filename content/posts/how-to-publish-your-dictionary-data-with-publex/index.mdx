...
- **Set as searchable field** <a id="searchable-field"/>If you want the selected element to appear as a search field in the dictionary look-up, activate this field.
...
\[For the hands-on section, we plan to work together with the developers of Elexifier and offer data that allows users to apply Elexifier and Publex in one pipeline.] SupportCancel Full-text Access
