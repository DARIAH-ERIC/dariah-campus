...
summary:
  content: >
    This curriculum introduces the theory and practice of text encoding using
    the Guidelines of the Text Encoding Initiative (TEI), introducing the
    theories, practices, and methods that are used in the humanities for the
    encoding of texts for research, for preservation, and for online
    distribution.
resources:
...
* **"Unit II Modelling with XML and DTDs"** delves into XML in more detail: discussing the building blocks of XML and an overview of its rules and structures. This unit also introduces schema and Document Type Declarations (DTDs), with exercises on how to model XML via a DTD;&#x20;
...
**(Biographies accurate at the time of writing)**
