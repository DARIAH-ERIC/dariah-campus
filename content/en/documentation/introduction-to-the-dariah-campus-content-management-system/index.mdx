...
To add a ‘Fill in the blank’ quiz, go to the Widget menu and select the ‘Fill in the Blank’ option.  An editable box will appear with some guiding information for how to give the correct syntax for the different options.  Those different options are:
