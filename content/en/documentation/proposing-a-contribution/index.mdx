...
2. You will need to fill in the form found here: <Link link={{"discriminant":"external","value":"https://github.com/DARIAH-ERIC/dariah-campus/issues/new?template=01-propose-resource.yml"}}>Propose a Resource</Link> form
