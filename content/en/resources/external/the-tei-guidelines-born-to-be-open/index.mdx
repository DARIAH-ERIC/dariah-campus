...
summary:
  content: >-
    ...
    science in the current scholarly landscape while showing how the Text
    Encoding Initative (TEI) has been seminal in setting up an open agenda for
    managing, documenting or disseminating scholarly sources and methods.
remote:
...
<VideoCard provider="youtube" id="hV-wtGlx8I8" title="ACDH-CH Lecture 6.1 – Laurent Romary – The TEI Guidelines: Born to Be Open" subtitle="Click here to view" src="/assets/content/assets/en/resources/external/the-tei-guidelines-born-to-be-open/acdh-ch-laurent-tei.png" />
