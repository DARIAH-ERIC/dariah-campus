...
<Grid layout="two-columns" alignment="stretch">
  <GridItem alignment="stretch">
    <Figure src="/assets/content/assets/en/resources/external/citizen-science-in-the-digital-arts-and-humanities/cs-1-who-is-a-citizen-scientist-fig1-p8-150x150.png" alt="A pyramid shape model.  At the top is 'Co-design'.  On the second row, 'Co-production'.  On the third row down 'Active participation - e.g. surveys'.  On the bottom row 'Passive observation - communication of research results'." alignment="stretch">
  ...
  <GridItem alignment="stretch">
    <Figure src="/assets/content/assets/en/resources/external/citizen-science-in-the-digital-arts-and-humanities/cs-2-who-is-a-citizen-scientist-serrano-et-al-2014.png" alt="MOdels of Citizen Engagement in Science: - Pooling of resources; Data collection; Analysis tasks; Serious games; Participatory Experiments; Grassroots Activities; Collective Intelligence." alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/external/citizen-science-in-the-digital-arts-and-humanities/cs-5-challenges-explore-at-case-study-fig5.jpg" alt="exploreAT! logo." alignment="stretch">
...
#### [Further Learning for this section (click to expand)](#1549900863180-f381fa25-ea6c)
...
#### [Case Study](#1556799532452-cdbca964-876b)
...
#### [Further Learning for 'Creating a Citizen Science Project' (click to expand)](#1549971728957-bd6cb671-b239)
...
<Figure src="/assets/content/assets/en/resources/external/citizen-science-in-the-digital-arts-and-humanities/cs-6-data-life-cycle-model.png" alt="Data Life Cycle: Plan; Collect; Assure; Describe; Preserve; Discover; Integrate; Analyze." alignment="stretch">
...
#### [Case Study](#1549978631346-621619b4-0795)
...
#### [Further Learning for 'How to Manage Data and Metadata in Citizen Science' (click to expand)](#1549972077347-f8e1e8ac-556f)
...
This PARTHENOS Training modules was authored by Professor Jennifer Edmond (Trinity College Dublin), Eliza Papaki (Triniy College Dublin) and Dr. Erzsébet Tóth-Czifra (DARIAH-EU).  It was edited by Vicky Garnett (Trinity College Dublin).

If you would like to cite this module, we suggest the following citation:

“*Citizen Science in the (Digital) Arts and Humanities*“, Edmond, J. (Auth.), Garnett, V. (Ed.), Papaki, E. (Auth.), Tóth-Czifra, E. (Auth.) for PARTHENOS. \<URL> (Retreived on \[INSERT DATE])
