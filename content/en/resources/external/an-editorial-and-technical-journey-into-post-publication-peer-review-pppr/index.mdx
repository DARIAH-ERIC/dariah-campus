...
summary:
  content: >-
    ...
    peer review (PPPR) as well as the risks, challenges and potential benefits
    of changing traditional approaches to research publication workflows.
remote:
...
<VideoCard provider="youtube" id="Xd7Pyp8srno" title="An Editorial and Technical Journey into Post-Publication Peer Review (PPPR)" subtitle="Click here to view" src="/assets/content/assets/en/resources/external/an-editorial-and-technical-journey-into-post-publication-peer-review-pppr/pppr-title-slide.png" />
