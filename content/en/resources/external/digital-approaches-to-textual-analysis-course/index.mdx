...
sources:
  - dariah
featured-image: >-
  /assets/content/assets/en/resources/external/digital-approaches-to-textual-analysis-course/featured-image.webp
license: cc-by-4.0
table-of-contents: false
summary:
  content: >-
    This free online course provides a practical introduction to working with
    digital texts and applying some of the tools available to digitise and
