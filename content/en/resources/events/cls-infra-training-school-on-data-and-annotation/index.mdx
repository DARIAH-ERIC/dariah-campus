...
sessions:
  - title: Intro - Information extraction from the Shakespeare Drama Corpus
    ...
    attachments:
      - label: Download
        file: /assets/content/downloads/en/resources/events/cls-infra-training-school-on-data-and-annotation/sessions/2/downloads-1-silvie-introduction.pdf
    links:
      - label: Synthesis
  ...
  - title: XML, TEI, and TEITOK I
    ...
    attachments:
      - label: Download
        file: /assets/content/downloads/en/resources/events/cls-infra-training-school-on-data-and-annotation/sessions/2/downloads-2-maarten-xml-tei-and-teitok.pdf
    links:
      - label: Synthesis
  ...
  - title: Universal Dependencies – Morphology
    ...
    attachments:
      - label: Download
        file: /assets/content/downloads/en/resources/events/cls-infra-training-school-on-data-and-annotation/sessions/2/downloads-3-silvie-ud-pipe-universal-dependencies-morphology.pdf
    links: []
    presentations: []
  - title: Base CQL
    speakers:
  ...
  - title: Metadata
    ...
    attachments:
      - label: Download
        file: /assets/content/downloads/en/resources/events/cls-infra-training-school-on-data-and-annotation/sessions/2/downloads-5-maarten-metadata.pdf
    links: []
    presentations: []
  - title: Advanced CQL
    speakers:
  ...
  - title: Statistics
    ...
    attachments:
      - label: Download
        file: /assets/content/downloads/en/resources/events/cls-infra-training-school-on-data-and-annotation/sessions/2/downloads-7-vaclav-statistics.pdf
    links: []
    presentations: []
  - title: Universal Dependencies – Syntax
    ...
    attachments:
      - label: Download
        file: /assets/content/downloads/en/resources/events/cls-infra-training-school-on-data-and-annotation/sessions/2/downloads-8-silvie-universal-dependencies-syntax.pdf
    links: []
    presentations: []
  - title: Named-Entity Recognition and bulk editing
    ...
    attachments:
      - label: Download
        file: /assets/content/downloads/en/resources/events/cls-infra-training-school-on-data-and-annotation/sessions/2/downloads-9-maarten-named-entity-recognition.pptx
    links: []
    presentations: []
  - title: Tree queries - Grew
    ...
    attachments:
      - label: Download
        file: /assets/content/downloads/en/resources/events/cls-infra-training-school-on-data-and-annotation/sessions/2/downloads-10-silvie-tree-query-languages-exercise-in-grew.pptx
    links: []
    presentations: []
