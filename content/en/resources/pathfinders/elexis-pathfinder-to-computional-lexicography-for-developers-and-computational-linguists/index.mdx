...
In the courses, <Link link={{"discriminant":"resources-hosted","value":"lexonomy-mastering-the-elexis-dictionary-writing-system"}}>Lexonomy: Mastering the ELEXIS Dictionary Writing System</Link> and <Link link={{"discriminant":"resources-hosted","value":"lex2-mastering-elexis-corpus-tools-for-lexicographic-purposes"}}>LEX2:  Mastering ELEXIS Corpus Tools for Lexicographic Purposes</Link>, you can learn how to use the DWS Lexonomy and the CQS Sketch Engine. In this pathfinder, we take a broader perspective. We describe in a nutshell what a DWS and a CQS is, what the main characteristics are and what kinds of systems there are and where you can find them.
...
Other features offered by corpus tools involve some type of statistical calculation, for example word lists, collocations, synonyms and so forth (see Section 4 in the course <Link link={{"discriminant":"resources-hosted","value":"introduction-to-corpus-based-lexicographic-practice"}}>Introduction to Corpus-Based Lexicographic Practice</Link> for more and Atkins and Rundell 2008:108). Among the more advanced features and highly valuable to lexicographers, are detailed collocation presentation (lexical profiling), good dictionary example identification tool, and tickbox lexicography.
...
A separate module of the ELEXIS Curriculum gives an overview of the <Link link={{"discriminant":"resources-hosted","value":"clarin-tools-and-resources-for-lexicographic-work"}}>CLARIN Tools and Resources for Lexicographic Work</Link>.
