...
summary:
  title: Data Mining
  content: This video introduces data mining as a collection of computational
    methods for extracting knowledge from large digital datasets. It outlines
    the main stages of a data mining workflow - preprocessing and analysis - and
    explains key techniques including clustering, outlier detection,
    classification, and association pattern mining, with examples from
    humanities research.
content-type: video
translations: []
dariah-national-consortia: []
dariah-working-groups: []
doi: https://hdl.handle.net/21.11159/01a057ae-77f5-758c-b078-924fba6d8a52
---
