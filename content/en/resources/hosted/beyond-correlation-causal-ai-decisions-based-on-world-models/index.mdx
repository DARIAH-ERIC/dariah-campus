...
* <VideoCard provider="youtube" id="MTKUL8npqW8" title="AT ACDH Lecture 12.2 with Roland Fleischhacker (deepsearch) " src="/assets/content/assets/en/resources/hosted/beyond-correlation-causal-ai-decisions-based-on-world-models/lecture-12.2-bild.png" />
