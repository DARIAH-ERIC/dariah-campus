...
3. Tour of APWA pages
   * Try keyword searches using the search interface (Home> <Link link={{"discriminant":"external","value":"https://prisonwitness.org/the-archive/"}}>Explore the
     Archive</Link>)
...
4. Show some <Link link={{"discriminant":"external","value":"https://prisonwitness.org/curated-collections/"}}>sample
   curations</Link>
