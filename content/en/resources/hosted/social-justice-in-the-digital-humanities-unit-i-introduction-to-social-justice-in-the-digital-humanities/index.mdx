...
<Callout kind="none">
  ...
  The common goals of PVAs and some examples of these archives (first slide, from top to bottom): <Link link={{"discriminant":"external","value":"https://www.yegpoliceviolencearchive.ca/s/archive/page/home"}}> YEG Police Violence Archive</Link>, <Link link={{"discriminant":"external","value":"https://www.archivingpoliceviolence.org/"}}>A People’s Archive of Police Violence</Link>, and <Link link={{"discriminant":"external","value":"https://mappingpoliceviolence.us/"}}>Mapping Police Violence </Link>.
</Callout>
...
<Callout kind="none" title="Exercise: Reconstructing mainstream narratives">
