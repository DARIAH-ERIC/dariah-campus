...
<Disclosure title="Footnotes for The SCWAReD Projects">
  ...
  \[3]: Adapted from José Eduardo González's Introduction to the Spanish American Fiction workset and its related Final report. Table 1, Figure 4 and 5 are taken directly from González’s Introduction (table) and Final Report (figures).\*\*DELETE THIS FOOTNOTE\*\*\*
