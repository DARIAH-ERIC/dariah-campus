...
<Callout kind="none" title="Acknowledgements">
  This resource was edited to fit the DARIAH-Campus House Style following migration from #dariahTeach by Vicky Garnett.  The migration process itself was developed and conducted by Stefan Probst and Barbara Krautgartner.
</Callout>
...
<Callout kind="none" title="Exercise: Comparative Analysis using NASN">
  ...
  <Video provider="youtube" id="4TuhCzvp-RY?si=v_85kpdHNLVXL8Ns">
