...
This module is part of a wider <Link link={{"discriminant":"curricula","value":{"id":"automatic-text-recognition-made-easy"}}}>'Automatic Text Recognition Made Easy' Curriculum</Link>. You may also wish to visit the next module in this curriculum, <Link link={{"discriminant":"resources-hosted","value":{"id":"automatic-text-recognition-atr-end-formats-and-reusability"}}}>Automatic Text Recognition (ATR) - End Formats and Reusability</Link>.
