...
See our Git collaboration guide to learn more about <Link link={{"discriminant":"resources-hosted","value":{"id":"git-collaboration","hash":"cloning-a-remote-repository"}}}>cloning a remote repository</Link>.
...
See our Git version control via command line guide to learn more about <Link link={{"discriminant":"resources-hosted","value":{"id":"git-version-control-via-command-line","hash":"mark-content-changes-to-be-included-in-the-version-history"}}}>adding files</Link>.
...
See our Git version control via command line guide to learn more about <Link link={{"discriminant":"resources-hosted","value":{"id":"git-version-control-via-command-line","hash":"bundle-changes-into-meaningful-chunks"}}}>bundle changes into meaningful chunks and commit to them</Link>.
