...
The edition view consists of 65 HTML pages. [Page 18](https://karl-kraus.github.io/wpn-static/absatz_18.html) of the edition - also shown in the screenshot below - gives a good example of the complexity that has to be dealt with.
...
<Figure src="/assets/content/assets/en/resources/hosted/improving-quality-assurance-and-development-efficiency-with-regression-testing/snapshot-absatz-18-chromium-linux.png" alt="example of a test screenshot" alignment="stretch">
