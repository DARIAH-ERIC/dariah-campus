---
title: 'Markup Languages: Their History and Uses'
locale: en
...
summary:
  content: >
    This resource teaches the principles behind markup language and how they are
    applied in order to enable digital means of text analysis.  It covers
    historical ways of analysis text before moving on to how XML and TEI can be
    used for digital analysis.
...
---
This resource on markup languages and their history is divided into four lessons. **Markup Languages and Text Modelling** introduces the history of markup languages. You will learn how to distinguish features  and characteristics of markup languages, and limitations and advantages of making text machine readable. **What is Text Really?** discusses the concept of  'text', and how it is understood from a text encoding perspective. The theory of the OHCO Model (Ordered Hierarchy of Content Objects) is discussed. It describes a rationale for issues common to SGML-based markup languages, as well as a broader understanding of what constitutes text in the digital age. **Modelling With XML** and **Modelling with TEI** explore the history of XML and TEI, their characteristics, as well as the strengths and weaknesses of markup languages. This introduces the building blocks of XML: elements and attributes. 

This resource is part of the DARIAH-Teach "Text Encoding and the Text Encoding Initiative" curriculum.

## Learning Outcomes

After completing this module, learners will be able to:

* Trace the historical development of markup languages from early print-based annotation practices through SGML, XML, and TEI, and distinguish between presentational and descriptive approaches to marking up text.
* Explain the OHCO (Ordered Hierarchy of Content Objects) model and evaluate its strengths and limitations as a theoretical framework for understanding text structure, including the challenge of overlapping hierarchies.
* Apply the core principles of XML and TEI to describe how texts can be modelled in a machine-readable, software-independent, and semantically meaningful way for humanities research.

Please note: these learning outcomes were written with the support of Generative AI (Anthropic Claude Sonnet 4.6)

<Callout kind="note" title="Publication History of this Resource">
...
<Video provider="youtube" id="E7-g17oL7w0?si=iCxaNgFaABLcjPm-">
...
<Figure src="/assets/content/assets/en/resources/hosted/text-encoding-and-the-tei-unit-i-markup-languages-their-history-and-uses/12e535814338e541c9ee62c66827b2f87676456e-5648.png" alt="A document in letter format, but all the letters have been replaced with 'X'." alignment="right-one-fourth">
...
<Figure src="/assets/content/assets/en/resources/hosted/text-encoding-and-the-tei-unit-i-markup-languages-their-history-and-uses/fb98bcd1f127a69d7f4190ef21f77ddd9e553bfb-5649.png" alt="A document, but all the letters have been replaced with the letter 'X'." alignment="right-one-fourth">
...
<Figure src="/assets/content/assets/en/resources/hosted/text-encoding-and-the-tei-unit-i-markup-languages-their-history-and-uses/c17de6f9b1c9ca01635503424751dd493b9b595d-5650.png" alt="A handwritten letter with text written vertically and horizontally across the page." alignment="center">

</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/text-encoding-and-the-tei-unit-i-markup-languages-their-history-and-uses/81088c251e7743b7204ea63d6121c98db7b803f0-5651.jpg" alt="Calligraphy text written without any spaces or punctuation." alignment="right-one-third">
...
<Video provider="youtube" id="vkGsjOin0KA?si=NfIGiab4WCSGZnZs">
