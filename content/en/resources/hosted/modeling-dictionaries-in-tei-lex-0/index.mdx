...
![Good news for people who love bad news](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/5-w4-fyo-0.jpg "CC BY-ND Olivia Mew")
...
7. Click on the downward pointing arrow next to `<teiHeader>` to fold the contents of the teiHeader.
   ...
   ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/4s-chb-kf.png)
...
8. Go back to your previously saved XML file and copy everything starting with `<entry>` and ending with `</grammar>`; in your current TEI file, delete `<p></p>` inside `<body></body>` and then paste the copied contents from the old file instead.
   ...
   ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/f-uh-nsam.png)
...
10. Hover with your mouse over the underlined end tag `</body>` to see what error oXygen will report there.
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/oavd-vs-i.png)
...
12. Now, double-click the element name in `<lemma>`.
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/m-f7-z2e-g.png)

13. Change the element name to `<form>`.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/2qr-kj-u9.png)

14. Select `@normalized` and its value, then delete both.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/l-fx-ou-uv.png)

15. Add attribute `@type` to `<form>` and check out what options are suggested for values.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/mkja90a.png)
...
17. Select the text value of `<form>`.
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/rx-dpq2-b.png)
...
18. Control-click or right-click the selected word to bring up a contextual menu, then select Refactoring › Surround with Tags.
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/szn-ob-nh.png)
...
19. Select orth from the dropdown by scrolling to it, or for a more efficient solution, start typing `o` in the field "Specify the tag".
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/omnl-atz.png)

20. Add `@norm` to `<orth>`.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/g0-wxz-jt.png)

21. Type in 'lexicographer' as value of `@norm`.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/qv-lc-dwe.png)

22. Remember the "Fromat and Indent" icon that we introduced in the last unit? Find it and click on it.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/u8ji-qxe.png)

23. Finally, replace `<grammar>n.s.</grammar>` with `<gramGrp><pos>n.s.</pos></gramGrp>`.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/arl-t3-fd.png)
...
![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/feuy9g-d.png)
