...
draft: true
doi: https://hdl.handle.net/21.11159/019595c5-1fb5-734d-be4c-858d1c62688c
---
...
<Figure src="/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/ac.jpg">
...
7. Click on the downward pointing arrow next to `<teiHeader>` to fold the contents of the teiHeader.
   ...
   ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/ab.png)
...
8. Go back to your previously saved XML file and copy everything starting with `<entry>` and ending with `</grammar>`; in your current TEI file, delete `<p></p>` inside `<body></body>` and then paste the copied contents from the old file instead.
   ...
   ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/ae.png)
...
10. Hover with your mouse over the underlined end tag `</body>` to see what error oXygen will report there.
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/be.png)
...
12. Now, double-click the element name in `<lemma>`.
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/bc.png)

13. Change the element name to `<form>`.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/aa.png)

14. Select `@normalized` and its value, then delete both.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/bb.png)

15. Add attribute `@type` to `<form>` and check out what options are suggested for values.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/bd.png)
...
17. Select the text value of `<form>`.
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/cb.png)
...
18. Control-click or right-click the selected word to bring up a contextual menu, then select Refactoring › Surround with Tags.
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/cc.png)
...
19. Select orth from the dropdown by scrolling to it, or for a more efficient solution, start typing `o` in the field "Specify the tag".
    ...
    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/bf.png)

20. Add `@norm` to `<orth>`.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/ba.png)

21. Type in 'lexicographer' as value of `@norm`.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/ca.png)

22. Remember the "Fromat and Indent" icon that we introduced in the last unit? Find it and click on it.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/cd.png)

23. Finally, replace `<grammar>n.s.</grammar>` with `<gramGrp><pos>n.s.</pos></gramGrp>`.

    ![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/ad.png)
...
![](/assets/content/assets/en/resources/hosted/modeling-dictionaries-in-tei-lex-0/af.png)
