...
This module is part of a wider <Link link={{"discriminant":"curricula","value":"automatic-text-recognition-made-easy"}}>'Automatic Text Recognition Made Easy' Curriculum</Link>.  You may also wish to visit the next module in this curriculum, <Link link={{"discriminant":"resources-hosted","value":"automatic-text-recognition-atr-text-recognition-and-post-atr-correction"}}>Automatic Text Recognition (ATR) - Text Recognition and Post-ATR Correction</Link>.
