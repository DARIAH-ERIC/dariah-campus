...
This module is part of a wider '[Automatic Text Recognition Made Easy' Curriculum](https://campus.dariah.eu/curricula/automatic-text-recognition-made-easy).  You may also wish to visit the next module in this curriculum, "[Automatic Text Recognition (ATR) - Text Recognition and Post-ATR Correction](https://campus.dariah.eu/resources/hosted/automatic-text-recognition-atr-text-recognition-and-post-atr-correction)".
