...
summary:
  content: >-
    This tutorial explores where and how to find, create, and collect images of
    textual material, a crucial initial step in any process using Automatic Text
    Recognition (ATR).
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-2-where-and-how-to-get-images/anna_digitizing_a_document.jpeg" alignment="stretch">
  Digitisation of archive material: Anna Busch scanning a book
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-2-where-and-how-to-get-images/get-images_copyright.jpg" alignment="stretch">
  Under copyright or not? There might be a difference concerning the printed book, the scan or the textual content
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-2-where-and-how-to-get-images/im_magazin.jpeg" alignment="stretch">
  Inside an Archive: Aneta Plzáková at the moving storage rack shelves
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-2-where-and-how-to-get-images/charter-poster-1.jpg" alignment="stretch">
  Cultural Heritage Reuse Charter by DARIAH, [https://www.dariah.eu/activities/open-science/data-re-use/](https://www.dariah.eu/activities/open-science/data-re-use/)
</Figure>

## Conclusion

Gathering images is the first important step in building the collection or corpus underlying an ATR project. While the internet provides a wealth of digital surrogates, this resource has shown that the reuse conditions for any scanned document have to be investigated before the processing phase. The Cultural Heritage Data Reuse Charter presented here was developed to provide guidance in the collaboration with Heritage Institutions and helps foster good practices.

### The "Automatic Text Recognition Made Easy" curriculum

This module is part of a wider '[Automatic Text Recognition Made Easy' Curriculum](https://campus.dariah.eu/curricula/automatic-text-recognition-made-easy).  You may also wish to visit the next module in this curriculum, "[Automatic Text Recognition (ATR)- Pre-Processing and Image Optimisation](https://campus.dariah.eu/resources/hosted/automatic-text-recognition-atr-pre-processing-and-image-optimisation)".
