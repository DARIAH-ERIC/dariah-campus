...
---
This 'Modelling with XML and DTDs' module is divided into three lesson. In **Basic XML rules: well formed vs. valid XML** the key rules for XML documents are discussed. The basic rules to construct XML documents are explained, how to use elements and attributes, how to encode special characters (via Unicode), how elements are nested, and what the relationships between elements are, described as a family (parent, children, sibling) relationships. **Introduction to DTDs provides a history of DTDs**, what they are used for, and the difference between internal and external DTDs. There are exercises in creating elements and attributes, as well as the opportunity to create your first DTD. The DTD exercise is designed for you to put into practice what you have learned through modelling a poem. The **Advanced DTD Exercise** is an challenge exercise which provides you with the framework for creating a DTD and document instance (XML document that adheres to the DTD)  for a recipe.

This resource is part of the DARIAH-Teach "<Link link={{"discriminant":"curricula","value":{"id":"text-encoding-and-the-tei"}}}>Text Encoding and the Text Encoding Initiative</Link>".

## Learning Outcomes

After completing this module, learners will be able to:

* **Construct well-formed and valid XML documents** by correctly applying core XML syntax rules, including proper use of elements, attributes, nesting, and Unicode entity references.
* **Design and write Document Type Definitions (DTDs)** that specify element and attribute rules, content models, and occurrence constraints for structured XML documents.
* **Apply XML and DTD modelling skills to real-world data** by creating document instances and corresponding DTDs for structured content such as poems, recipes, and address books.
...
<Link link={{"discriminant":"external","value":"http://www.w3schools.com/xml/xml_validator.asp"}}>W3Schools</Link> identifies five key rules for XML syntax. Documents that conform to these rules are called *Well-Formed*:
...
<Figure src="/assets/content/assets/en/resources/hosted/text-encoding-and-the-tei-unit-ii-modelling-with-xml-and-dtds/15cf90b368ddf75e0e850b1b5e1eceb7cdf44bfb-5727.jpg" alt="Matryoshka dolls." alignment="right-one-fourth">
...
Conceptually, the structure of an XML document is a tree structure. The *root element*, forms the basis of the XML tree and all other element nodes, attribute nodes and text nodes reach out like branches and leaves. Visually this could be represented as a tree graph as in the following figure of the address book in the previous section:

<Figure src="/assets/content/assets/en/resources/hosted/text-encoding-and-the-tei-unit-ii-modelling-with-xml-and-dtds/f7fad3bcd13b476edb7bf474b6623f5448753a38-5739.png" alignment="stretch">
...
<Video provider="youtube" id="xp2hbHaBZwI?si=6sRjFwVYlZyMt4zx">
...
<Video provider="youtube" id="sDH0w-I9qYM?si=EydgobWyfstwk-xU">
...
<Callout kind="none" title="DTD Exercise 1">
  ...
  * author
  ...
  To help you with the DTD syntax, we’ve created a <Link link={{"discriminant":"download","value":"/assets/content/downloads/en/resources/hosted/text-encoding-and-the-tei-unit-ii-modelling-with-xml-and-dtds/dtd-cheat-sheet.pdf"}}>DTD Cheat Sheet</Link>. Open up the PDF and keep it handy when you are creating the DTD. Create the DTD in a parsing editor such as oXygen. oXygen understands DTD syntax, and once you begin creating the document instance, it will give error messages if you do something wrong. However, until the XML code is in place, you will get parsing errors.
  ...
  <Video provider="youtube" id="CKC3_kAbWPg?si=RVjY3cCYAErgxyBh">
    ###
  </Video>
</Callout>
...
<Callout kind="none" title="DTD Exercise 2: Adding Attributes">
  ...
  <Video provider="youtube" id="2L9XBuCsQUw?si=TTOfl6-u5fHWImSa">

  </Video>
</Callout>

## Advanced DTD exercises

<Tabs>
  <Tab title="Recipe exercise">
  ...
  <Tab title="Cookbook exercise">
    Based on the Recipe exercise you should create an online cookbook now. Starting from the recipe model, what elements and attributes do you need to create a model of a cookbook?
...
## (Delete below if Susan approves of tabs)
