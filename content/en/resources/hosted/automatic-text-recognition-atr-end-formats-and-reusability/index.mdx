...
This module is the last part of a wider <Link link={{"discriminant":"curricula","value":{"id":"automatic-text-recognition-made-easy"}}}>'Automatic Text Recognition Made Easy' Curriculum</Link>.
