...
summary:
  content: >-
    ...
    aggregate big cultural data and reduce it to a small set of patterns? Or
    shall we refuse this dominant paradigm instead and focus on diversity,
    variability and differences (including tiny ones), i.e., work on big
    cultural data without aggregation and with attention to what is infrequent
    and outliers?
content-type: video
translations: []
...
<VideoCard provider="youtube" id="Bjjbhs0O3LE" title="What Does Data Want?" subtitle="Click here to view" src="/assets/content/assets/en/resources/hosted/what-does-data-want/lev-manovich.png" />
