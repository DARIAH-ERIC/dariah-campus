...
doi: https://hdl.handle.net/21.11159/019595c5-1190-762d-9ec8-13ebbf77c908
---
...
This course requires basic knowledge of Lexicography, which can be acquired from the <Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-dictionaries"}}}>Introduction to Dictionaries</Link> and the <Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-corpus-based-lexicographic-practice"}}}>Introduction to Corpus-Based Lexicographic Practice</Link> courses. In addition to this, we recommend doing the course <Link link={{"discriminant":"resources-hosted","value":{"id":"modeling-dictionaries-in-ontolex-lemon"}}}>Modeling Dictionaries in OntoLex-Lemon</Link> before starting Part 2 of this course. If you are interested in learning more about the topics of Part 1 of this course, we suggest continuing with <Link link={{"discriminant":"resources-hosted","value":{"id":"lexicography-in-the-age-of-open-data"}}}>Lexicography in the Age of Open Data</Link> and <Link link={{"discriminant":"resources-hosted","value":{"id":"standards-for-representing-lexicographic-data-an-overview"}}}>Standards for Representing Lexical Data: An Overview</Link>.
...
![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/clarin-map-europe-2021-10-0.jpg)
...
![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/9-f-md518.png)
...
![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/pg-x79z-x.png)
...
![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/2-petnm-c.png)
...
This video shows the management of the core module ![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/y4il8-au.png)
...
![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/evhql-y7.png) ![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/y-fnn-qr4.png)
...
![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/e-g-mh-ssx.png)
...
![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/z-cp-kge-r.png)

![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/x-te29ze.png)

**The lexical entry dictionary view.** [Link](https://)

The video shows the dictionary-like view of LexO

![](/assets/content/assets/en/resources/hosted/clarin-tools-and-resources-for-lexicographic-work/em-ghu-9v.png)
