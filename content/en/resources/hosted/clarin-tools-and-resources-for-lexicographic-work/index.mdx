...
This course requires basic knowledge of Lexicography, which can be acquired from the <Link link={{"discriminant":"resources-hosted","value":"introduction-to-dictionaries"}}>Introduction to Dictionaries</Link> and the <Link link={{"discriminant":"resources-hosted","value":"introduction-to-corpus-based-lexicographic-practice"}}>Introduction to Corpus-Based Lexicographic Practice</Link> courses. In addition to this, we recommend doing the course <Link link={{"discriminant":"resources-hosted","value":"modeling-dictionaries-in-ontolex-lemon"}}>Modeling Dictionaries in OntoLex-Lemon</Link> before starting Part 2 of this course. If you are interested in learning more about the topics of Part 1 of this course, we suggest continuing with <Link link={{"discriminant":"resources-hosted","value":"lexicography-in-the-age-of-open-data"}}>Lexicography in the Age of Open Data</Link> and <Link link={{"discriminant":"resources-hosted","value":"standards-for-representing-lexicographic-data-an-overview"}}>Standards for Representing Lexical Data: An Overview</Link>.
