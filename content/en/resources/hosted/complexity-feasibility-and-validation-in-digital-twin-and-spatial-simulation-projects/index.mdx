  ...
  <QuizChoice variant="single" buttonLabel="Check answer">
    ...
    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        A. The project will no longer meet the technical specifications.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      <QuizChoiceAnswerLabel>
        B. The project may lose sight of its original objective as complexity and scope increase.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        C. The simulation will become technically inaccurate.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        D. Human validation will no longer be necessary.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>
  </QuizChoice>
</Quiz>
