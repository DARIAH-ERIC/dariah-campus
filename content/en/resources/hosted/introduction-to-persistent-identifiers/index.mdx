...
<VideoCard provider="youtube" id="R1Ki4T-xDIQ" title="Introduction to Persistent Identifiers" src="/assets/content/assets/en/resources/hosted/introduction-to-persistent-identifiers/tibor-thumbnail.png" subtitle="Click here to view" />
