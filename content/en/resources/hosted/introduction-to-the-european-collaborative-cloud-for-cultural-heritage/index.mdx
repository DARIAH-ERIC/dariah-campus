...
<Disclosure title="Supplementary reading">
...
<Callout kind="tip" title="Activity: pause and reflect">
...
<Disclosure title="Supplementary reading">
  ...
  2. **Britannica** [ ](https://www.britannica.com/technology/digital-twin)— [Digital twin: Definition, History, Types & Facts ](https://www.britannica.com/technology/digital-twin)A good encyclopedic entry that covers history, types, and uses in plain language, a solid general reference.
  ...
  4. **ACM Computing Surveys (2024/2025)** — *Digital Twins for Cultural Heritage: A Systematic Analysis of the State of the Art* [https://dl.acm.org/doi/10.1145/3793541](https://dl.acm.org/doi/10.1145/3793541). A comprehensive survey of 108 studies (2002–2025) that organises the field around three dimensions: user-facing applications, enabling technologies, and maturity levels. It also introduces a clear conceptual framework that distinguishes a basic digital replica from a true dynamic digital twin, useful for anyone seeking a rigorous definition grounded in the heritage domain.
...
<Callout kind="tip" title="Activity: Map your institution's collaborative potential">
...
<Callout kind="tip" title="Activity: practical use case">
