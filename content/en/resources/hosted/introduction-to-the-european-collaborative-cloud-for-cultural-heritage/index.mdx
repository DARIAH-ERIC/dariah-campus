...
<Disclosure title="European Commission and EU programmes">
  The European Commission sets the overall direction of the Cultural Heritage Cloud and provides funding primarily through programmes such as Horizon Europe. These programmes support both the development of the Cloud’s infrastructure and the tools and services built on top of it.body
</Disclosure>

<Disclosure title="ECHOES Sonsortium">
...
<Disclosure title="European Research Infrastructures">
...
<Disclosure title="ECHOES Sister Projects">
...
<Disclosure title="ECHOES Cascading Grant Recipients">
...
<Disclosure title="CH Institutions and Communities">
...
<Callout kind="none" title="Test embed quiz in callout">
  <Quiz>
...
<Callout kind="note" title="Activity: Reflecting on Your Own Data Practices">
...
<Callout kind="tip" title="Activity: Reflecting on Your Own Data Practices">
  Think about your own work (or a cultural heritage institution you are familiar with). You don’t have to answer all of these questions, but feel free to use them to guide your thinking:
...
### **Activity: Reflecting on Your Own Data Practices**
...
### **Activity: Map Your** Institution's Collaborative Potential

This activity invites you to reflect on how collaboration currently works in your institution, and how it could be improved through shared tools and infrastructure. You do not need to answer every question in detail - use the prompts below to guide your thinking.
...
### **Activity: Reflecting on Open Science**
...
**Activity 2: Your own practical use case**&#x20;
...
Claire prepares and structures her collection using tools provided by the Cloud. Instead of working in isolated spreadsheets or local databases, she works within an environment that interacts directly with the Cloud’s **Knowledge Base** and [**Knowledge Graph**](https://vocabs.ilc4clarin.ilc.cnr.it/skosmos/echoes_glossary/en/page/knowledge_graph) –  the core components that support the structuring, linking, and integration of data across the infrastructure.
