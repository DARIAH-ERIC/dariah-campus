...
```
<script>(function(w,d,s,u,f,m,n,o){o='https://survey.zohopublic.eu';w[f]=w[f]||function(){(w[f].p=w[f].p||[]).push(arguments);};m=d.createElement(s),n=d.getElementsByTagName(s)[0];m.async=1;m.src=o+u;n.parentNode.insertBefore(m,n);zs_intercept(o,'Y4ByPM',{});})(window, document, 'script', '/api/v1/public/livesurveys/Y4ByPM/popup/script', 'zs_intercept');</script>
