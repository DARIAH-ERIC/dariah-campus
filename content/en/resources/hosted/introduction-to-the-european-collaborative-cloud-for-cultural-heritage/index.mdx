...
<Disclosure title="ECHOES Consortium">
  The [ECHOES consortium](https://www.echoes-eccch.eu/) is responsible for building the foundations of the Cultural Heritage Cloud. It brings together research institutions, infrastructure providers, and heritage networks, representing a wide range of professional communities, including conservators, archivists, curators, librarians, researchers, and digital heritage specialists, whose expertise and needs are central to the Cloud’s development.
...
<Disclosure title="ECHOES Sister Projects">
  ...
  You can read more about the first round of funded sister projects [here](https://www.echoes-eccch.eu/community/).
</Disclosure>
...
<Disclosure title="ECHOES Cascading Grant Recipients">
  ...
  The grants are distributed through three calls addressing different aspects of the Cloud’s development: the [first call](https://www.echoes-eccch.eu/first-call-awards/) focused on data, and will fund 12 projects with €60,000 per project, designed to encourage stakeholders in the Cultural Heritage Community to contribute datasets for use in the ECCCH. The [second call](https://www.echoes-eccch.eu/second-call/) focused on engagement and collaboration. It funded 20 projects involving both tangible and intangible heritage, with the goals of increasing awareness of the ECCCH and strengthening skills and capacity-building activities across the sector. 
...
<Callout kind="tip" title="Activity: Map your institution's collaborative potential">
  ...
  1. **Identify your workflows**. What kind of digital activities are part of your work?

  * digitisation
  * metadata preparation (cleaning, mapping, enrichment, etc.
  * data ingestion
  * transcription
  * data reuse
  * …

  2. **Identify collaborators.** For each workflow, consider who contributes:

  * within your organisation, project, or practice;
  * beyond it (e.g. researchers, students, partner institutions, independent professionals, community groups, volunteers).

  3. **Consider machine support.** Where could tools or automation help?

  * automatic text recognition
  * metadata validation
  * linking to vocabularies or external authority files
  * identifying patterns or similarities

  4. &#x20;**Identify challenges.** Where does collaboration become difficult?
  ...
  * technical incompatibilities
  ...
  5. **Imagine improvements.** Think about how your current way of working could change:

  * Which part of your workflow would benefit most from being shared or connected with others?
  * Where do you currently duplicate work that could be reduced through shared infrastructure?
  * What would become easier if your data, tools, and collaborators were better connected?
</Callout>
...
<Callout kind="important" title="How this looks in practice">
  A small regional archive digitises a collection of 19th-century migration records.&#x20;

  Previously, the documents were only discoverable through an internal spreadsheet and a paper record accessible on-site. When preparing the dataset for publication, the archive assigns each record a persistent identifier, adds rich metadata (including names, dates, places and document types), and registers the dataset in a searchable national heritage portal.&#x20;

  As a result, a researcher studying migration patterns across Europe can now discover the collection through a keyword search, even without knowing the archive existed beforehand.
</Callout>
...
<Callout kind="tip" title="Activity: practical use case">
  ...
  Complete the following sentence: *In my context, Open Science or FAIR principles could help me by…*
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-the-european-collaborative-cloud-for-cultural-heritage/screenshot-2026-05-25-at-18.57.50.png" alt="Workflow diagram showing how a research data scientist searches across collections, combine relevant sources, and build a coherent research dataset that follows FAIR principles, without navigating separate systems or manually aligning format" alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-the-european-collaborative-cloud-for-cultural-heritage/screenshot-2026-05-25-at-19.19.53.png" alt="Research workflow diagram showing how a Domain/Subject specialist uses the cloud to document a fragile archaeological artefact and has created a high-resolution 3D model of it. She wants to annotate the model with her observations and treatment plans, so that her conservation work is clearly documented, shareable with colleagues, and connected to the object's digital twin." alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-the-european-collaborative-cloud-for-cultural-heritage/screenshot-2026-05-25-at-19.17.32.png" alt="Research workflow diagram showing how an early career explorer uses the cloud for his work: he wants to transform the manuscripts into structured, searchable text while preserving the source material and ensuring that his work follows FAIR principles" alignment="stretch">
...
<Callout kind="important" title="Satisfaction Survey">
  Please help us by taking 3 minutes to fill in [this satisfaction survey.](https://survey.zohopublic.eu/zs/Y4ByPM) Your input allows us to get insight in the overall satisfaction with this course and identify opportunities to improve this training course.
</Callout>
