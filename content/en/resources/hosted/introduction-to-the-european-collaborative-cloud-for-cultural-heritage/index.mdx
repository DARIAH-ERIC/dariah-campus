...
doi: https://hdl.handle.net/21.11159/019e6486-10f8-774b-a18c-83d8ad7ca37a
---
## **Learning goals**
...
#### **User Story 3: Working with 3D models**

**Persona:** Dr. Elena Novak - Domain/Subject Specialist
**Role:** Conservator-restorer specialising in archaeological artefacts
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-the-european-collaborative-cloud-for-cultural-heritage/screenshot-2026-05-25-at-19.19.53.png" alignment="stretch">
...
#### **User Story 4: Demonstrating Vertical Transcription Lab**
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-the-european-collaborative-cloud-for-cultural-heritage/screenshot-2026-05-25-at-19.17.32.png" alignment="stretch">
...
<Quiz>
  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      1. What problem does the Single Entry Point solve?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      a. It stores all data in a central repository
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      b. It allows users to log in once and access multiple services
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      c. It translates metadata between formats
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      d. It controls how data is annotated
    </QuizChoiceAnswer>
  </QuizChoice>
</Quiz>
...
<Quiz>
  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      2. What is the role of a metadata broker in the Cloud?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      a. To standardise how metadata is displayed to users
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      b. To translate between different metadata formats so data can be connected
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      c. To store datasets permanently
    </QuizChoiceAnswer>
...
<Quiz>
  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      3. What does federation mean in the context of the Cloud?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="correct">
      a. Institutions keep control of their data while connecting it to a shared environment
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      b. All data is stored in a single central database
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      c. Users can only access data within their own institution
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      d. Data is aggregated into a shared system while institutions maintain access to local copies
    </QuizChoiceAnswer>
  </QuizChoice>
</Quiz>
...
<Quiz>
  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      4. What does the Knowledge Graph enable in practice?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      a. Faster login for users
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      b. Translating metadata between different formats
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      c. The storage of large datasets
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      d. Revealing relationships between data across collections
    </QuizChoiceAnswer>
  </QuizChoice>
</Quiz>
...
<Quiz>
  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      5. What is a vertical application in the Cloud?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      a. A tool that replaces metadata standards
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      b. A specialised tool designed for a specific task, such as cataloguing or annotation
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      c. A tool that integrates multiple services into a single interface
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      d. A tool used to manage system infrastructure
    </QuizChoiceAnswer>
  </QuizChoice>
</Quiz>
...
<Quiz>
  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      6. What is the purpose of a private workspace?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      a. To make data publicly available
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      b. To replace institutional repositories
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      c. To allow users to work on data privately before sharing it
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      d. It defines how data is structured within a single system
    </QuizChoiceAnswer>
  </QuizChoice>
</Quiz>
...
<Quiz>
  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      7. What role does the Heritage Digital Twin Ontology (HDTO) play?
    </QuizChoiceQuestion>
    ...
    <QuizChoiceAnswer kind="incorrect">
      b. It stores copies of digital objects in multiple locations
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      c. It defines how data is visually displayed
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      d. It provides a shared conceptual framework for connecting data across collections
    </QuizChoiceAnswer>
  </QuizChoice>

  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      8. Anna wants to combine datasets from multiple institutions without downloading and manually reformatting them. What combination of components makes this possible?
    </QuizChoiceQuestion>
    ...
    <QuizChoiceAnswer kind="correct">
      b. Metadata broker + Knowledge Graph
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      c. SEP + private workspace
    </QuizChoiceAnswer>
  ...
  <QuizChoice variant="single">
    <QuizChoiceQuestion>
      9. What is the role of the API Gateway in the Cloud?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      a. To translate between metadata formats
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      b. To reveal relationships between datasets
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      c. To route queries and manage communication between systems
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      d. To move datasets from one repository to another
    </QuizChoiceAnswer>
  </QuizChoice>
</Quiz>
