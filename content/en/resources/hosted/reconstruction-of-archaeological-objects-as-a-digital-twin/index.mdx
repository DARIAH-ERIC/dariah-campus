...
sources:
  - artemis
featured-image: /assets/content/assets/en/resources/hosted/reconstruction-of-archaeological-objects-as-a-digital-twin/featured-image.png
license: cc-by-4.0
table-of-contents: true
summary:
  title: Reconstruction Of Archaeological Objects As A Digital Twin
  content: This resource aims to acquaint both DH experts and the general audience
    with the general idea, the workflows and advantages of transforming manual
    object reassembly and restoration into a digital twin.
content-type: training-module
translations: []
dariah-national-consortia: []
dariah-working-groups: []
doi: https://hdl.handle.net/21.11159/019e2b11-9ed3-77aa-96e5-9e8ce78999be
---
