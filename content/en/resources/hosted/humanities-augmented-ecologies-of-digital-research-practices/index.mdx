...
summary:
  content: >-
    ...
    the digital humanities and how the way in which we talk about research
    impacts upon the kind of things that we can do.
content-type: video
translations: []
...
<VideoCard provider="youtube" id="BhDB3IaLZNw" title="Humanities, Augmented: Ecologies of Digital Research Practices" subtitle="Click here to view" src="/assets/content/assets/en/resources/hosted/humanities-augmented-ecologies-of-digital-research-practices/ecologies-research.png" />
