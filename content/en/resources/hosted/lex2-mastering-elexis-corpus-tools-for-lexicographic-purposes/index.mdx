...
If you are new to corpus linguistics or using corpora in dictionary-making, you should first complete the ELEXIS Course <Link link={{"discriminant":"resources-hosted","value":"introduction-to-corpus-based-lexicographic-practice"}}>Introduction to Corpus-Based Lexicographic Practice</Link> here on DARIAH-Campus.
...
Prease refer to this course <Link link={{"discriminant":"resources-hosted","value":"introduction-to-corpus-based-lexicographic-practice"}}>Introduction to Corpus-Based Lexicographic Practice</Link>
...
Now that you know how to use a state-of-the-art tool for building and querying corpora, you may be interested in two additional ELEXIS courses here on DARIAH-Campus: <Link link={{"discriminant":"resources-hosted","value":"lexonomy-mastering-the-elexis-dictionary-writing-system"}}>Lexonomy: Mastering the ELEXIS Dictionary Writing System</Link> and <Link link={{"discriminant":"resources-hosted","value":"automating-the-process-of-dictionary-creation"}}>Automating the Process of Dictionary Creation</Link>
