...
More specifically, [RS's github implementation](https://github.com/athenarc/research-spotlight) provides a modular notebook-based process, organised into a sequence of Jupyter/Google Colab cells. This format allows the technical process to be divided into smaller, traceable steps, each corresponding to a specific operation performed on the input datasets. Each module follows a broadly similar structure: configuration of paths and dependencies, definition of the relevant functions, execution of the module on the input dataset, and, where useful, inspection or visualisation of the output.&#x20;
