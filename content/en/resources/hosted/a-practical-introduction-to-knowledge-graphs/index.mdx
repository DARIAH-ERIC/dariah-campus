...
Entity disambiguation systems are usualy ML or DL models trained to associate the extracted entity with the apporpriate link in a KB out of a set of generated candidates. This linking is done based on the context of the extracted entity such as the sentence, phrase or even paragraph that the entity was extracted from. Typically the steps for entity disambiguation (after the entity is extracted) are the following:&#x20;
...
* **Links to Knowledge Base:** Finally, it maps the text mention to that specific, unique entity in the knowledge base (e.g., mapping "Washington" to the U.S. capital entity)
