...
More specifically, [RS's github implementation](https://github.com/athenarc/research-spotlight) provides all the nessecary modules each following a three-cell architecture (with an optional 4 cell for visualization of the output) in a python jupiter notebook.&#x20;
