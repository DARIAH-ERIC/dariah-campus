...
4. declare structure among classes and thus inheritance of their attributes (e.g. every instance that belongs to a class inherits all the attributes of its superclass as well) and&#x20;
