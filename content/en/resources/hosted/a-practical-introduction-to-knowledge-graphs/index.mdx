...
We will declare our classes and relationships in RDF an RDFS data models using Python. For this purpose we can take advantage of the <Link link={{"discriminant":"external","value":"https://rdflib.readthedocs.io/en/stable/"}}>RDFLib</Link> python library&#x20;
