...
We will declare our classes and relationships in RDF an RDFS data models using the Python RDFLib package. The script for installing RDFLib and calling the appropriate functions can be seen as follows:
...
so_schema_file_name = './so_schema_sample.rdf'
