...
summary:
  title: abc
  content: >-
    This resource introduces learners to audio material segmentation,
    transcription, text annotation and dictionary creating using the tools ELAN
    and FLEx.
...
<Callout kind="note" title="Project background">
  The video resources were originally created as part of the EU-project RAQMYAT “Stratégies numériques pour la formation doctorale en sciences humaines et sociales en Tunisie” (610216-EPP-1-2019-1-FR-EPPKA2-CBHE-JP). RAQMYAT aims to strengthen the digital strategies in the humanities and social sciences in Tunesia, to foster innovative learning and teaching methods and support international collaborations. Further information is available on the project website: [https://www.raqmyatproject.eu/en/home-9/](https://www.raqmyatproject.eu/en/home-9/).
</Callout>
...
<Callout kind="tip" title="Task">
  * Download the file <Link link={{"discriminant":"download","value":"/assets/content/downloads/en/resources/hosted/introduction-to-elan/selma.wav"}}>Selma.wav </Link>
  * Download the file <Link link={{"discriminant":"download","value":"/assets/content/downloads/en/resources/hosted/introduction-to-elan/selma.mp4"}}>Selma.mp4</Link>
</Callout>
