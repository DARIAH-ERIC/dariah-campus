...
summary:
  title: Automatic Text Recognition (ATR) - Getting Started
  content: >-
    Kick off your journey into Automatic Text Recognition (ATR) with our
...
translations: []
doi: https://hdl.handle.net/21.11159/019595c4-2c08-710d-b6f0-819a6f6c5de5
---
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-1-getting-started/escriptorium.png" alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-1-getting-started/zone-gallicorpora-htr-15-bpt6k1057726c-edited.png" alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-1-getting-started/atrprediction.png" alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-1-getting-started/htrtraining.png" alignment="stretch">
  ATR Training Cycle
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-1-getting-started/atrerrortypes.png" alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/automatic-text-recognition-atr-video-1-getting-started/accuracylevel.png" alignment="stretch">
...
This module is part of a wider '[Automatic Text Recognition Made Easy' Curriculum](https://campus.dariah.eu/curricula/automatic-text-recognition-made-easy).  You may also wish to visit the next module in this curriculum, "[Automatic Text Recognition (ATR) - Where and How to Get Images](https://campus.dariah.eu/resources/external/automatic-text-recognition-atr-video-2-where-and-how-to-get-images)".
