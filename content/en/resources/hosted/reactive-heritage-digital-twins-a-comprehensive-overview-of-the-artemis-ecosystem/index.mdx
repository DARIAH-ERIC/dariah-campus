...
<Figure src="/assets/content/assets/en/resources/hosted/reactive-heritage-digital-twins-a-comprehensive-overview-of-the-artemis-ecosystem/screenshot-2026-08-11-154252.png" alt="The figure illustrates the transition from a Static Heritage Digital Twin, based mainly on manually updated historical and documentation data, to a Reactive Heritage Digital Twin. The reactive approach continuously connects the physical asset with its digital counterpart through sensing, data ingestion, analysis, decision-making, and action/visualisation." alignment="stretch">
...
<Quiz>
  <QuizImageDropZones src="/assets/content/assets/en/resources/hosted/reactive-heritage-digital-twins-a-comprehensive-overview-of-the-artemis-ecosystem/screenshot-2026-08-26-131945.png" alt="Matching exercise on the ARTEMIS microservices" distractors={[]} instantFeedback={false}>
    <QuizQuestion>
...
<Figure src="/assets/content/assets/en/resources/hosted/reactive-heritage-digital-twins-a-comprehensive-overview-of-the-artemis-ecosystem/artemis-3d.png" alt="Picture showing the ARTEMIS Smart Display Case" alignment="stretch">
  Smart Display Case
</Figure>
