---
title: "Reactive Heritage Digital Twins: A Comprehensive Overview of the ARTEMIS
  Ecosystem"
locale: en
...
summary:
  content: This learning resource introduces the concept of Reactive Heritage
    Digital Twins (RHDTs) and their role in addressing the dynamic challenges of
    cultural heritage preservation. It explores the transition from static to
    reactive digital twins, including key concepts, challenges, use cases, and
    enabling technologies. Using the ARTEMIS project as a practical example,
    learners will gain insights into the architecture, services, and real-world
    implementation of RHDTs for monitoring, analysing, and protecting cultural
    heritage assets.
content-type: training-module
translations: []
dariah-national-consortia: []
dariah-working-groups: []
doi: https://hdl.handle.net/21.11159/01a0aa74-4ac0-7666-8d76-f6d349c7a051
---
...
<Figure src="/assets/content/assets/en/resources/hosted/reactive-heritage-digital-twins-a-comprehensive-overview-of-the-artemis-ecosystem/screenshot-2026-08-11-153906.png" alt="There are four main categories of risks to cultural heritage: environmental fluctuations (humidity, temperature, light), material degradation (ageing, fatigue, biological processes), structural and human risks (shocks, vibration, tampering, disasters), and exceptional events such as extreme weather." alignment="stretch">
  Cultural Heritage Challenges
</Figure>
...
<Callout kind="important">
  **The aim of the project is to move from reactive restoration after damage towards data-supported prevention before damage.**
</Callout>
...
<Figure src="/assets/content/assets/en/resources/hosted/reactive-heritage-digital-twins-a-comprehensive-overview-of-the-artemis-ecosystem/screenshot-2026-08-11-154252.png" alt="The transition from a Static Heritage Digital Twin to a Reactive Digital Heritage Twin is mainly based on manually updated historical and documentation data. The reactive approach continuously connects the physical asset with its digital counterpart through sensing, data ingestion, analysis, decision-making, and action/visualisation." alignment="stretch">
...
<Quiz>
  <QuizImageDropZones src="/assets/content/assets/en/resources/hosted/reactive-heritage-digital-twins-a-comprehensive-overview-of-the-artemis-ecosystem/screenshot-2026-08-26-131945.png" alt="The different elements that feed into ARTEMIS RHDT: IoCT, simulation, AR/VR and semantic KB" distractors={[]} instantFeedback={false}>
    <QuizQuestion>
...
<Quiz>
  <QuizChoice variant="single" buttonLabel="Check answer">
    <QuizChoiceQuestion>
      What is the main function of orchestration in the ARTEMIS ecosystem?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        To replace individual microservices with a single monolithic application.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        To eliminate the need for standardised APIs.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      <QuizChoiceAnswerLabel>
        To coordinate services into defined sequences to create complete RHDT workflows.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        To manage only the AR/VR visualisation components.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>
...
<Quiz>
  <QuizChoice variant="single" buttonLabel="Check answer">
    <QuizChoiceQuestion>
      The ARTEMIS services are organised into four main domains. Which combination is correct?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        Database, Frontend, Backend, Mobile
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      <QuizChoiceAnswerLabel>
        IoCT, Simulation, AR/VR, Cataloguing
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        Sensors, Actuators, Cameras, GPS
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        Analytics, Reporting, Visualisation, Storage
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>
...
<Figure src="/assets/content/assets/en/resources/hosted/reactive-heritage-digital-twins-a-comprehensive-overview-of-the-artemis-ecosystem/artemis-3d.png" alt="A tall display case, the bottom part made from sturdy material with a glass casing in the upper half.The ARTEMIS Smart Display Case contains an ancient book, dimly lit." alignment="stretch">
  Smart Display Case
</Figure>
...
<Callout kind="important">
  **The RHDT closes the loop between physical change, digital data, analysis, decision-making, and physical response.**
</Callout>

<Quiz>
  <QuizChoice variant="single" buttonLabel="Check answer">
    <QuizChoiceQuestion>
      Which situation best describes the “Physical-Digital Loop” of an RHDT?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        A 3D model is created and then permanently stored.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        Sensor data is collected but not further processed.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      <QuizChoiceAnswerLabel>
        A change in the physical environment is detected by sensors, digitally analysed, and can trigger a response in the physical environment.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        A cultural heritage object is viewed exclusively in a VR environment.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>
...
<Quiz>
  <QuizChoice variant="single" buttonLabel="Check answer">
    <QuizChoiceQuestion>
      How is the RHDT used in the case of the Pigmeos Mosaic at Itálica?
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="correct">
      <QuizChoiceAnswerLabel>
        To visualise real-time IoT data overlaid on the 3D model within a collaborative VR environment for joint risk assessment.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        Only to create a digital copy of the artwork for archival purposes.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        Exclusively to document the current state of the mosaic.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      <QuizChoiceAnswerLabel>
        To physically replace the original mosaic with a digital reconstruction.
      </QuizChoiceAnswerLabel>
    </QuizChoiceAnswer>
