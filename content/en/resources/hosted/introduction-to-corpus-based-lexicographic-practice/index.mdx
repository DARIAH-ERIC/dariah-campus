...
doi: https://hdl.handle.net/21.11159/019595c5-1bfc-72ae-a4bf-b9c8dcca0d01
---
...
This course provides the theoretical background to using corpora in lexicographic practice. If you are interested in getting hands-on experience, we suggest continuing with the course <Link link={{"discriminant":"resources-hosted","value":{"id":"lex2-mastering-elexis-corpus-tools-for-lexicographic-purposes"}}}>LEX2: Mastering ELEXIS Corpus Tools for Lexicographic Purposes</Link>.
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/int-slips.png">
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/ac.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/cb.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/ab.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/df.png)

##### Syntactic annotation

Syntactic annotation provides information about the grammatical structure of sentences. This is also called parsing. Two types of parsers can be distinguished, those annotating constituent structures and those annotating dependencies (Figure taken from Jurafsky et al. 2021, Chapter 14, p.2). Syntactically annotated corpora are called treebanks as syntactic structures are commonly visualised in the form of trees.

![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/dc.png)

For a more computational description of dependency and constituency parsing, see Chapters 13 and 14 from [Jurafksy et al. 2021](https://web.stanford.edu/~jurafsky/slp3/).
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/bc.png">
  A sample UD annotation for English
</Figure>
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/cd.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/de.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/dg.png)
...
Corpora can also help to identify the different senses of a polysemous word. For instance, by looking at the concordances (i.e. ...) of the noun party in the example below, we see occurrences of the different senses of the noun party, i.e. party in the sense of political party, but also in the sense of a social event.

![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/da.png)

These different senses can also be observed when looking at the word sketch of party:

![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/aa.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/ba.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/bb.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/dh.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/ad.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/db.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/ca.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/dd.png)
