---
title: From immersive storytelling to experimentation in a multiscale modelling
  approach
locale: en
...
sources:
  - artemis
featured-image: /assets/content/assets/en/resources/hosted/from-immersive-storytelling-to-experimentation-in-a-multiscale-modelling-approach/featured-image.png
license: cc-by-4.0
table-of-contents: true
summary:
  title: From immersive storytelling to experimentation in a multiscale modelling
    approach
  content: This resource focuses on immersive environments and multi-scale digital
