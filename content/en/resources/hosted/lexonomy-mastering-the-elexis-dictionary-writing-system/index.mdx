...
doi: https://hdl.handle.net/21.11159/019595c5-1e71-73fb-822e-3a13cce530ed
---
...
Congratulations, you have now arrived at the end of this course! If you are looking to expand your skills, you could consider moving on to the next course in the ELEXIS curriculum entitled <Link link={{"discriminant":"resources-hosted","value":{"id":"automating-the-process-of-dictionary-creation"}}}>Automating the Process of Dictionary Creation</Link>. It builds on the material covered in this course and in <Link link={{"discriminant":"resources-hosted","value":{"id":"lex2-mastering-elexis-corpus-tools-for-lexicographic-purposes"}}}>LEX2: Mastering ELEXIS Corpus Tools for Lexicographic Purposes</Link> that taught you how to create a corpus in Sketch Engine.
