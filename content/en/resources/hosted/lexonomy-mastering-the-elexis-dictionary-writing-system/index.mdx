...
Congratulations, you have now arrived at the end of this course! If you are looking to expand your skills, you could consider moving on to the next course in the ELEXIS curriculum entitled <Link link={{"discriminant":"resources-hosted","value":{"id":"automating-the-process-of-dictionary-creation"}}}>Automating the Process of Dictionary Creation</Link>. It builds on the material covered in this course and in <Link link={{"discriminant":"resources-hosted","value":{"id":"mastering-oxygen-xml-editor-for-dictionary-nerds"}}}>LEX2: Mastering ELEXIS Corpus Tools for Lexicographic Purposes</Link> that taught you how to create a corpus in Sketch Engine.
