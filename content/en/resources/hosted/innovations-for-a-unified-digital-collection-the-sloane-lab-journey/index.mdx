...
<VideoCard provider="youtube" id="https://youtu.be/MtxzC90bhq0" title="Innovations for a Unified Digital Collection - The Sloane Lab Journey" src="/assets/content/assets/en/resources/hosted/innovations-for-a-unified-digital-collection-the-sloane-lab-journey/sloane-lab-thumbnail.png" subtitle="Click here to view" />
