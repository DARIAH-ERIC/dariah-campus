---
title: "Retrieving Context, Re-centring Interpretation: AI Hermeneutics and the
...
summary:
  content: In digital humanities, retrieval technologies have always mediated how
    we read, from concordances to search engines. This talk introduces AI
    hermeneutics, an approach that treats retrieval-augmented generation (RAG)
    not as automation but as interpretive infrastructure, opening up an
    opportunity to integrate AI into the existing reading experience.
content-type: webinar-recording
translations: []
dariah-national-consortia: []
doi: https://hdl.handle.net/21.11159/019bbda8-86a1-738e-9e8a-7d7a15b159fb
---
