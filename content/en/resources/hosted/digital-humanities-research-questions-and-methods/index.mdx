...
sources:
  - parthenos
featured-image: >-
  /assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/featured-image.jpg
license: cc-by-4.0
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-1-figure1-neu.png" alt="Scanned image of Stenography Protocols in German language" alignment="stretch">
  Figure 1. Proceedings of the Austrian parliament in PDF.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-2-fig2.png" alt="Scan of a document in Danish language." alignment="stretch">
  Figure 2. Proceedings of the Danish parliament in HTML.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-3-figure3-neu.png" alt="Document in XML format." alignment="stretch">
  Figure 3. Proceedings of the German parliament in XML.
</Figure>

#### Structural Elements

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-4-figure4-neu.png" alignment="right-one-fourth">
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-5-figure5-neu.png" alignment="stretch">
  Figure 5. Political Mashup, formal XML schema for parliamentary proceedings.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-6-figure6-neu.png" alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-7-figure7-neu.png" alt="A bar chart based on quantifiable data from metadata." alignment="stretch">
  Figure 7. Text production in the German parliament over time by political party.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-8-figure8-neu.png" alt="A bar chart." alignment="stretch">
  Figure 8. Most characteristic nouns specific to a given parliamentary group in the French parliament.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-9-figure9-neu.png" alt="A table showing the distribution of female MPs vs the number of speeches given by female MPs." alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-10-figure10-neu.png" alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-11-figure11-neu.png" alt="A diagram showing how a single document refers to members and locations of UK Parliament." alignment="stretch">
  Figure 11. Illustration of the named entity recognition and linking in the UK parliamentary proceedings.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-12-figure12-neu.png" alt="Excerpts from Parliamentary proceedings." alignment="stretch">
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-13-figure13-neu.png" alt="Data Collection > Data Preparation > Preprocessing > Organisation > Topic Modelling > Visualisation." alignment="stretch">
...
<Video provider="youtube" id="JBPhqJWLSYw">
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-29-figure-14-clarin-postcard-parliamentary.jpg" alt="CLARIN Resource Families — Parliamentary Corpora infographic.  Left panel:  CLARIN RESOURCE FAMILIES  Parliamentary corpora are a very important multidisciplinary language resource that can be approached from many research perspectives, including not only political science, but also sociology, history, psychology, and applicative approaches to linguistics, for instance, critical discourse analysis. The good availability of parliamentary proceedings in digitized form and granted access rights to public information in the EU countries have motivated a number of national as well as international initiatives to compile, process and analyse parliamentary corpora.  www.clarin.eu/resource-families  Right panel (circular infographic):  [QR code] PARLIAMENTARY CORPORA  18 parliamentary corpora  1 MULTILINGUAL: Europarl (21 languages)  17 MONOLINGUAL IN 14 LANGUAGES:  1 Czech 1 Danish 2 English 1 French 1 Estonian 1 Finnish 3 German 1 Greek 1 Lithuanian 2 Norwegian 1 Polish 1 Portuguese 1 Slovenian 1 Swedish  AVAILABILITY  3 through a concordancer 9 for download 4 both  SIZE  7 small (<10 million tokens) 7 medium (10–100 million tokens) 3 large (>100 million tokens)  ANNOTATION  8 PoS-tagged 7 lemmatised" alignment="stretch">
  Figure 14 - Infographic of the Parliamentary Corpora from the CLARIN Resource Families.
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-14-figure14-neu.png" alignment="stretch">
  Figure 15. Description of the Hansard corpus in the CLARIN resource families with hyperlinks to the concordance, tools used to annotate the corpus and the key publication about how the corpus was built.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-15-figure15-neu.png" alignment="stretch">
  Figure 16. The concordancer for the Hansard corpus.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-16-figure16-neu.png" alignment="stretch">
  Figure 17. Frequency list for \*ism.
</Figure>

Since Hansard is a large diachronic corpus, it is especially suitable for researching how the usage of specific words changed through time in the context of the British parliament. As can be seen in Figure 17, the second most frequent word is terrorism. Let’s say that we want to investigate this word diachronically, using the chart option which sorts all the occurrences of the word either by decade (the default option) or speaker. The chart in Figure 18 shows that the word terrorism has been used in the British parliament since the first half of the 19th century, although it was very infrequent then (for instance, there were 7 uses of the word in the 1850s). The frequency of the word rose dramatically in the 1970s (4846 times compared to 363 instances in the 1960s).

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-17-figure17-neu.png" alignment="stretch">
  Figure 18. Diachronic chart for terrorism.
</Figure>

Clicking on one of the columns displays the concordances, which show how the word was used in context. Figure 19 shows the first 12 results for the 1970s.

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-18-figure18-neu.png" alignment="stretch">
  Figure 19. Concordances for terrorism.
</Figure>

Each line is an excerpt of a speech delivered in the British parliament in which the word terrorism was used. The metadata for this entry can be displayed by clicking the MORE CONTEXT tab. Figure 20 shows the metadata for concordance line 6: Orr (C), and allows us to see a substantially more expanded context for the example, including information on the speaker (Mr\_Lawrence\_Orr), the date (1971\_02\_15), and the topic of the debate (northern\_ireland\_hansard\_15\_february\_1971\_).

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-19-figure19-neu.png" alignment="stretch">
  Figure 20. Metadata for one of the concordance lines in the corpus.
</Figure>

### Further Learning and Image Credits for the 'Collections of Parliamentary records' section&#x20;
...
<Disclosure title="Click to Expand">
  ...
  * Figures 15-20 are screenshots from the [Hansard corpus in the CoCa concordancer](https://www.hansard-corpus.org/x.asp).
</Disclosure>
...
<Grid layout="two-columns" alignment="stretch">
  <GridItem alignment="stretch">
    <Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrg-20-cmc-figure-1a.png" alt="A tweet" alignment="stretch">
      Figure 21a. Original tweet&#x20;
    </Figure>
  </GridItem>

  <GridItem alignment="stretch">
    <Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-21-cmc-figure-2c.png" alt="The tweet in JSON format." alignment="stretch">
      Figure 21b. Tweet in JSON format as obtained from the Twitter streaming API&#x20;
    </Figure>
  </GridItem>
</Grid>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-22-working-with-social-media-corpora-3-1024x318.jpg" alt="A wikipedia entry in Slovenian." alignment="stretch">
  Figure 22a. Original Wikipedia Talk Page.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-23-figure-2b.png" alt="The same wikipedia page from fig. 22 in XML format." alignment="stretch">
  Figure 22b. Example of an original Wikipedia Talk Page and the same page in XML.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-24-figure-3a-1024x799.png" alt="Screengrab of a blog post." alignment="stretch">
  Figure 23a. Original blog post
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-22b-figure-3b-1024x186.png" alt="HTML of text from blog post in Fig 22a." alignment="stretch">
  Figure 23b. Blog post in html&#x20;
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-23-figure7.png" alignment="stretch">
  Figure 24. Two different coding languages for the same social media post.
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-24-figur8.png" alignment="stretch">
  Figure 25. Analysis of the onset of tweeting activity during the week (blue), on Saturday (black) and Sunday (red) of German Twitter users. Vertical dashed lines marks the transition from/to the Daylight Saving Time. Dawn is shown in the grey-white transition
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-25-figure9.png" alt="A colour-coded map showing the Nordic countries." alignment="stretch">
  Figure 26. Percentage of gendered tweets according to users’ names posted in English in the Nordic countries
</Figure>

#### Linguistic Annotations and Text Enrichment

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-26-figure.png" alt="An example of XML, specifically following the TEI (Text Encoding Initiative) schema conventions used for linguistic/corpus annotation." alignment="stretch">
  Figure 27. Excerpt of XML specifically following the TEI (Text Encoding Initiative) schema conventions used for linguistic/corpus annotation.
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-27-figure11.png" alt="An annotated sentence.  The sentence reads &#x22;DigitalGlobe is a compnay with headquarters in Westminster, Colorado.  Our President is Dan Jablonsky.&#x22;  The word 'DigitalGlobe' is annotated as an organisation.  'Westminster, Colorado' is annotated as a 'Location'.  'Dan Jablonsky' is annotated as a 'Person'." alignment="stretch">
  Figure 28. Illustration of named entity recognition in social media corpora.
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-28-figure12.png" alt="&#x22;Sentiment analysis is the task of identifying positive and negative opinions, emotions and evaluations in text&#x22;.  There are three statements, each given an indication of positive, neutral or negative.  Sentence 1 &#x22;The main dish was delicious&#x22; = positive.  Sentence 2 &#x22;It is a Syrian dish' = neutral.  &#x22;The main dish was salty and horrible&#x22; = negative." alignment="stretch">
  Figure 29. Illustration of sentiment analysis in social media corpora.
</Figure>

### Further Learning and Image Credits for 'Working with Social Media Corpora' section
...
<Disclosure title="Click to expand">
  ...
  * Figure 21a is taken from [https://twitter.com/PostGradProblem](https://twitter.com/PostGradProblem).
  * Figure 21b is taken from [https://gist.github.com/hrp/900964](https://gist.github.com/hrp/900964).
  * Figures 22 a & b are taken from [https://dumps.wikimedia.org](https://dumps.wikimedia.org) with [https://github.com/nljubesi/wikitalk-extractor](https://github.com/nljubesi/wikitalk-extractor).
  * Figures 23 is taken from [http://www.shakesville.com/2018/11/mo-salah-just-got-jammed.html](http://www.shakesville.com/2018/11/mo-salah-just-got-jammed.html).
  * Figure 24 is taken from [http://www.chatkorpus.tu-dortmund.de/tei/tei\_CMC\_CHATCORPUS2CLARIN\_SHORT.html#TEI.post](http://www.chatkorpus.tu-dortmund.de/tei/tei_CMC_CHATCORPUS2CLARIN_SHORT.html#TEI.post).
  * Figure 25 is taken from Scheffler et al. (2016). In: [Proceedings of the Tenth International AAAI Conference on Web and Social Media (ICWSM 2016)](https://www.aaai.org/ocs/index.php/ICWSM/ICWSM16/paper/view/13080/12826) \[link to PDF], Figure 4 page 677.
  * Figure 26 is taken from Coats et al. (2017). In: [Investigating Computer-Mediated Communication: Corpus-based Approaches to Language in the Digital World](http://www.ff.uni-lj.si/sites/default/files/Dokumenti/Knjige/e-books/investigating.pdf) \[link to PDF], Figure 1 page 109.
  * Figure 27 is taken from Fišer, Ljubešić, & Erjavec (2018). Lang Resources & Evaluation. [https://doi.org/10.1007/s10579-018-9425-z](https://doi.org/10.1007/s10579-018-9425-z).
  * Figure 28 is taken from [http://blog.digitalglobe.com/developers/named-entity-recognition-for-twitter/](http://blog.digitalglobe.com/developers/named-entity-recognition-for-twitter/).
  * Figure 29 is taken from [https://www.slideshare.net/Staano/evaluation-datasets-for-twitter-sentiment-analysis-a-survey-and-a-new-dataset-the-stsgold](https://www.slideshare.net/Staano/evaluation-datasets-for-twitter-sentiment-analysis-a-survey-and-a-new-dataset-the-stsgold).
</Disclosure>

## Boosting Digital Humanities Research with Computer-Mediated Communication (CMC) data

### Introducing Computer-Mediated Communication as Data
...
<Callout kind="tip" title="Watch!">
  Watch this [video of Andrew Salway on “Creating and Using Topically-Focused Blog Corpora”](http://videolectures.net/clarinplusworkshop2017_salway_blog_corpora/) (link takes you to external site).
</Callout>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-30-clarin-postcard-cmc.jpg" alt="CLARIN Resource Families — CMC Corpora infographic.  Left panel:  CLARIN RESOURCE FAMILIES  Computer-mediated communication (CMC) constitutes public and private communication on-line, such as posts on blogs, forums, comments on online news sites, social media and networking sites such as Twitter and Facebook, instant chat rooms, mobile phone applications such as WhatsApp and e-mail. Because corpora that compile CMC often include very informal styles of writing, they are interesting for a wide range of research fields, such as language variation, pragmatics, media and communication studies, etc.  www.clarin.eu/resource-families  Right panel (circular infographic):  [QR code] CMC CORPORA  12 CMC corpora  8 LANGUAGES: 1 Czech, 1 Dutch, 1 Estonian, 1 Finnish, 1 French, 1 German, 1 Lithuanian, 5 Slovenian  AVAILABILITY: 1 through a concordancer, 4 for download, 7 both  SIZE: 4 small (<10 million tokens), 6 medium (10–100 million tokens), 2 large (>100 million tokens)  ANNOTATION: 8 PoS-tagged, 6 lemmatised, 5 word-normalised" alignment="stretch">
  Figure 30 - Infographic of the 'CMC Corpora' content in the CLARIN Resource Families
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-31-figure-13.png" alignment="stretch">
  Figure 31: Description of Twitter corpus Janes – Tweet 1.0 in the CLARIN resource families with hyperlinks to the concordancer and the CLARIN.SI Repository, from which the corpus can be downloaded.
</Figure>

*KonText* is a powerful concordancer with an easy-to-use interface which supports different types of queries, as shown in Figure 32.

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-32-figure-14.png" alignment="stretch">
  Figure 32: Explanation of the supported types of queries in KonText with examples.
</Figure>

One of the most important characteristics of the Janes Tweet corpus is that it normalised, which means that all the words which deviate from the standard spelling have an assigned standard variant. This makes it possible to study all the variants of a word with a single query, which is shown in Figures 33–35.

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-33-figure-15.png" alignment="stretch">
  [Figure 33. Query for all the spelling variants of the personal pronoun jaz (Eng. “I”).](../../../../wp-content/uploads/2018/11/Figure-15.png)
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-34-figure-16.png" alignment="stretch">
  [Figure 34. Excerpt of the concordances for the spelling variants of the personal pronoun jaz (Eng. “I”) with absolute and normalised frequencies at the top and the available metadata on the left.](../../../../wp-content/uploads/2018/11/Figure-16.png)
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-35-figure-24-1.png" alignment="right-one-half">
  Figure 35. Frequency list of the lowercased spelling variants of the personal pronoun jaz (Eng. “I”)
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-36-figure-18.png" alignment="stretch">
  Figure 36. KonText offers an option to specify various contextual parameters of the Tweets you are interested in.
</Figure>
...
The metadata can be used to investigate the characteristics of the language used on social media. For example, we can investigate whether a certain word or phenomenon is more characteristic of non-standard language, specific to a certain type of user, or more prominent for messages with negative sentiment. We demonstrate this on the word *bizarka* (Eng. informal expression for something very unusual, quirk) in Figures 37-39.

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-37-figure-19.png" alignment="stretch">
  Figure 37. Concordances for the lemma *bizarka* (Eng. quirk) which have been sorted according to its right context. The results suggest that *bizarka dneva* (Eng. weird news of the day) is a frequent collocation.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-38-figure-20.png" alignment="stretch">
  Figure 38. Collocation candidates for the lemma *bizarka* (Eng. quirk) confirm the above finding and add the following strong candidates to the list: *zvezdniška bizarka* (Eng. celebrity quirk), *petkova bizarka* (Eng. Friday quirk), *(naj)večja bizarka* (Eng. bigger/the biggest quirk), *bizarka včerajšnjega dne* (Eng. yesterday’s quirk), t*otalna bizarka* (Eng. total quirk).
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-39-figure-21-1.png" alignment="stretch">
  Figure 39. Frequency lists of the lemma bizarka (Eng. quirk) according to the metadata show that the word is used almost exclusively by private users. It is predominantly used by female Twitter users, typically appears in tweets written in informal language and is slightly more characteristic of tweets with negative sentiment. The usage of the word in the five years covered in the corpus is stable, ranging from 3.03 to 3.36 instances per million.
</Figure>

In addition to regular parts of speech, the Janes Tweet corpus has special tags for emoticons and emojis (e.g. ;), , 💅), hashtags (e.g. #EuroBasket2013, #slo, #sampovem), mentions (e.g. @ErikaPlaninsec, @Simobil, @petrasovdat) and URLs (e.g. [XXX@siol.net](mailto:XXX@siol.net), quicklog.me, podarimalico.si). The tags are *Xe* for emoticons and emojis, *Xh* for hashtags, *Xa* for mentions and *Xw* for URLs so they too can be queried with CQL. This is demonstrated in Figures 40-42.

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-40-figure-22.png" alignment="stretch">
  Figure 40. Using CQL to search for emoticons and emoji. The regular expression \[tag\_en = “Xe”] returns all the tokens in the corpus which are tagged as Residual (X) and identified as emoticons or emoji (e). All the tags used in the corpus are documented in the Tagset summary.&#x20;
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-41-figure-23.png" alignment="stretch">
  Figure 41. The KWIC (“Keyword in Context”) view of the emoticons and emoji in the corpus.
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-42-figure-25-1.png" alignment="stretch">
  Figure 42. 20 most frequent emoticons and emojis in the corpus of Slovene tweets. The list can be accessed by clicking on the Frequency tab in the KWIC view in Figure 22. For an international study on emoji usage on Twitter, see Ljubešić and Fišer (2016a).
</Figure>

### Further Learning in 'Social Media Corpora in CLARIN Resource Families'
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-43-1-jaccuse-1024x649.png" alt="Scan of L'Aurore newspaper front page in the BnF Gallica interface.  The frontpage headline reads &#x22;J'Accuse...!  Lettre Au Président de la Republique par Émile Zola&#x22;" alignment="stretch">
  Figure 43 - Famous front page featuring Emile Zola's open letter
</Figure>
...
Some interfaces offer the option of frequency visualisation that can provide an overview of the distribution of results over time. The interface of the Royal Dutch Library, Delpher, has such a feature and is also noticeable because of the option to change absolute frequencies to relative frequencies. Choosing relative values displays the proportion of results compared to the entire digitised collection. See below the example of hits for “Titanic”, where the difference between relative and absolute is not too strong, indicating that a significant proportion of the newspapers that have been digitised covered the disaster in 1912.&#x20;

You can interact directly with the graph shown in Figs 44 and 45 here: [https://www.delpher.nl/nl/kranten/ngram?query=titanic\&coll=ddd](https://www.delpher.nl/nl/kranten/ngram?query=titanic\&coll=ddd)

<Grid layout="two-columns" alignment="stretch">
  <GridItem alignment="stretch">
    <Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-44-2-titanic-1024x685-absolute.png" alignment="stretch">
      Figure 44 - Delpher Timeline on Titanic - Absolute Frequency
    </Figure>
  </GridItem>

  <GridItem alignment="stretch">
    <Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-45-impresso-image-titanic-2-1-relative.jpg" alignment="stretch">
      Figure 45 - Depher Timeline on Titanic - Relative Frequency
    </Figure>
  </GridItem>
</Grid>

The query on “Eiffel Tower”, by contrast, shows that the proportion decreases when comparing the two peaks, even though the absolute values are more comparable.

You can interact directly with the graphs shown in Figs 46 and 47 by clicking here: [https://www.delpher.nl/nl/kranten/ngram?query=Eiffeltoren\&coll=ddd](https://www.delpher.nl/nl/kranten/ngram?query=Eiffeltoren\&coll=ddd)

<Grid layout="two-columns" alignment="stretch">
  <GridItem alignment="stretch">
    <Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-46-2-eiffeltower-1024x685-absolute.png" alignment="stretch">
      Figure 46 - Delpher Timeline on Eiffel Tower - Absolute Frequency
    </Figure>
  </GridItem>

  <GridItem alignment="stretch">
    <Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-47-impresso-image-eiffel-2-relative.jpg" alignment="stretch">
      Figure 47 - Delpher Timeline on Eiffel Tower - Relative Frequency
    </Figure>
  </GridItem>
</Grid>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-48-impresso-grouped-image-1024x285.jpg" alignment="stretch">
  Figure 48. Scans of newspapers from the ANNO interface with ripped out sections or pages.
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-49-4-script-kwhighlight-1024x550.png" alignment="stretch">
  Figure 49. Screengrab of a scanned newspaper in an interface
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-50-5-cdcn-toc-1024x651.png" alignment="stretch">
  Figure 50. The UCR Center for Bibliograhical Studies and Research Newspaper Collection Viewer
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-51-6-bnl-layout-titanic-1024x634.png" alignment="stretch">
  Figure 51. Screengrab of the Luxembourg National Library viewer
</Figure>

This same viewer displays the OCR that has been produced, alongside the scanned image:

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-52-7-bnl-ocr-titanic-1024x688.png" alignment="stretch">
  Figure 52. The Luxembourg National Library Viewer with OCR also displayed
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-53-8-enspch-navigation-1024x746.png" alignment="stretch">
  Figure 53. E-Newspaper Archives.ch viewer showing Frieberger Nachrichten 1962
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-54-9-delpger-warning-1024x651.png" alignment="stretch">
  Figure 54. Delpher 'Zoektip' popup
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-55-10-gallica-autofill-1024x651.png" alignment="stretch">
  Figure 55. BnF Gallica drop down menu
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-56-11-europeana-estoniatitles-1024x651.png" alignment="stretch">
  Figure 56. Some of the newspapers in the Europeana collections
</Figure>

Some interfaces inform users of the most recently added titles, such as ANNO:

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-57-12-anno-added-titles-1024x651.png" alignment="stretch">
  Figure 56. Listings of newspapers available on the ANNO platform
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-58-impresso-anno-screebgrab-1024x586.png" alignment="stretch">
  Figure 57. ANNO front page three days after the sinking of the Titanic
</Figure>

A few interfaces add tags to newspaper titles, such as ANNO:

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-59-13-anno-arbeit-1024x651.png" alignment="stretch">
  Figure 58. ANNO Arbeiter (49)
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-60-14-script-selection-tools-933x1024.png" alignment="stretch">
  Figure 59. Scriptorium interface
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/digital-humanities-research-questions-and-methods/dhrq-61-15-enspch-tags-933x1024.png" alignment="stretch">
  Figure 60. e-Newspaper Archives.ch interface offering option to correct the OCR or tag articles
</Figure>
