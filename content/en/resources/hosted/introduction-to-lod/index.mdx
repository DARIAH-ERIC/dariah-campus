...
summary:
  title: Introduction to Linked Open Data
  content: >-
    This resource provides an introduction to Linked Open Data and SPARQL. It
    explains how LOD is used to publish structured data on the web and basic
    concepts like RDF, ontologies and using URIs. Practical exercises using
    SPARQL queries and SPARQL endpoints in the SPARQL playground and the CLSCor
    Catalogue complete the course.
...
LOD allows for the creation of a web of interlinked data that facilitates new ways of browsing, querying, and discovering information. The result can be visualised and explored at [https://lod-cloud.net/](https://lod-cloud.net/):
...
<Callout kind="tip" title="Would you like to code along?">
  ...
  **RDF Input for our First Queries**

  ```turtle
  <http://example.org/William_Shakespeare> <http://example.org/is_author_of> <http://example.org/Hamlet> . <http://example.org/William_Shakespeare> <http://example.org/is_author_of> <http://example.org/Macbeth> . <http://example.org/Hamlet> <http://example.org/location> <http://example.org/Denmark> .
  ```
...
In this part of the course, you will get to practice your new skills on an actual data catalogue.
