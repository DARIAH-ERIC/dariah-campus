...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-lod/anatomy-of-a-query.svg" alt="Anatomy of a SPARQL query, including query prefixes, dataset definition and query modifiers" alignment="stretch">
...
<Callout kind="note" title="Side Note: A Practical Use Case for VALUES">
