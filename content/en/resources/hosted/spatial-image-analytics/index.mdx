...
<Figure src="/assets/content/assets/en/resources/hosted/spatial-image-analytics/bb0533d207cf4e404c806dda0f1b2bca8684ae93-36172.png" alt="" alignment="stretch" />
...
<Link link={{"discriminant":"external","value":"http://www.geonames.org/"}}>http://www.geonames.org/</Link>
...
<Link link={{"discriminant":"external","value":"http://www.geosetter.de/en/download/"}}>http://www.geosetter.de/en/download/</Link> has been developed for Windows Operating systems. To run Geosetter on an Apple Macintosh computer, the Mac must be set up to run Windows by following one of two installation options:

*Option 1* : Create a dual-boot setup on your Mac. This allows you to boot into either Mac OS or Windows OS. The usual way to do this is to use the free software BootCamp. Available at: <Link link={{"discriminant":"external","value":"http://www.apple.com/support/bootcamp/"}}>http://www.apple.com/support/bootcamp/</Link>
...
<Link link={{"discriminant":"external","value":"http://www.geosetter.de/en/download/"}}>http://www.geosetter.de/en/download/</Link>
...
Finally, go to **Internet** tab and change the URL address under Geonames to: <Link link={{"discriminant":"external","value":"http://www.geonames.org/"}}>http://www.geonames.org/</Link>
...
Available at: <Link link={{"discriminant":"external","value":"https://www.arcgis.com/features/free-trial.html"}}>https://www.arcgis.com/features/free-trial.html</Link>
...
Using BootCamp: <Link link={{"discriminant":"external","value":"http://www.apple.com/support/bootcamp/"}}>http://www.apple.com/support/bootcamp/</Link>
