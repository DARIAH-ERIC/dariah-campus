...
To continue to the next section, you will need to have completed the <Link link={{"discriminant":"external","value":"https://clarin.oeaw.ac.at/moodledariahteach/mod/page/view.php?id=354"}}>Geotagging setup</Link> **\[THIS LINK JUST GOES TO THE TEACH HOME PAGE?? - MOVE GEOTAGGING WORKFLOW BELOW TO HERE?]** guidelines and launch Geosetter.
...
&#x20;In order to be able to complete this 'Image Geotagging' section you will need to:
...
* *Option 1* : Create a dual-boot setup on your Mac. This allows you to boot into either Mac OS or Windows OS. The usual way to do this is to use the free software BootCamp. Available at: <Link link={{"discriminant":"external","value":"http://www.apple.com/support/bootcamp/"}}>[http://www.apple.com/support/bootcamp/](http://www.apple.com/support/bootcamp/)</Link>
...
- open a free account on Geonames geographical database <Link link={{"discriminant":"external","value":"http://www.geonames.org/"}}>[http://www.geonames.org](http://www.geonames.org)</Link>
...
<Callout kind="note" title=" Note 1: Metadata">
...
Finally, go to **Internet** tab and change the URL address under Geonames to: <Link link={{"discriminant":"external","value":"http://www.geonames.org/"}}>[http://www.geonames.org/](http://www.geonames.org/)</Link>
...
To continue to the next section, you will need to have completed the <Link link={{"discriminant":"external","value":"https://clarin.oeaw.ac.at/moodledariahteach/mod/page/view.php?id=384"}}>Spatial analysis setup</Link> guidelines and launch ArcMap.
...
Spatial analysis setup **Software Download**
...
Available at: <Link link={{"discriminant":"external","value":"https://www.arcgis.com/features/free-trial.html"}}>[https://www.arcgis.com/features/free-trial.html](https://www.arcgis.com/features/free-trial.html)</Link>
...
Using BootCamp: <Link link={{"discriminant":"external","value":"http://www.apple.com/support/bootcamp/"}}>[http://www.apple.com/support/bootcamp/](http://www.apple.com/support/bootcamp/)</Link>
