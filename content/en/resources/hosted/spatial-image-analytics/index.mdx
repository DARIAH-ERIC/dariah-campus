...
**Exercise:** Introduction to Spatial Image Analytics
...
To learn how to geotag an image file in Geosetter, you are going to work with the digital image from one of <Link link={{"discriminant":"external","value":"http://eng.travelogues.gr/collection.php?view=303"}}>Stackelberg</Link> works created during his travels in Greece between 1810-13 (Fig. 2). Navigate to the directory of the ***Images\_copy*** folder and select Stackelberg subfolder. The file should appear in the upper left window of the interface. Double-click on the first image entitled **The Temple of Olympian Zeus in Athens** and then click on the tabs *Location* and *Source Description.* Notice that the fields are empty.
...
<Figure src="/assets/content/assets/en/resources/hosted/spatial-image-analytics/9ba055fc0f23e81fd6618b47bf4bc3fbff180da7-36214.PNG" alt="identifier" alignment="stretch">
  *Figure 2. Image data points and Identify window in ArcMap.*
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/spatial-image-analytics/014281a2373c1dedfa35cccc5e2c3c169e06e936-36215.PNG" alt="modelbuilder1" alignment="stretch">
  *Figure 3. The conceptual model at the Integrate stage.*
</Figure>
...
<Figure src="/assets/content/assets/en/resources/hosted/spatial-image-analytics/ef0dbbe31833c8bcba3d5215c2f327934d05a10f-36218.PNG" alt="HS_final" alignment="stretch">
  *Figure 6. ArcMap interface with displayed Hotspot results*
</Figure>
