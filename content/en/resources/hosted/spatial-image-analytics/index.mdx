...
To continue to the next section, you will need to have completed the <Link link={{"discriminant":"external","value":"https://clarin.oeaw.ac.at/moodledariahteach/mod/page/view.php?id=354"}}>Geotagging setup</Link> guidelines and launch Geosetter.
...
<Link link={{"discriminant":"external","value":"http://www.geosetter.de/en/download/"}}>[http://www.geosetter.de/en/download/](http://www.geosetter.de/en/download/)</Link> has been developed for Windows Operating systems. To run Geosetter on an Apple Macintosh computer, the Mac must be set up to run Windows by following one of two installation options:
...
<Link link={{"discriminant":"external","value":"http://www.geosetter.de/en/download/"}}>[http://www.geosetter.de/en/download/](http://www.geosetter.de/en/download/)</Link>
