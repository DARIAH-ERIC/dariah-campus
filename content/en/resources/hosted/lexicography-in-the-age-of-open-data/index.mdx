...
* **<Link link={{"discriminant":"resources-hosted","value":"open-science-is-just-good-science"}}>Open Science is Just Good Science</Link>**
...
For those who want to learn more about what the CLARIN infrastructure can offer lexicographers we recommend the ELEXIS course <Link link={{"discriminant":"resources-hosted","value":"clarin-tools-and-resources-for-lexicographic-work"}}>CLARIN Tools and Resources for Lexicographic Work</Link>.
...
* <Link link={{"discriminant":"resources-external","value":"an-introduction-to-conceptual-modelling"}}>An Introduction to Conceptual Modelling</Link>
