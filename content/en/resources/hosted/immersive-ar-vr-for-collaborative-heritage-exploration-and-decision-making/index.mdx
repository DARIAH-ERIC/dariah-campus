...
<Quiz>
  <QuizImageDropZones src="/assets/content/assets/en/resources/hosted/immersive-ar-vr-for-collaborative-heritage-exploration-and-decision-making/match-exercise.png" distractors={[]} instantFeedback={false}>
    ...
    <QuizImageDropZone label="Timelines" shape="ellipse" items={[{"label":"Compare historical phases or intervention stages."}]} x={15} y={4.3} width={12.2} height={21.3}>

    </QuizImageDropZone>

    <QuizImageDropZone label="Viewpoint" shape="ellipse" items={[{"label":"Save expert perspectives and guided observation points."}]} x={8.3} y={37.3} width={12.2} height={21.3}>
