...
<Quiz>
  <QuizImageDropZones src="/assets/content/assets/en/resources/hosted/immersive-ar-vr-for-collaborative-heritage-exploration-and-decision-making/artemis.webp" distractors={[]} instantFeedback={false}>
    <QuizQuestion>
      **Match each interaction tool to its description**
    </QuizQuestion>

    <QuizImageDropZone label="Timelines" shape="ellipse" items={[{"label":"Compare historical phases or intervention stages."}]} x={10.6} y={4.8} width={14.8} height={27.1}>

    </QuizImageDropZone>

    <QuizImageDropZone label="Viewpoints" shape="ellipse" items={[{"label":"Save expert perspectives and guided observation points."}]} x={7.7} y={37.5} width={13.8} height={25.7}>
