...
<Quiz>
  <QuizImageDropZones src="/assets/content/assets/en/resources/hosted/immersive-ar-vr-for-collaborative-heritage-exploration-and-decision-making/match-exercise.png" distractors={[]} instantFeedback={false}>
    ...
    <QuizImageDropZone label="Timelines" shape="ellipse" items={[{"label":"Compare historical phases or intervention stages."}]} x={14.3} y={3.2} width={13.6} height={24}>

    </QuizImageDropZone>

    <QuizImageDropZone label="Viewpoint" shape="ellipse" items={[{"label":"Save expert perspectives and guided observation points."}]} x={7.4} y={35.7} width={13.7} height={24.4}>
