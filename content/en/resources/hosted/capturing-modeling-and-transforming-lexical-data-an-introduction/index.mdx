...
The creation of user interfaces and storage of digitized lexical datasets in databases is beyond the scope of this course. You may, however, be interested in the ELEXIS course <Link link={{"discriminant":"resources-hosted","value":"how-to-publish-your-dictionary-data-with-publex"}}>How to Publish Your Dictionary Data with Publex</Link>.
