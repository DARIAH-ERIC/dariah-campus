...
doi: https://hdl.handle.net/21.11159/019595c5-1153-70e8-b193-41abab39ad1a
---
...
<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/g-l9q7-ir.png">
...
<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/ib-l-rh2-v.png">
  Example 1. Linde Dictionary: decent OCR by the ABBYY Cloud OCR service.
</Figure>

**Czech-Polish Dictionary**

<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/zi-r7o-xj.png">
  Example 2. Czech-Polish dictionary: here also the OCR result is quite decent.
</Figure>

**Rechnik malyj**

<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/r8-os-t9-c.png">
  Example 3. Rechnik Malyj: the German OCR works a bit, the (old style) Cyrillic is useless.
</Figure>

**Mikloshich**

<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/i7e5-k-jd.png">
...
<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/m-mp-tas-w.png">
  Example 5. Serbian Etymological Dictionary: The OCR of modern Cyrillic is of acceptable quality
</Figure>

**Grimm**

<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/lcg-mew-v.png">
  Example 6. Grimm: OCR is reasonable, but could have been better with a higher resolution image.
</Figure>

**Bernolak**

<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/a2cy-sik.png">
  Example 7. The Bernolak dictionary: rather bad OCR.
</Figure>

**Warsaw Dictionary**

<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/w8v-bd-d4.png">
...
<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/m7-kg-r-cc.png">
...
<Figure src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/vr-vwm-xy.jpg">
...
Once you've learned the basics of working with XML, you can explore XPath, a standard query language for selecting nodes from XML documents. <Link link={{"discriminant":"resources-hosted","value":{"id":"xpath-for-dictionary-nerds"}}}>Extracting Lexical Data: XPath for Dictionary Nerds</Link> may be a good place to start.
...
As part of the ELEXIS Curriculum on DARIAH-Campus, we offer an introductory course on <Link link={{"discriminant":"resources-hosted","value":{"id":"transforming-lexical-data-xslt-for-dictionary-nerds"}}}>Transforming Lexical Data: XSLT for Dictionary Nerds</Link>.
...
2. Select File > New and make the contents of the New Document folder visible by clicking on it. Alternatively, type in "xml" in search field.
   ...
   ![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/le073-bh.png)
...
![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/w-defn-sg.png)
...
![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/o-qb-sxd2.png)

2. As a result, your XML will be reformatted for your viewing pleasure.

![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/0n-tp-o6-n.png)
...
Keep in mind, there is a lot more to learn about oXygen. If you're interested, make sure to check out the ELEXIS course <Link link={{"discriminant":"resources-hosted","value":{"id":"mastering-oxygen-xml-editor-for-dictionary-nerds"}}}>Mastering oXygen XML Editor for Dictionary Nerds</Link> here on DARIAH-Campus.
...
The creation of user interfaces and storage of digitized lexical datasets in databases is beyond the scope of this course. You may, however, be interested in the ELEXIS course <Link link={{"discriminant":"resources-hosted","value":{"id":"how-to-publish-your-dictionary-data-with-publex"}}}>How to Publish Your Dictionary Data with Publex</Link>.
