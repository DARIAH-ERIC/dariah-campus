...
Once you've learned the basics of working with XML, you can explore XPath, a standard query language for selecting nodes from XML documents. <Link link={{"discriminant":"resources-hosted","value":"xpath-for-dictionary-nerds"}}>Extracting Lexical Data: XPath for Dictionary Nerds</Link> may be a good place to start.
...
As part of the ELEXIS Curriculum on DARIAH-Campus, we offer an introductory course on <Link link={{"discriminant":"resources-hosted","value":"transforming-lexical-data-xslt-for-dictionary-nerds"}}>Transforming Lexical Data: XSLT for Dictionary Nerds</Link>.
...
Keep in mind, there is a lot more to learn about oXygen. If you're interested, make sure to check out the ELEXIS course <Link link={{"discriminant":"resources-hosted","value":"mastering-oxygen-xml-editor-for-dictionary-nerds"}}>Mastering oXygen XML Editor for Dictionary Nerds</Link> here on DARIAH-Campus.
...
The creation of user interfaces and storage of digitized lexical datasets in databases is beyond the scope of this course. You may, however, be interested in the ELEXIS course <Link link={{"discriminant":"resources-hosted","value":"mastering-oxygen-xml-editor-for-dictionary-nerds"}}>How to Publish Your Dictionary Data with Publex</Link>.
