...
If you're new to XML, make sure you review the basics by (re)visiting the ELEXIS course <Link link={{"discriminant":"resources-hosted","value":"capturing-modeling-and-transforming-lexical-data-an-introduction"}}>Capturing, Modeling and Transforming Lexical Data: An Introduction</Link> and, in partiuclar, sections on <Link link={{"discriminant":"resources-hosted","value":"capturing-modeling-and-transforming-lexical-data-an-introduction#xml-building-blocks-and-basic-rules"}}>XML building blocks and basic rules</Link>
