...
doi: https://hdl.handle.net/21.11159/019595c5-1e05-77a8-8bcf-4d49cb734864
---
...
This course requires basic knowledge of XML, which can be acquired from the course <Link link={{"discriminant":"resources-hosted","value":{"id":"capturing-modeling-and-transforming-lexical-data-an-introduction"}}}>Capturing, Modeling and Transforming Lexical Data: An Introduction</Link>. Especially the part on Modeling lexicographic data (with XML) is essential. In addition to this, we recommend doing the course <Link link={{"discriminant":"resources-hosted","value":{"id":"xpath-for-dictionary-nerds"}}}>Extracting Lexical Data: XPath for Dictionary Nerds</Link> if you want to grasp the finer details of defining transformations in Elexifier. For transforming PDF dictionaries, basic knowledge of Lexonomy is recommended. For this, check out the course <Link link={{"discriminant":"resources-hosted","value":{"id":"lexonomy-mastering-the-elexis-dictionary-writing-system"}}}>Lexonomy: Mastering the ELEXIS Dictionary Writing System</Link>.
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/be.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/bf.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/bh.png)
...
>
> You can learn more about TEI Lex-0 in the course <Link link={{"discriminant":"resources-hosted","value":{"id":"modeling-dictionaries-in-tei-lex-0"}}}>Modelling Dictionaries in TEI Lex-0</Link>.
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/bg.png)

The transformation already contains three elements, i.e. entry, headword and sense.

![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/ac.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/ae.png)

![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/cc.png)
...
> Note: You can learn more about XPATH in the course <Link link={{"discriminant":"resources-hosted","value":{"id":"xpath-for-dictionary-nerds"}}}>Extracting Lexical Data: XPath for Dictionary Nerds</Link>
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/bd.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/aa.png)

So far so good. Let's now look at "PART OF SPEECH".

Transforming the Part of Speech tag is a little more difficult in our Sample Dictionary as the part of speech value is stored in an attribute of the PartOfSpeech tag.![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/bb.png)To transform the Part of Speech, you first need to specify the tag name, i.e. PartOfSpeech and then you need to select the value of the attribute. You do this by selecting the option 'attribute value' from the dropdown menu.

![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/ca.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/ab.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/ah.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/bc.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/af.png)

You then set the path to the example translation element.

![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/ag.png)
...
![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/ad.png)

You can then choose to download with or without namespaces.

![](/assets/content/assets/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/ba.png)
...
Lexonomy is a cloud-based, open-source platform for writing and publishing dictionaries. In the course <Link link={{"discriminant":"resources-hosted","value":{"id":"lexonomy-mastering-the-elexis-dictionary-writing-system"}}}>Lexonomy: Mastering the ELEXIS Dictionary Writing System</Link> you learn how to use Lexonomy.
