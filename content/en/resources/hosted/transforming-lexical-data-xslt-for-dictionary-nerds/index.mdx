...
draft: true
doi: https://hdl.handle.net/21.11159/0195cc28-a24a-767b-adb8-ad88fb44e010
---
...
You should already be familiar with the fundamentals of XML and XPath. If not, you could visit the sections on XML in <Link link={{"discriminant":"resources-hosted","value":{"id":"capturing-modeling-and-transforming-lexical-data-an-introduction"}}}>Capturing, Modeling and Transforming Lexical Data: An Introduction</Link>, and <Link link={{"discriminant":"resources-hosted","value":{"id":"xpath-for-dictionary-nerds"}}}>Extracting Lexicographic Data: XPath for Dictionary Nerds</Link>.
...
![](/assets/content/assets/en/resources/hosted/transforming-lexical-data-xslt-for-dictionary-nerds/04.png)
...
![](/assets/content/assets/en/resources/hosted/transforming-lexical-data-xslt-for-dictionary-nerds/05.png)
...
7. If you have other files open in oXygen, make sure that you've selected `johnson-in-bad-TEI.xml` from the XML dropdown menu in the upper left corner of the window, as well as `johson2TEI.xsl` in the XSL dropdown next to it.
   ...
   ![](/assets/content/assets/en/resources/hosted/transforming-lexical-data-xslt-for-dictionary-nerds/01.png)
...
8. To test the XSLT transformation in the Debugger Perspective, click, on the blue arrow icon below the XSL dropdow, or select Debugger > Run from the main menu.
   ...
   ![](/assets/content/assets/en/resources/hosted/transforming-lexical-data-xslt-for-dictionary-nerds/02.png)
   ...
   ![](/assets/content/assets/en/resources/hosted/transforming-lexical-data-xslt-for-dictionary-nerds/03.png)
