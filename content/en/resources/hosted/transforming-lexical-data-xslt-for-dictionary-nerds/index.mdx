...
You should already be familiar with the fundamentals of XML and XPath. If not, you could visit the sections on XML in <Link link={{"discriminant":"resources-hosted","value":"capturing-modeling-and-transforming-lexical-data-an-introduction"}}>Capturing, Modeling and Transforming Lexical Data: An Introduction</Link>, and <Link link={{"discriminant":"resources-hosted","value":"xpath-for-dictionary-nerds"}}>Extracting Lexicographic Data: XPath for Dictionary Nerds</Link>.
