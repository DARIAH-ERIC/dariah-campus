...
# apart from 'books', the tables 'respondents' and 'reviews' are also present. 
# pick one and activate it, then check the contents using one of the methods above - by writing your code on the next line.
data(reviews)
head(reviews)
```
