...
In the code block below, you see part of the base syntax of R. The first line, between \{ } is the title of the code block. The two lines of code both have the format function(object).
