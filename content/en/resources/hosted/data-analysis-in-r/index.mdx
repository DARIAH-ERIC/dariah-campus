...
To make the most of this tutorial, I encourage you to first download R and Rstudio, and then open this file **(rmd) \{add link} in Rstu**dio. That way, you can try out the code for yourself, do the exercises and modify the code when you take the next step of applying your new knowledge to your own data.
