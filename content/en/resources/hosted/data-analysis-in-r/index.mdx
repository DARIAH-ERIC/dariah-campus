...
translations: []
doi: https://hdl.handle.net/21.11159/01990b1b-2502-75ea-bcce-eef03e96aa63
---
## Introduction
...
To make the most of this tutorial, I encourage you to first download R and Rstudio, and then open <Link link={{"discriminant":"download","value":"/assets/content/downloads/en/resources/hosted/data-analysis-in-r/data-analysisin-r-dariah-resource.rmd"}}>this file</Link> in Rstudio. That way, you can try out the code for yourself, work through the exercises and modify the code when you take the next step of applying your new knowledge to your own data and your own research questions.
...
You can download the tutorial file <Link link={{"discriminant":"download","value":"/assets/content/downloads/en/resources/hosted/data-analysis-in-r/data-analysisin-r-dariah-resource.rmd"}}>here</Link>  **a**nd open it with Rstudio. The text is identical to this webpage. You can also read through the steps below, **but the code samples are not executable.**
