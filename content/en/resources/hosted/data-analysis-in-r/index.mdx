...
> |   | **short.title**     | **author**         | **title.english** |
> | - | ------------------- | ------------------ | ----------------- |
> | 1 | Rosnay\_HaarNaamWas | Rosnay, Tatiana de | Sarah's Key       |
> | 2 | Zwagerman\_Duel     | Zwagerman, Joost   | Duel              |
> | 3 | Abdolah\_Kraai      | Abdolah, Kader     | The Crow          |
...
To end our exploration of R and the litRiddle corpus, you can try to 'Knit' the markdown file by selecting your preferred output from the dropdown menu next to the ball of yarn in the menu bar. Knitting only works when all code works; if you have not completed the exercises, there will be some code fragments that hinder the knitting. You can work around this by either 'commenting' these lines through placing a # in front of them, or by preventing the whole code block from running. This can be done by clicking on the gear icon in the right top hand of a code block, and under 'Output' select 'Show nothing (don't run code)'.

Once you have succesfully knitted an output file, it will show up under the tab Files at the right-hand side of the Rstudio screen.
