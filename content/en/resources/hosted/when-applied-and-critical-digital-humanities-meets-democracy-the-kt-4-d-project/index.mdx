...
summary:
  content: >-
    This webinar from Prof. Jennifer Edmond and Dr. Eleonora Lima at Trinity
    College Dublin discusses the Knowledge Technologies for Democracy (KT4D)
    project and its investigation into how democracy and civic participation can
    be better facilitated in the face of rapidly changing knowledge
    technologies, namely Artificial Intelligence (AI) and Big Data.
...
<VideoCard provider="youtube" id="AEj4DnxCfnM" title="When Applied and Critical Digital Humanities Meets Democracy: the KT4D Project" subtitle="Click here to view" src="/assets/content/assets/en/resources/hosted/when-applied-and-critical-digital-humanities-meets-democracy-the-kt-4-d-project/friday-frontiers-dec-2024-thumbnail.png" />
