...
There are no prerequisites for this course. Although, if you are very new to the world of dictionaries, you may want to check out our <Link link={{"discriminant":"resources-hosted","value":"introduction-to-dictionaries"}}>Introduction to Dictionaries</Link>.
...
As we already learned in the <Link link={{"discriminant":"resources-hosted","value":"introduction-to-dictionaries#audience"}}>Introduction to Dictionaries</Link>,
...
then have an effect on dictionary <Link link={{"discriminant":"resources-hosted","value":"introduction-to-dictionaries#macrostructure"}}>macrostructure</Link> and
<Link link={{"discriminant":"resources-hosted","value":"introduction-to-dictionaries##microstructure"}}>microstructure</Link>, for example on the amount of
...
There are many <Link link={{"discriminant":"resources-hosted","value":"introduction-to-dictionaries#dictionary-typologies"}}>criteria</Link> that can be used to
...
This course and the <Link link={{"discriminant":"resources-hosted","value":"introduction-to-dictionaries"}}>Introduction to Dictionaries</Link> serve as a good point
...
check out our <Link link={{"discriminant":"resources-hosted","value":"introduction-to-corpus-based-lexicographic-practice"}}>Introduction to Corpus-Based Lexicographic Practice</Link>.

If, on the other hand, you want to learn about the joys (and tribulations) of turning paper-based
dictionaries into digital format, we suggest you start with <Link link={{"discriminant":"resources-hosted","value":"capturing-modeling-and-transforming-lexical-data-an-introduction"}}>Capturing, Modeling and Transforming Lexical Data: An Introduction</Link>.
