...
doi: https://hdl.handle.net/21.11159/019595c5-1d00-773d-a614-a33ca667bfb4
---
...
There are no prerequisites for this course. Although, if you are very new to the world of dictionaries, you may want to check out our <Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-dictionaries"}}}>Introduction to Dictionaries</Link>.
...
As we already learned in the <Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-dictionaries","hash":"audience"}}}>Introduction to Dictionaries</Link>,
...
then have an effect on dictionary <Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-dictionaries","hash":"macrostructure"}}}>macrostructure</Link> and
<Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-dictionaries","hash":"microstructure"}}}>microstructure</Link>, for example on the amount of
...
There are many <Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-dictionaries","hash":"dictionary-typologies"}}}>criteria</Link> that can be used to
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/elexis-figure1-eng.png">
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/overall-dissimilarity-sl-eu.png">
...
<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/esd-plot-2022-05-12-europe.png">
  Figure 3
</Figure>

<Figure src="/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/esd-plot-2022-05-12-north-macedonia.png">
...
- dissemination via the WWW possible (increases potential number of participants)
...
- tendency of user overreporting or misreporting
- incomplete answers; users can stop answering at any time
...
- comprehensiveness: good for getting detailed insight into dictionary use
- ability to ask users for clarification on their answers
...
- a great deal of analysis needed (transcription, coding)
...
- insight into user thinking during dictionary use
...
- comprehensiveness: good for getting detailed insight into dictionary use
- useful for dictionary design and information placement
...
- useful info for a particular dictionary
- observations during actual dictionary use
...
- limited to a particular resource
...
- unobtrusive, no additional effort from users needed
...
- demanding analysis
- difficult to identify context of dictionary use
...
- monitor actual use during a specific task
...
- findings could be limited to a particular task
- more suitable for small-scale studies
...
- unobtrusive, no additional effort from users needed
- evidence of actual use relevance of findings for dictionaries may be low
...
This course and the <Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-dictionaries"}}}>Introduction to Dictionaries</Link> serve as a good point
...
check out our <Link link={{"discriminant":"resources-hosted","value":{"id":"introduction-to-corpus-based-lexicographic-practice"}}}>Introduction to Corpus-Based Lexicographic Practice</Link>.

If, on the other hand, you want to learn about the joys (and tribulations) of turning paper-based
dictionaries into digital format, we suggest you start with <Link link={{"discriminant":"resources-hosted","value":{"id":"capturing-modeling-and-transforming-lexical-data-an-introduction"}}}>Capturing, Modeling and Transforming Lexical Data: An Introduction</Link>.
