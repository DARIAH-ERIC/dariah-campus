...
That's great, we're delighted! Here are the steps you need to go through in order to get your contribution published.

### Step 1 - Submitting a proposal and required information
...
2. You will need to fill in the form found here: [GitHub template to propose new resource](https://github.com/DARIAH-ERIC/dariah-campus/issues/new/choose).
...
- Any new tags you want to add to the list (please ensure that your tag isn't already listed on DARIAH-Campus - the full list is here [DARIAH-Campus Topics page](https://campus.dariah.eu/tags))
...
3. Submit your form and we will get back to you **within a week** to let you know when you can start the next step.
