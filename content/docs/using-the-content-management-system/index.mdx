...
We are currently in the process of changing to a new content management system (CMS).  During this time we will not be accepting any new drafts of resources.  You are still very welcome to propose a contribution (see 'Proposing a Contribution'), and we will notify you when the new system is ready for you to start drafting.  We anticipate that this will be available in **approx 4 weeks (early March 2025)**.
</SideNote>
...
1. Go to DARIAH-Campus CMS and log in using your GitHub account (**this is currently disabled while we switch to the new CMS**).
