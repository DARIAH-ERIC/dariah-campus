...
We are currently in the process of changing to a new content management system (CMS).  During this time we will not be accepting any new drafts of or updates to resources.  You are still very welcome to propose a contribution for a new resource via the usual 'Proposing a Contribution' steps, and we will notify you when the new system is ready for you to start drafting.  We anticipate that this will be available in **approx 4 weeks (early March 2025)**.
</SideNote>
...
1. Go to DARIAH-Campus CMS (currently disabled, see notice above) and log in using your GitHub account.
2. If this is the first time you've used the CMS, you will be asked to allow the system access to your GitHub account. You will also be asked if you want to "Fork the Repo" or "Don't fork the Repo". You should select "Fork the Repo".
...
<SideNote type="info" title="Please note">
