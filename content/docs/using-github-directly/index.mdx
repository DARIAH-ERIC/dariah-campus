...
5. Next, type: "`brew install node@14`" into Terminal and hit 'return'
...
3. Open 'command line' and check node version by typing: `node -v`.  The current version we recommend is Node 14.
...
![Copying the resource template folder](images/DC_HostRes_img1\_copying.png)

**Copy** (do not 'drag and drop') the entire folder, and then **paste** it into the `content/posts` folder:

![Copying the resource template folder](images/DC_HostRes_img2\_pasting.png)
...
![Copying the resource template folder](images/DC_HostRes_img3\_green.png)
...
![Copying the resource template folder](images/DC_HostRes_img4\_inBrowser.png)
...
![Copying the resource template folder](images/DC_PFndr_img1\_copy.png)

**Copy** (do not 'drag and drop') the entire folder, and then **paste** it into the `content/posts` folder in your fork

![Copying the resource template folder](images/DC_PFndr_img2\_paste.png)
...
![Copying the resource template folder](images/DC_PFndr_img3\_index.png)
...
![Copying the resource template folder](images/DC_PFndr_img4\_inBrowser.png)
...
![Copying the event template folder](images/DC_CapEvent_img1\_copy.png)

**Copy** (do not 'drag and drop') the entire folder, and then **paste** it into the `content/events` folder in your fork.

![Copying the resource template folder](images/DC_CapEvent_img2\_paste.png)
...
![Copying the resource template folder](images/DC_CapEvent_img3\_ingreen.png)
...
![Copying the event template folder](images/DC_CapEvent_img4\_inBrowser.png)
