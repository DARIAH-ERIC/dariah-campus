...
2.	You will need to fill in the form found here: **[URL to GitForms on the DC GitHub]**.
...
* Any **new tags** you want to add to the list (please ensure that your tag isn’t already listed on DARIAH-Campus - the full list is here [URL to D-C ‘topics’ page])
