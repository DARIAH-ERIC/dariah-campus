...
You create **bold text** like this, using double asterisks, before and after the word or phrase. To italicise text you _use underscores_ like this. You can create **_bold and italic_** by combining both.
