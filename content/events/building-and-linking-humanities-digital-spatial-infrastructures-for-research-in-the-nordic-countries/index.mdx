...
abstract: This workshop, focussing on "Spatial data medieval to modern", is the first of a series
...
about: 'The project **"Linking, Building and Sustaining Humanities Digital Spatial
  ...
  In total three workshops have been planned in this project: Uppsala, Sweden (May 2022) represented here; Bergen, Norway (September 2022); and Reykjavík, Iceland (May 2023).  Blogposts covering the second and third workshops in this series can be found on the project website here: [https://nordic-spatialhumanities.org/](https://nordic-spatialhumanities.org/)
...
sessions:
  - speakers:
    ...
    body: The talk addresses implementation of Linked Open Data in the Swedish
