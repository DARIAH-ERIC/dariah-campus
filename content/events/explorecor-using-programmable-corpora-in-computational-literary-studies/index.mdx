...
sessions:
  ...
  - title: "Exploring Programmable Corpora 2: Introducing Network Analysis"
    ...
    body: ABSTRACT AND VIDEO GO HERE

      <Speakers>
        <Speaker speaker="beine-julie-jennifer">
        </Speaker>
      </Speakers>
  ...
  - title: "Reproducibility 1: Replication or Prediction or What?"
    ...
    body: ABSTRACT AND VIDEO GO HERE
      ...
      <Speakers>
        <Speaker speaker="schöch-christof">
        </Speaker>
      </Speakers>
