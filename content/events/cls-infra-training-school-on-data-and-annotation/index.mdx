...
sessions:
  - title: Intro - Information extraction from the Shakespeare Drama Corpus
    ...
    body:
      ...
      You can find the handouts for this session in the complete event synthesis on Zenodo here - [Prague Summer School on Zenodo] (https://zenodo.org/record/7118694#.Yzrr9ezMLPC)
